...
class FakeConnection : Connection() {
  ...
  fun findHttpEvent(eventType: NetworkInspectorProtocol.HttpConnectionEvent.UnionCase): NetworkInspectorProtocol.HttpConnectionEvent? {
    return httpData.firstOrNull { it.unionCase == eventType }
  }

  fun findLastHttpEvent(eventType: NetworkInspectorProtocol.HttpConnectionEvent.UnionCase): NetworkInspectorProtocol.HttpConnectionEvent? {
