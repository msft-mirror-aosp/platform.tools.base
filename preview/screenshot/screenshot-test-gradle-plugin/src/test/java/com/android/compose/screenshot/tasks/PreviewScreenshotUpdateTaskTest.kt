...
class PreviewScreenshotUpdateTaskTest {
    ...
    fun testPreviewScreenshotUpdate() {
        ...
        val screenshotResults = listOf(
            PreviewScreenshotResult("com.example.agptest.ExampleInstrumentedTest.preview_a45d2556_da39a3ee_0", "com.example.agptest.ExampleInstrumentedTest.preview",
                image1, null ),
            PreviewScreenshotResult("com.example.agptest.ExampleInstrumentedTest.preview1_da39a3ee_4c0e9d96_0", "com.example.agptest.ExampleInstrumentedTest.preview1",
                image2, null ),
            PreviewScreenshotResult("com.example.agptest.ExampleInstrumentedTest.preview1_da39a3ee_4c0e9d96_1", "com.example.agptest.ExampleInstrumentedTest.preview1",
                image3, null ))
        val result = PreviewRenderingResult(globalError = null, screenshotResults = screenshotResults)
        writePreviewRenderingResult(resultsFile.writer(), result)
    ...
    fun testPreviewScreenshotUpdateWithNoPreviews() {
        ...
        val renderTaskOutputDir = tempDirRule.newFolder("rendered")
        val resultsFile = tempDirRule.newFile("results.json")
        writePreviewRenderingResult(resultsFile.writer(), PreviewRenderingResult(null, listOf()))
        task.referenceImageDir.set(referenceImageDir)
        task.renderTaskOutputDir.set(renderTaskOutputDir)
        task.renderTaskResultFile.set(resultsFile)
        task.analyticsService.set(object: AnalyticsService() {
    ...
    fun testPreviewScreenshotUpdateWithErrors() {
        ...
        val previewRenderingResult = listOf(PreviewScreenshotResult("com.example.agptest.ExampleInstrumentedTest.preview_a45d2556_da39a3ee_0", "com.example.agptest.ExampleInstrumentedTest.preview", image1,null ),
            ...
            PreviewScreenshotResult("com.example.agptest.ExampleInstrumentedTest.preview1_da39a3ee_4c0e9d96_1", "com.example.agptest.ExampleInstrumentedTest.preview1","preview1_da39a3ee_4c0e9d96_1.png", ScreenshotError("ERROR", "MESSAGE", "STACK_TRACE", listOf(), listOf(), listOf())))
    ...
    fun testPreviewScreenshotUpdateWithEmptyPreview() {
        ...
        val previewRenderingResult = listOf(PreviewScreenshotResult("com.example.agptest.ExampleInstrumentedTest.preview_a45d2556_da39a3ee_0", "com.example.agptest.ExampleInstrumentedTest.preview",
        ...
        val previewScreenshot = previewRenderingResult[0]
        assertFailsWith<GradleException>("Cannot update reference images. Rendering failed for ${previewScreenshot.imagePath.substringBeforeLast(".")}. Error: ${previewScreenshot.error!!.message}. Check ${resultsFile.absolutePath} for additional info") {
            task.run()
        }
        referenceImageDir.listFiles()?.let { assert(it.isEmpty()) }
    }
