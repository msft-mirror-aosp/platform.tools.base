...
/**
 * This interface is used by classes that wrap a communication channel (SocketChannel or AdbChannel)
 * and use it to perform reads and writes with a timeout.
 *
 * <p>This interface is adapted from `com.android.ddmlib.SimpleConnectedSocket` for use within
 * deployer without a dependency on ddmlib.
 */
public interface DeployerConnectedSocket extends Closeable {

    /**
     * Reads from the channel into {@code dst}.
     *
    ...
    /**
     * Writes to the channel from {@code dst}.
     *
