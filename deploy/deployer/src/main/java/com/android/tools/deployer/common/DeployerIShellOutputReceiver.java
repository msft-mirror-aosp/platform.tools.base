...
/**
 * Classes which implement this interface provide methods that deal with output from a remote shell
 * command on a device/emulator.
 *
 * <p>This interface is a copy of {@link com.android.ddmlib.IShellOutputReceiver} adapted for use
 * within deployer without a dependency on ddmlib.
 */
public interface DeployerIShellOutputReceiver {
    /**
     ...
     */
    void addOutput(@NonNull byte[] data, int offset, int length);
