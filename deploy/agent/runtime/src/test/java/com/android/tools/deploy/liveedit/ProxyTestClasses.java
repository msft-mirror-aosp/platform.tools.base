...
public class ProxyTestClasses {
    ...
    public static class Pythagorean implements Function2<Long, Long, Long> {
        public Long apply(Long sideA, Long sideB) {
            return Math.round(Math.sqrt(square(sideA) + square(sideB)));
        }
    ...
    public static class Driver {
        public static long liveEditedMethod(long a, long b) {
            ...
            return func.apply(a, b) + notLiveEditedMethod(func);
        }
