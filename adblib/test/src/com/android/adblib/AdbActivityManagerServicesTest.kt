...
class AdbActivityManagerServicesTest {
  ...
  private val activityManagerServices
    get() = fakeAdbRule.adbSession.activityManagerServices
  ...
  fun testCapabilitiesApi35(): Unit = runBlockingWithTimeout {
    ...
    Assert.assertEquals(listOf("opengl-tracing", "view-hierarchy", "support_boot_stages"), result.frameworkCapabilities)
