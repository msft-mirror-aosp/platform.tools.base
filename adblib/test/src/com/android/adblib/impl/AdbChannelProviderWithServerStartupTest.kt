...
class AdbChannelProviderWithServerStartupTest {
  ...
  fun test_StartAdbServerAndCreateChannel_whenInitialCreateChannelFails(): Unit = runBlocking {
    ...
    val adbServerStartup =
      object : AdbServerStartup {
    ...
    val adbChannelProviderConnectAddresses =
      AdbChannelProviderWithServerStartup(host, AdbServerChannelConnectOptions(port), adbServerStartup)

    // Act
    val adbChannel = registerCloseable(adbChannelProviderConnectAddresses.createChannel(Long.MAX_VALUE, TimeUnit.MILLISECONDS))
  ...
  fun test_AdbServerNotFoundAndCannotBeStarted_throws(): Unit = runBlocking {
    ...
    // Act
    registerCloseable(adbChannelProviderConnectAddresses.createChannel(Long.MAX_VALUE, TimeUnit.MILLISECONDS))
  ...
  fun test_DoNotStartAdbServer_whenInitialCreateChannelAttemptSucceeds(): Unit = runBlocking {
    ...
    val adbChannelProviderConnectAddresses =
      AdbChannelProviderWithServerStartup(host, AdbServerChannelConnectOptions(server.port), adbServerStartup)
