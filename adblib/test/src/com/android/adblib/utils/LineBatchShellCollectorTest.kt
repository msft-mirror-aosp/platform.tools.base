...
class LineBatchShellCollectorTest {
  ...
  fun oneBatch_withoutTrailingNewline() {
    ...
    // Assert
    Assert.assertEquals(listOf(listOf("line1", "line2"), listOf("line3")), flowCollector.lineBatches)
  }
  ...
  fun oneBatch_withTrailingNewline() {
    ...
    // Assert
    Assert.assertEquals(listOf(listOf("line1", "line2", "line3"), listOf("")), flowCollector.lineBatches)
  }
  ...
  fun multipleBatches() {
    ...
    // Assert
    Assert.assertEquals(listOf(listOf("line1", "line2"), listOf("line3", "line4"), listOf("line5")), flowCollector.lineBatches)
  }

  private fun collectStrings(linesCollector: LineBatchShellCollector, flowCollector: FlowCollector<List<String>>, vararg values: String) {
    runBlocking {
