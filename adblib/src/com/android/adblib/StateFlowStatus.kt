...
/**
 * A general purpose "status" class to be used with [StateFlow] values
 * to describe the current state of the underlying state flow collector.
 */
data class StateFlowStatus(
    ...
    override fun toString(): String {
        val statusString = when (valueKind) {
    ...
    enum class ValueKind {
        ...
        * Whether this is the very first entry of the flow, emitted before actual values.
        ...
        /**
         * Whether the flow is currently interrupted during a transient error. Typically,
         * [currentError] is set to the error that caused the retry.
         */
        IS_RETRYING,
    }
    companion object {
