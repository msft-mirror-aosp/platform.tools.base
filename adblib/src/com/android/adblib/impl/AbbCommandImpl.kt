...
internal class AbbCommandImpl<T>(override val session: AdbSession, private val device: DeviceSelector, private val args: List<String>) :
  AbbCommand<T> {
  ...
  override fun <U> withCollector(collector: ShellV2Collector<U>): AbbCommand<U> {
    @Suppress("UNCHECKED_CAST") val result = this as AbbCommandImpl<U>
