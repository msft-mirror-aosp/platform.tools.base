 ...
 */
private const val FORWARD_LINE_PATTERN = "(${ALL_BUT_SPACE})${SPACE}(${ALL_BUT_SPACE})${SPACE}(${ALL_BUT_SPACE})"
...
internal class ForwardSocketListParser {
  ...
  private fun parseOneShortFormatLine(builder: ListWithErrors.Builder<ForwardSocketInfo>, lineIndex: Int, lineText: CharSequence) {
