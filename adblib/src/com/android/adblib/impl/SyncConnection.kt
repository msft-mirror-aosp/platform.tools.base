...
internal class SyncConnection(
    ...
    suspend fun readDirectoryEntryV2(syncRequestId: String): DirectoryEntryV2? {
        // See https://cs.android.com/android/platform/superproject/+/4737fae6acca4046f5c9c0851ef6349378affafb:packages/modules/adb/file_sync_protocol.h;l=78
    ...
    private fun parseStatV2Buffer(buffer: ByteBuffer): FileStatV2 {
        // See https://cs.android.com/android/platform/superproject/+/4737fae6acca4046f5c9c0851ef6349378affafb:packages/modules/adb/file_sync_protocol.h;l=55
        //     struct __attribute__((packed)) sync_stat_v2 {
        //  0    uint32_t id;    /* "STA2" or "DNT2" */
        //  4    uint32_t error; /* Linux `errno` of the `stat` call */
        //  8    uint64_t dev;   /* ID of device containing file */
    ...
    /**
     * Reads a 64-bit [timespec](https://man7.org/linux/man-pages/man3/timespec.3type.html) structure from [buffer] and returns the equivalent [FileTime] value.
     */
