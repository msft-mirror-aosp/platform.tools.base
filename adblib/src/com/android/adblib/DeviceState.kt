 ...
 *
 * See
 * [states](https://cs.android.com/android/platform/superproject/+/790d619575aea7032a4fe5f097d412adedf6623b:packages/modules/adb/transport.cpp;l=1132)
 */
@Suppress("unused", "SpellCheckingInspection")
enum class DeviceState(val state: String) {

  /** Device is fully online and available to perform most services, such as installing an application, debugging, etc. */
  ONLINE("device"),
   ...
   *
   * See
   * [no permissions](https://cs.android.com/android/platform/superproject/+/790d619575aea7032a4fe5f097d412adedf6623b:packages/modules/adb/transport.cpp;l=1148)
   */
  ...
  /**
   * The terminal state of a ConnectedDevice. This is not emitted by ADB; this is emitted to signal the end of the device session. If the
   * device reconnects, it will have a new ConnectedDevice instance.
   */
