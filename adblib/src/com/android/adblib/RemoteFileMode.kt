...
private constructor(
  ...
  companion object {
    ...
    /** Returns a new [RemoteFileMode] instance initialized from multiple [PosixFilePermission] values */
    ...
    /** Returns a new [RemoteFileMode] instance initialized from a set of [PosixFilePermission] values */
    ...
    /**
     * Returns a new [RemoteFileMode] instance initialized from Linux style file mode string, e.g. "rw-r--r"
     *
     * @throws IllegalArgumentException if the string is invalid, see [PosixFilePermissions.fromString]
     */
    ...
    /**
     * Returns a new [RemoteFileMode] instance initialized from the file permissions of an actual file [Path].
     *
     * Returns `null` if the [Path] cannot be accessed for some reason, e.g. file does not exist. Please use the [DEFAULT] value as
     * alternative if this is the case.
     *
     * Note: The returned [RemoteFileMode] may be an approximation if the underlying [Path.getFileSystem] does not support
     * [PosixFilePermission], e.g. on the Windows platform.
     */
