...
/**
 * The format specification of a socket that ADB listens from when forwarding socket connections (see [AdbHostServices.forward].
 *
 * See
 * [ADB source code](https://cs.android.com/android/platform/superproject/+/c9877a99c1ade78c9aa6ac67b8059c20a7bf5ed2:packages/modules/adb/socket_spec.cpp;l=330)
 * for reference.
...
abstract class SocketSpec {
  ...
  /**
   * A TCP connection, either local or remote. If this is used for a "server" socket, [port] can be zero, in which case ADB server returns
   * the actual port the server socket has been bound to.
   */
  ...
  /**
   * A [SocketSpec] passed unchanged to/from the ADB server. This is useful to represent [SocketSpec] not currently supported by other
   * [SocketSpec] classes.
   */
  ...
  companion object {
    ...
    /** Returns a [SocketSpec] instance given a string representation of the format (see [toQueryString]). */
