...
class InstanceListTest : TestCase() {
  fun testAddition() {
    val l1 = InstanceList.Empty + RootObj(RootType.INVALID_TYPE, 0, 0, null) + RootObj(RootType.INVALID_TYPE, 1, 0, null)
  ...
  fun testEliminator() {
    ...
    assertThat(size(InstanceList.Empty + RootObj(RootType.INVALID_TYPE, 0, 0, null) + RootObj(RootType.INVALID_TYPE, 1, 0, null)))
      .isEqualTo(2)
  }
}
