...
/**
 * An implementation of JourneyRunEventConsumer that builds a complete
 * [JourneyRun] proto in memory by processing events as they arrive.
 * It writes the complete proto after the RunFinished event is processed.
 */
class JourneyRunAggregatorConsumer(
    ...
    private fun writeToFile() {
        ...
        FileOutputStream(outputFile).use { output ->
            journeyRunResultBuilder.build().writeTo(output)
        }
    }
}
