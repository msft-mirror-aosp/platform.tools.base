...
object RoboConfigConstants {
  ...
  const val CRAWLER_PACKAGE_ID = "com.google.robo.platform"

  /** The relative class name for the ProxyService within the crawler package. Intended to be appended to [CRAWLER_PACKAGE_ID]. */
  ...
  /** Regex pattern to detect the "port_is_bound" message from Robo proxy logs, capturing the bound port number in group 1. */
