...
public class ParcelDetectorTest extends AbstractCheckTest {
    ...
    public void testParcelables() {
        String expected =
                "src/test/bytecode/MyParcelable1.java:6: Error: This class implements Parcelable"
                    + " but does not provide a CREATOR field [ParcelCreator]\n"
        ...
        lint().files(
                        ...
                        java(
                                "package test.bytecode;\n"
                                    ...
                                    + "\tpublic static final Parcelable.Creator<MyParcelable2>"
                                    + " CREATOR = new Parcelable.Creator<MyParcelable2>() {\n"
    ...
    public void testInterfaceOnSuperClass() {
        ...
        String expected =
                "src/test/pkg/ParcelableDemo.java:14: Error: This class implements Parcelable but"
                    + " does not provide a CREATOR field [ParcelCreator]\n"
                    + "    private static class JustParcelable implements Parcelable {\n"
                    + "                         ~~~~~~~~~~~~~~\n"
                    + "src/test/pkg/ParcelableDemo.java:19: Error: This class implements Parcelable"
                    + " but does not provide a CREATOR field [ParcelCreator]\n"
                    + "    private static class JustParcelableSubclass extends JustParcelable {\n"
                    + "                         ~~~~~~~~~~~~~~~~~~~~~~\n"
                    + "src/test/pkg/ParcelableDemo.java:22: Error: This class implements Parcelable"
                    + " but does not provide a CREATOR field [ParcelCreator]\n"
                    + "    private static class ParcelableThroughAbstractSuper extends"
                    + " AbstractParcelable {\n"
                    + "                         ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                    + "src/test/pkg/ParcelableDemo.java:27: Error: This class implements Parcelable"
                    + " but does not provide a CREATOR field [ParcelCreator]\n"
                    + "    private static class ParcelableThroughInterface implements"
                    + " MoreThanParcelable {\n"
                    + "                         ~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
                    + "4 errors, 0 warnings\n";
        //noinspection all // sample code
        lint().files(
                        java(
                                ...
                                "package test.pkg;\n"
                                    ...
                                    + "    }\n"
                                    + "\n"
                                    + "    private abstract static class AbstractParcelable"
                                    + " implements Parcelable {\n"
                                    + "    }\n"
                                    + "\n"
                                    + "    private static class JustParcelable implements"
                                    + " Parcelable {\n"
                                    ...
                                    + "    }\n"
                                    + "\n"
                                    + "    private static class JustParcelableSubclass extends"
                                    + " JustParcelable {\n"
                                    + "    }\n"
                                    + "\n"
                                    + "    private static class ParcelableThroughAbstractSuper"
                                    ...
                                    + "    }\n"
                                    + "\n"
                                    + "    private static class ParcelableThroughInterface"
                                    + " implements MoreThanParcelable {\n"
                                    + "        public int describeContents() {return 0;}\n"
                                    + "        public void writeToParcel(Parcel dest, int flags)"
                                    + " {}\n"
        ...
        lint().files(
                        java(
                                ...
                                "package test.pkg;\n"
                                    ...
                                    + "    public static <T extends Parcelable> T"
                                    + " getParcelable(Bundle args, String key) {\n"
                                    + "        return args == null ? null :"
                                    + " args.<T>getParcelable(key);\n"
                                    + "    }\n"
                                    + "}\n"))
                .run()
                .expectClean();
        ...
        lint().files(
                        java(
                                ...
                                "package test.pkg;\n"
                                    ...
                                    + "    public static abstract class AbstractParcelable"
                                    + " implements Parcelable {\n"
    ...
    public void testKotlin() {
        lint().files(
                ...
                .run()
                .expect(
                        "src/test/pkg/MissingParcelable1a.kt:6: Error: This class implements"
        ...
        lint().files(
                        ...
                        kotlin(
                                "package test.pkg\n"
                                    ...
                                    + "\n"
                                    + "    companion object {\n"
                                    + "        val CREATOR = object : Parcelable.Creator<MyClass> {"
                                    + " // ERROR\n"
                                    + "            override fun createFromParcel(parcel: Parcel) ="
                                    + " MyClass(parcel)\n"
                                    + "            override fun newArray(size: Int) ="
                                    + " arrayOfNulls<MyClass>(size)\n"
                                    + "        }\n"
                                    + "    }\n"
                                    + "}"),
                        ...
                        kotlin(
                                "package test.pkg\n"
                                    ...
                                    + "\n"
                                    + "    companion object {\n"
                                    + "        @JvmField val CREATOR = object :"
                                    + " Parcelable.Creator<MyClass2> { // OK\n"
                                    + "            override fun createFromParcel(parcel: Parcel) ="
                                    + " MyClass2(parcel)\n"
                                    + "            override fun newArray(size: Int) ="
                                    + " arrayOfNulls<MyClass2>(size)\n"
                                    + "        }\n"
                                    + "    }\n"
                                    + "}"),
                ...
                .run()
                .expect(
                        "src/test/pkg/MyClass.kt:19: Error: Field should be annotated with"
                            + " @JvmField [ParcelCreator]\n"
                            + "        val CREATOR = object : Parcelable.Creator<MyClass> { //"
                            + " ERROR\n"
                            + "            ~~~~~~~\n"
                            + "1 errors, 0 warnings")
        ...
        lint().files(
                        kotlin(
                                "@file:JvmName(\"TestKt\")\n"
                                    ...
                                    + "\n"
                                    + "@Parcelize\n"
                                    + "data class Test(val a: List<String>) : Parcelable // OK: Has"
                                    + " parcelable\n"
                                    + "\n"
                                    + "class Test2(val a: List<String>) : Parcelable // Missing"
                                    + " field but don't suggest @Parcelize\n"
                                    + "\n"
                                    + "data class Test3(val a: List<String>) : Parcelable // Warn:"
                                    + " Missing @Parcelize\n"
                                    + "\n"),
                ...
                .run()
                .expect(
                        "src/test/Test.kt:11: Error: This class implements Parcelable but does not"
                            + " provide a CREATOR field [ParcelCreator]\n"
                            + "class Test2(val a: List<String>) : Parcelable // Missing field but"
                            + " don't suggest @Parcelize\n"
                            + "      ~~~~~\n"
                            + "src/test/Test.kt:13: Error: This class implements Parcelable but"
                            + " does not provide a CREATOR field [ParcelCreator]\n"
                            + "data class Test3(val a: List<String>) : Parcelable // Warn: Missing"
                            + " @Parcelize\n"
                            + "           ~~~~~\n"
                            + "2 errors, 0 warnings");
    }
        ...
        lint().files(
                        ...
                        java(
                                "package test.pkg;\n"
                                    ...
                                    + " MethodMayBeStatic */ public class BaseParcelable implements"
                                    + " Parcelable {\n"
                                    + "    @NonNull\n"
                                    ...
                                    + "    }\n"
                                    + "\n"
                                    + "    public static final Creator<BaseParcelable> CREATOR ="
                                    + " new Creator<BaseParcelable>() {\n"
                                    + "        @NonNull\n"
                                    + "        @Override\n"
                                    + "        public BaseParcelable createFromParcel(@NonNull"
                                    + " Parcel in) {\n"
                                    ...
                                    + "\n"
                                    + "    @Override\n"
                                    + "    public void writeToParcel(@NonNull Parcel dest, int"
                                    + " flags) {\n"
        ...
        lint().files(
                        ...
                        kotlin(
                                "package test.pkg\n"
                                    ...
                                    + "    data class Square(val circleDimmed: Boolean) :"
                                    + " ImageConfig()\n"
