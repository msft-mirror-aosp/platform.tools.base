    ...
    public void testRemoveTest() {
                ...
                lint().files(
                                kotlin(
                                        ""
                                                ...
                                                + "    listGetter: () -> List<MutableList<String>>, removeFirstIndex: Int, removeLast: () -> Int\n"
                                                + ") {\n"
                                                + "    list.removeFirst()\n"
                                                + "    list.removeLast()\n"
                                                + "    listGetter().get(\n"
      ...
      AndroidVersion version =
        ...
        if (version.getApiLevel() < 35) {
            result.expect(
                            ""
                                    + "src/test.kt:7: Warning: This Kotlin extension function will be hidden by java.util.SequencedCollection starting in API 35: removeFirst. When this source code is recompiled against API level 35, it will crash on older levels. You can avoid this by using removeAt(0) instead. [NewApi]\n"
                                    + "    list.removeFirst()\n"
                                    + "         ~~~~~~~~~~~~~\n"
                                    + "src/test.kt:8: Warning: This Kotlin extension function will be hidden by java.util.SequencedCollection starting in API 35: removeLast. When this source code is recompiled against API level 35, it will crash on older levels. You can avoid this by using removeAt(list.lastIndex) instead. [NewApi]\n"
                                    + "    list.removeLast()\n"
                                    + "         ~~~~~~~~~~~~\n"
                                    + "src/test.kt:11: Warning: This Kotlin extension function will be hidden by java.util.SequencedCollection starting in API 35: removeFirst. When this source code is recompiled against API level 35, it will crash on older levels. You can avoid this by using removeAt(0) instead. [NewApi]\n"
                                    + "    ).removeFirst()\n"
                                    + "      ~~~~~~~~~~~~~\n"
                                    + "src/test.kt:14: Warning: This Kotlin extension function will be hidden by java.util.SequencedCollection starting in API 35: removeLast. When this source code is recompiled against API level 35, it will crash on older levels. You can avoid this by using removeAt(listGetter().get(removeLast()).lastIndex) instead. [NewApi]\n"
                                    + "    ).removeLast()\n"
                                    + "      ~~~~~~~~~~~~\n"
                                    + "src/test.kt:18: Warning: This Kotlin extension function will be hidden by java.util.SequencedCollection starting in API 35: removeFirst. When this source code is recompiled against API level 35, it will crash on older levels. You can avoid this by using removeAt(0) instead. [NewApi]\n"
                                    + "    return removeFirst()\n"
                                    + "           ~~~~~~~~~~~~~\n"
                                    + "src/test.kt:22: Warning: This Kotlin extension function will be hidden by java.util.SequencedCollection starting in API 35: removeLast. When this source code is recompiled against API level 35, it will crash on older levels. You can avoid this by using removeAt(lastIndex) instead. [NewApi]\n"
                                    + "    return removeLast()\n"
                                    + "           ~~~~~~~~~~~~\n"
                                    + "0 errors, 6 warnings")
                    .expectFixDiffs(
                            ""
                                    ...
                                    + "-     list.removeFirst()\n"
                                    + "+     list.removeAt(0)\n"
                                    + "Fix for src/test.kt line 8: Replace with removeAt(list.lastIndex):\n"
                                    + "@@ -8 +8\n"
                                    + "-     list.removeLast()\n"
                                    ...
                                    + "-     ).removeFirst()\n"
                                    + "+     ).removeAt(0)\n"
                                    + "Fix for src/test.kt line 14: Replace with removeAt(listGetter().get(removeLast()).lastIndex):\n"
                                    + "@@ -14 +14\n"
                                    + "-     ).removeLast()\n"
            ...
            result.expect(
                            ""
                                    + "src/test.kt:7: Error: Call requires API level 35 (current min is 1): java.util.List#removeFirst (Prior to API level 35, this call would resolve to a Kotlin stdlib extension function. You can use removeAt(0) instead.) [NewApi]\n"
                                    + "    list.removeFirst()\n"
                                    + "         ~~~~~~~~~~~~~\n"
                                    + "src/test.kt:8: Error: Call requires API level 35 (current min is 1): java.util.List#removeLast (Prior to API level 35, this call would resolve to a Kotlin stdlib extension function. You can use removeAt(list.lastIndex) instead.) [NewApi]\n"
                                    + "    list.removeLast()\n"
                                    + "         ~~~~~~~~~~~~\n"
                                    + "src/test.kt:11: Error: Call requires API level 35 (current min is 1): java.util.List#removeFirst (Prior to API level 35, this call would resolve to a Kotlin stdlib extension function. You can use removeAt(0) instead.) [NewApi]\n"
                                    + "    ).removeFirst()\n"
                                    + "      ~~~~~~~~~~~~~\n"
                                    + "src/test.kt:14: Error: Call requires API level 35 (current min is 1): java.util.List#removeLast (Prior to API level 35, this call would resolve to a Kotlin stdlib extension function. You can use removeAt(listGetter().get(removeLast()).lastIndex) instead.) [NewApi]\n"
                                    + "    ).removeLast()\n"
                                    + "      ~~~~~~~~~~~~\n"
                                    + "src/test.kt:18: Error: Call requires API level 35 (current min is 1): java.util.List#removeFirst (Prior to API level 35, this call would resolve to a Kotlin stdlib extension function. You can use removeAt(0) instead.) [NewApi]\n"
                                    + "    return removeFirst()\n"
                                    + "           ~~~~~~~~~~~~~\n"
                                    + "src/test.kt:22: Error: Call requires API level 35 (current min is 1): java.util.List#removeLast (Prior to API level 35, this call would resolve to a Kotlin stdlib extension function. You can use removeAt(lastIndex) instead.) [NewApi]\n"
                                    + "    return removeLast()\n"
                                    + "           ~~~~~~~~~~~~\n"
                                    + "6 errors, 0 warnings")
                    .expectFixDiffs(
