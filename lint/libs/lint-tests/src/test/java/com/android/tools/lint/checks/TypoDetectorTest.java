...
public class TypoDetectorTest extends AbstractCheckTest {
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile typos2 =
            xml(
                    "res/values-en-rUS/strings-en.xml",
                    ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<resources>\n"
                            + "    <!-- No typos -->\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile typos3 =
            xml(
                    "res/values-b+en+USA/strings-en.xml",
                    ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<resources>\n"
                            + "    <!-- No typos -->\n"
    ...
    @SuppressWarnings("all") // Sample code
    private TestFile typos4 =
            xml(
                    "res/values-xy/strings.xml",
                    ""
                            + "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                            + "<resources>\n"
                            + "    <!-- No typos -->\n"
