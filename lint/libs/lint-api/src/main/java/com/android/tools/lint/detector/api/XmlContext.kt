...
open class XmlContext(
  ...
  fun getLocation(textNode: Node, begin: Int, end: Int): Location {
    assert(textNode.nodeType == Node.TEXT_NODE || textNode.nodeType == Node.COMMENT_NODE || textNode.nodeType == Node.CDATA_SECTION_NODE)
   ...
   * @param scope the DOM node scope the error applies to. The lint infrastructure will check whether there are suppress directives on this
