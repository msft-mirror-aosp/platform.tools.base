...
class VersionTest {
  ...
  fun testParseExactVersion() {
    ...
    assertThat(Version.parse("1.0-20150201.131010-1").toString()).isEqualTo("1.0-20150201.131010-1")
    ...
    assertThat(Version.parse("3.9223372036854775808").toString()).isEqualTo("3.9223372036854775808")
    assertThat(Version.parse("4.18446744073709551616").toString()).isEqualTo("4.18446744073709551616")
  ...
  fun testNonNumericLexicographic() {
    listOf("1.A", "1.B", "1.a", "1.b").let {
      it.zipWithNext().forEach { pair -> assertThat(Version.parse(pair.first)).isLessThan(Version.parse(pair.second)) }
    }
  }
  ...
  fun testSpecialHigherThanOtherNonNumeric() {
    listOf("1.0-zeta", "1.0-rc", "1.0-snapshot", "1.0-final", "1.0-ga", "1.0-release", "1.0-sp", "1.0").let {
      it.zipWithNext().forEach { pair -> assertThat(Version.parse(pair.first)).isLessThan(Version.parse(pair.second)) }
    }
  }
  ...
  fun testPrefixInfimum() {
    assertThat(Version.prefixInfimum("1").toString()).isEqualTo("prefix infimum version for \"1\"")
  }
  ...
  fun testNextPrefix() {
    ...
    assertThat(Version.parse("1.rc").nextPrefix()).isEqualTo(Version.prefixInfimum("1.snapshot"))
    assertThat(Version.parse("1.snapshot").nextPrefix()).isEqualTo(Version.prefixInfimum("1.final"))
    ...
    assertThat(Version.parse("1.2147483648").nextPrefix()).isEqualTo(Version.prefixInfimum("1.2147483649"))
    assertThat(Version.parse("2.4294967296").nextPrefix()).isEqualTo(Version.prefixInfimum("2.4294967297"))
    assertThat(Version.parse("3.9223372036854775808").nextPrefix()).isEqualTo(Version.prefixInfimum("3.9223372036854775809"))
    assertThat(Version.parse("4.18446744073709551616").nextPrefix()).isEqualTo(Version.prefixInfimum("4.18446744073709551617"))
    assertThat(Version.parse("1.2212222019").nextPrefix()).isEqualTo(Version.prefixInfimum("1.2212222020"))
  }
  ...
  fun testPreviewInfimum() {
    ...
    assertThat(Version.parse("2-alpha1-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("2"))
    assertThat(Version.parse("2-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("2"))
    assertThat(Version.parse("2-snapshot").previewInfimum).isEqualTo(Version.prefixInfimum("2"))
    assertThat(Version.parse("2-dev").previewInfimum).isEqualTo(Version.prefixInfimum("2"))
    assertThat(Version.parse("1.2").previewInfimum).isNull()
    assertThat(Version.parse("1.2-alpha3").previewInfimum).isEqualTo(Version.prefixInfimum("1.2"))
    assertThat(Version.parse("1.2-alpha3-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("1.2"))
    assertThat(Version.parse("1.2-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("1.2"))
    assertThat(Version.parse("1.2.3").previewInfimum).isNull()
    assertThat(Version.parse("1.2.3-alpha4").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3"))
    assertThat(Version.parse("1.2.3-alpha-4").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3"))
    assertThat(Version.parse("1.2.3-alpha4-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3"))
    assertThat(Version.parse("1.2.3-alpha-4-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3"))
    assertThat(Version.parse("1.2.3-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3"))
    assertThat(Version.parse("1.2.3.4").previewInfimum).isNull()
    assertThat(Version.parse("1.2.3.4.5-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3.4.5"))
    assertThat(Version.parse("1.2.3.4.5.6-alpha9-SNAPSHOT").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3.4.5.6"))
    assertThat(Version.parse("7.0.0-dev03").previewInfimum).isEqualTo(Version.prefixInfimum("7.0.0"))

    assertThat(Version.parse("1-SNAPSHOT.3").previewInfimum).isEqualTo(Version.prefixInfimum("1"))
    assertThat(Version.parse("1-dev.3").previewInfimum).isEqualTo(Version.prefixInfimum("1"))
    assertThat(Version.parse("1.2.3-alpha4-beta5").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3"))
    assertThat(Version.parse("1.2.3-beta4-alpha5").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3"))
    assertThat(Version.parse("1.2.3-alpha.10").previewInfimum).isEqualTo(Version.prefixInfimum("1.2.3"))
  ...
  fun testPreviewSupremum() {
    ...
    assertThat(Version.parse("2-alpha1-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("2"))
    assertThat(Version.parse("2-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("2"))
    assertThat(Version.parse("2-snapshot").previewSupremum).isEqualTo(Version.parse("2"))
    assertThat(Version.parse("2-dev").previewSupremum).isEqualTo(Version.parse("2"))
    assertThat(Version.parse("1.2").previewSupremum).isNull()
    assertThat(Version.parse("1.2-alpha3").previewSupremum).isEqualTo(Version.parse("1.2"))
    assertThat(Version.parse("1.2-alpha3-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("1.2"))
    assertThat(Version.parse("1.2-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("1.2"))
    assertThat(Version.parse("1.2.3").previewSupremum).isNull()
    assertThat(Version.parse("1.2.3-alpha4").previewSupremum).isEqualTo(Version.parse("1.2.3"))
    assertThat(Version.parse("1.2.3-alpha-4").previewSupremum).isEqualTo(Version.parse("1.2.3"))
    assertThat(Version.parse("1.2.3-alpha4-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("1.2.3"))
    assertThat(Version.parse("1.2.3-alpha-4-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("1.2.3"))
    assertThat(Version.parse("1.2.3-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("1.2.3"))
    assertThat(Version.parse("1.2.3.4").previewSupremum).isNull()
    assertThat(Version.parse("1.2.3.4.5-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("1.2.3.4.5"))
    assertThat(Version.parse("1.2.3.4.5.6-alpha9-SNAPSHOT").previewSupremum).isEqualTo(Version.parse("1.2.3.4.5.6"))
    assertThat(Version.parse("7.0.0-dev03").previewSupremum).isEqualTo(Version.parse("7.0.0"))

    assertThat(Version.parse("1-SNAPSHOT.3").previewSupremum).isEqualTo(Version.parse("1"))
    assertThat(Version.parse("1-dev.3").previewSupremum).isEqualTo(Version.parse("1"))
    assertThat(Version.parse("1.2.3-alpha4-beta5").previewSupremum).isEqualTo(Version.parse("1.2.3"))
    assertThat(Version.parse("1.2.3-beta4-alpha5").previewSupremum).isEqualTo(Version.parse("1.2.3"))
    assertThat(Version.parse("1.2.3-alpha.10").previewSupremum).isEqualTo(Version.parse("1.2.3"))
