...
class DependencyTest {
  ...
  fun testExplicitlyIncludesPreview() {
    ...
    for (v in listOf("+", "[1,2)", "1.2.+", "1.2.3")) {
      ...
      Dependency.parse("com.example:example:$v!!1.2.3-rc").let { dependency -> assertThat(dependency.explicitlyIncludesPreview).isTrue() }
      ...
      Dependency(
          ...
          version =
            RichVersion(
              declaration = RichVersion.Declaration(RichVersion.Kind.REQUIRE, VersionRange.parse("1.2.3")),
              exclude = listOf(VersionRange.parse("1.2.4-alpha01")),
            ),
        )
        .let { dependency -> assertThat(dependency.explicitlyIncludesPreview).isFalse() }
    }
    ...
    // missing version
    Dependency.parse("com.example:example").let { dependency -> assertThat(dependency.explicitlyIncludesPreview).isFalse() }
  }
  ...
  fun testHasExplicitDistinctUpperBound() {
    ...
    Dependency(
        ...
        version =
          RichVersion(
            RichVersion.Declaration(RichVersion.Kind.REQUIRE, VersionRange.parse("[1,]")),
    ...
    // missing version
    Dependency.parse("com.example:example").let { dependency -> assertThat(dependency.hasExplicitDistinctUpperBound).isFalse() }
  }
  ...
  fun testModule() {
    for (name in listOf("", "example", "example-foo")) {
      ...
      for (version in listOf("1", "+", "[2,3]")) {
        assertThat(Dependency(name = name, version = RichVersion.parse(version)).module).isNull()
      }
    }
  }
  ...
  fun testInvalidGroup() {
    ...
    Dependency(name = "valid-name", version = RichVersion.parse("1.2.3"), classifier = "jre8").let {
      assertThat(it.toIdentifier()).isNull()
      assertThat(it.toString()).matches("^Dependency\\(.*\\)")
    }
    Dependency(name = "valid-name", version = RichVersion.parse("1.2.3"), classifier = "jre8", extension = "aar").let {
      assertThat(it.toIdentifier()).isNull()
      assertThat(it.toString()).matches("^Dependency\\(.*\\)")
    }
  }
  ...
  fun testInvalidVersion() {
    ...
    Dependency(group = "valid-group", name = "valid-name", version = RichVersion.parse("1:2")).let {
      assertThat(it.toIdentifier()).isNull()
      assertThat(it.toString()).matches("^Dependency\\(.*\\)")
    }
    Dependency(group = "valid-group", name = "valid-name", version = RichVersion.parse("1@2")).let {
    ...
    val version =
      RichVersion(declaration = RichVersion.Declaration(RichVersion.Kind.REQUIRE, VersionRange.parse("+")), prefer = Version.parse("1.2.3"))
    ...
    Dependency(group = "valid-group", name = "valid-name", classifier = "jre8", extension = "aar").let {
      assertThat(it.toIdentifier()).isNull()
      assertThat(it.toString()).matches("^Dependency\\(.*\\)")
    }
  }
  ...
  fun testInvalidClassifier() {
    Dependency(group = "valid-group", name = "valid-name", version = RichVersion.parse("valid-version"), classifier = "j@e8").let {
      assertThat(it.toIdentifier()).isNull()
      assertThat(it.toString()).matches("^Dependency\\(.*\\)")
    }
  }
  ...
  fun testInvalidExtension() {
    ...
    Dependency(group = "valid-group", name = "valid-name", version = RichVersion.parse("valid-version"), extension = "a@r").let {
      assertThat(it.toIdentifier()).isNull()
      assertThat(it.toString()).matches("^Dependency\\(.*\\)")
    }
    Dependency(
