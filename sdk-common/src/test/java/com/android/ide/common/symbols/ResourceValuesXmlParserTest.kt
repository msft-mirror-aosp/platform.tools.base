...
class ResourceValuesXmlParserTest {
  ...
  fun parseAttr() {
    ...
    val table = parseValuesResource(XmlUtils.parseDocument(xml, true), IdProvider.sequential(), platformAttrSymbols)
...
<resources>
    ...
    val expected =
      SymbolTable.builder()
        ...
        .add(SymbolTestUtils.createSymbol("styleable", "oneattr", "int[]", "{ 0x7f040001 }", ImmutableList.of("enums")))
        ...
        .add(
          SymbolTestUtils.createSymbol("styleable", "twoattrs", "int[]", "{ 0x7f040002, 0x7f040003 }", ImmutableList.of("flags", "nothing"))
        )
        .build()
  ...
  fun parseStyleableWithAndroidAttr() {
    val androidSymbols =
      SymbolTable.builder().add(SymbolTestUtils.createSymbol("attr", "foo", "int", 0x10_04_0001)).tablePackage("android").build()
    ...
    val table = parseValuesResource(XmlUtils.parseDocument(xml, true), IdProvider.sequential(), androidSymbols)

    val expected =
      SymbolTable.builder()
        .add(SymbolTestUtils.createSymbol("styleable", "oneattr", "int[]", "{ 0x10040001 }", ImmutableList.of("android:foo")))
        .build()
  ...
  fun parseDrawable() {
    ...
    val expected = SymbolTable.builder().add(SymbolTestUtils.createSymbol("drawable", "foo", "int", 0x7f_08_0001)).build()
  ...
  fun parseId() {
    ...
    val expected = SymbolTable.builder().add(SymbolTestUtils.createSymbol("id", "foo", "int", 0x7f_0b_0001)).build()
  ...
  fun parseInteger() {
    ...
    val expected = SymbolTable.builder().add(SymbolTestUtils.createSymbol("integer", "a", "int", 0x7f_0c_0001)).build()
  ...
  fun parseIntegerArray() {
    ...
    val expected = SymbolTable.builder().add(SymbolTestUtils.createSymbol("array", "ints", "int", 0x7f_03_0001)).build()
  ...
  fun parsePlurals() {
    ...
    val expected = SymbolTable.builder().add(SymbolTestUtils.createSymbol("plurals", "plu", "int", 0x7f_12_0001)).build()
  ...
  fun parseString() {
    ...
    val expected = SymbolTable.builder().add(SymbolTestUtils.createSymbol("string", "a", "int", 0x7f_14_0001)).build()
  ...
  fun parseStringArray() {
    ...
    val expected = SymbolTable.builder().add(SymbolTestUtils.createSymbol("array", "strings", "int", 0x7f_03_0001)).build()
  ...
  fun parseTypedArray() {
    ...
    val expected =
      SymbolTable.builder()
        .add(SymbolTestUtils.createSymbol("array", "string_refs", "int", 0x7f_03_0001))
  ...
  fun parseItem() {
    ...
    val itemTable = parseValuesResource(XmlUtils.parseDocument(itemXml, true), IdProvider.sequential(), platformAttrSymbols)
    val noItemTable = parseValuesResource(XmlUtils.parseDocument(noItemXml, true), IdProvider.sequential(), platformAttrSymbols)
    ...
    val expected =
      SymbolTable.builder()
        ...
        .add(SymbolTestUtils.createSymbol("attr?", "labelPosition", "int", 0x7f_04_0002))
        .add(
  ...
  fun parseIncorrectStyleable() {
    ...
    try {
      parseValuesResource(XmlUtils.parseDocument(xml, true), IdProvider.sequential(), platformAttrSymbols)
      fail()
    } catch (e: ResourceValuesXmlParseException) {
      // expected
      assertThat(e.message).contains("Illegal type under declare-styleable: was <enum>, only accepted is <attr>")
    }
  }
...
<resources xmlns:android="http://schemas.android.com/apk/res/anroid" xmlns:aapt="http://schemas.android.com/aapt">
    ...
    val actual = parseValuesResource(XmlUtils.parseDocument(xml, true), IdProvider.sequential(), platformAttrSymbols)

    val expected =
      SymbolTable.builder()
        .add(SymbolTestUtils.createSymbol("color", "colorPrimary", "int", 0x7f_06_0001))
        .add(SymbolTestUtils.createSymbol("color", "colorPrimaryDark", "int", 0x7f_06_0002))
        .add(SymbolTestUtils.createSymbol("color", "colorAccent", "int", 0x7f_06_0003))
        .add(SymbolTestUtils.createSymbol("styleable", "foo_declare_styleable", "int[]", "{  }"))
        .add(SymbolTestUtils.createSymbol("anim", "foo_anim", "int", 0x7f_01_0001))
        .add(SymbolTestUtils.createSymbol("animator", "foo_animator", "int", 0x7f_02_0001))
        .add(SymbolTestUtils.createSymbol("drawable", "foo_drawable", "int", 0x7f_08_0001))
        .add(SymbolTestUtils.createSymbol("fraction", "foo_fraction", "int", 0x7f_0a_0001))
        .add(SymbolTestUtils.createSymbol("integer", "foo_integer", "int", 0x7f_0c_0001))
        .add(SymbolTestUtils.createSymbol("menu", "foo_menu", "int", 0x7f_0f_0001))
        .add(SymbolTestUtils.createSymbol("mipmap", "foo_mipmap", "int", 0x7f_10_0001))
        .add(SymbolTestUtils.createSymbol("raw", "foo_raw", "int", 0x7f_13_0001))
        .add(SymbolTestUtils.createSymbol("style", "foo_style", "int", 0x7f_15_0001))
        .add(SymbolTestUtils.createSymbol("transition", "foo_transition", "int", 0x7f_17_0001))
