...
class SymbolTableMergeTest {
  ...
  @Test
  fun testBasicMerge() {
    val androidSymbols = SymbolTable.builder().tablePackage("android").build()

    val table1 = SymbolTable.builder().tablePackage("table1").add(symbol("dimen", "a", "int", 1)).build()

    val table2 = SymbolTable.builder().tablePackage("table2").add(symbol("attr", "b", "int", 2)).build()

    val result = mergeAndRenumberSymbols("", table1, ImmutableSet.of(table2), androidSymbols)

    val expected =
      SymbolTable.builder().add(symbol("dimen", "a", "int", 0x7f_07_0001)).add(symbol("attr", "b", "int", 0x7f_04_0001)).build()
  ...
  fun testMergeWithDuplicated() {
    ...
    val table1 = SymbolTable.builder().tablePackage("table1").add(symbol("dimen", "a", "int", 0)).add(symbol("attr", "b", "int", 0)).build()

    val table2 = SymbolTable.builder().tablePackage("table2").add(symbol("attr", "b", "int", 0)).build()
  ...
  fun testMergeWithSimpleStyleable() {
    ...
    val table1 = SymbolTable.builder().tablePackage("table1").add(symbol("dimen", "a", "int", 0)).build()
  ...
  fun testMergeWithStyleableWithAttrFromAnotherTable() {
    ...
    val table1 =
      SymbolTable.builder().tablePackage("table1").add(symbol("attr", "a1", "int", 27)).add(symbol("attr", "a2", "int", 35)).build()
  ...
  fun testMergeWithStyleableWithAndroidAttr() {
    val androidSymbols = SymbolTable.builder().tablePackage("android").add(symbol("attr", "foo", "int", 0x10_04_002A)).build()

    val table1 = SymbolTable.builder().tablePackage("table1").build()
  ...
  fun testMergeWithRedefinedStyleable() {
    ...
    val expected =
      SymbolTable.builder()
        ...
        .add(symbol("styleable", "style1", "int[]", "{ 0x7f040001, 0x7f040002, 0x7f040003, 0x7f040004 }", listOf("a1", "a2", "b1", "b2")))
        .build()
  ...
  fun testMergeWithRedefinedStyleableAndNestedChildren() {
    ...
    val expected =
      SymbolTable.builder()
        ...
        .add(symbol("attr", "b1", "int", 0x7f_04_0003))
        .add(symbol("attr", "b2", "int", 0x7f_04_0004))
        .add(symbol("styleable", "style1", "int[]", "{ 0x7f040001, 0x7f040003, 0x7f040004 }", listOf("a1", "b1", "b2")))
        .build()
  ...
  fun testEmptyStyleables() {
    ...
    val table1 =
      SymbolTable.builder().tablePackage("table1").add(symbol("styleable", "empty_style", "int[]", "{ }", ImmutableList.of())).build()
    ...
    val result = mergeAndRenumberSymbols("", table1, ImmutableSet.of(table2, table3), androidSymbols)
  ...
  fun testMissingChildStyleable() {
    val androidSymbols = SymbolTable.builder().tablePackage("android").add(symbol("attr", "foo", "int", 42)).build()

    val dep = SymbolTable.builder().tablePackage("dep").add(symbol("styleable", "dep_style", "int[]", "{ }", ImmutableList.of())).build()

    val thisLibrary =
      SymbolTable.builder()
        .tablePackage("table3")
        .add(symbol("styleable", "dep_style", "int[]", "{ 0x1, 0x2 }", ImmutableList.of("android:foo", "my_bar")))
        .add(symbol("attr", "my_bar", "int", 0))
        .build()

    val result = mergeAndRenumberSymbols("", thisLibrary, ImmutableList.of(dep), androidSymbols)

    val expected =
      SymbolTable.builder()
        .add(symbol("attr", "my_bar", "int", 0x7f040001))
        .add(symbol("styleable", "dep_style", "int[]", "{ 42, 0x7f040001 }", ImmutableList.of("android:foo", "my_bar")))
        .build()
  ...
  fun testAndroidPrefixes() {
    ...
    val table1 =
      SymbolTable.builder()
        ...
        .add(symbol("styleable", "style1", "int[]", "{ 12, 42 }", listOf("android:foo", "bar")))
        .build()
    ...
    val table2 =
      SymbolTable.builder()
        ...
        .add(symbol("styleable", "style2", "int[]", "{ 12, 999, 42 }", listOf("android_foo", "android_not_found", "bar")))
        .build()
    ...
    val expected =
      SymbolTable.builder()
        ...
        .add(symbol("styleable", "style1", "int[]", "{ 0x1004002a, 0x7f040001 }", listOf("android:foo", "bar")))
        .add(symbol("styleable", "style2", "int[]", "{ 0x1004002a, 0, 0x7f040001 }", listOf("android_foo", "android_not_found", "bar")))
        .build()
