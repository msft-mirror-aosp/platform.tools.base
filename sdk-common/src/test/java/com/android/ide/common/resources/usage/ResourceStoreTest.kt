...
class ResourceStoreTest {
  ...
  fun testSimple() {
    ...
    assertThat(ResourceStore.serialize(store, true))
      .isEqualTo(
  ...
  fun testMerge() {
    ...
    val store3 =
      ResourceStore.deserialize("dimen[dim(E)],layout[activity_main(DR,7f070000),included(E)],string[hello_world(E,7f030000)];;;string/s*;")
    ...
    assertThat(merged)
      .isEqualTo(
        "dimen[dim(E)],layout[activity_main(U,7f070000),included(E)],string[app_name(DP),hello_world(E,7f030000),app_name2(E)];1^2^4;layout/included,string/*;dimen/d*,string/s*;"
      )
  ...
  fun testTypes() {
    ...
    ResourceStore.deserialize("P;dimen[name1_ref(E),name0_ref(E),name0(E,test.pkg)],sample[name1(E,test.pkg)];2^1,3^0;;;")
  }
}
