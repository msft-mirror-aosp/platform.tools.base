...
class AgpVersionTest {
  ...
  fun testTryParse() {
    ...
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.0.0-alpha1"))).isEqualTo("3.0.0-alpha1")
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.0.0-beta1"))).isEqualTo("3.0.0-beta1")
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.0.0-rc1"))).isEqualTo("3.0.0-rc1")
    /** 3.1.0 has zero-padding on alpha and rc but not beta preview versions */
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.1.0-alpha01"))).isEqualTo("3.1.0-alpha1")
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.1.0-beta1"))).isEqualTo("3.1.0-beta1")
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.1.0-rc01"))).isEqualTo("3.1.0-rc1")
    /** 3.2.0 has zero-padding on all preview versions */
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.2.0-alpha01"))).isEqualTo("3.2.0-alpha1")
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.2.0-beta01"))).isEqualTo("3.2.0-beta1")
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.2.0-rc01"))).isEqualTo("3.2.0-rc1")
    /** dev versions */
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.0.0-dev"))).isEqualTo("3.0.0-dev")
    assertThat(convertAGPVersionToString(AgpVersion.tryParse("3.1.0-dev"))).isEqualTo("3.1.0-dev")
  ...
  fun testTryParseStable() {
    ...
    assertThat(convertAGPVersionToString(AgpVersion.tryParseStable("10.10.10"))).isEqualTo("10.10.10")
  ...
  fun testParseStable() {
    ...
    try {
      ...
      assertThat(e.message).isEqualTo("'4.0.0-alpha01' is not a valid stable AGP version string.")
    }
  }
  ...
  fun testIsAtLeast() {
    ...
    AgpVersion.parse("7.1.1").let { version -> assertThat(version.isAtLeast(7, 2, 0, "alpha", 1, true)).isFalse() }
  }
  ...
  @Test
  fun testWithPreview() {
    assertThat(AgpVersion.parse("3.1.0").withPreview("alpha02")).isEqualTo(AgpVersion.parse("3.1.0-alpha02"))
    assertThat(AgpVersion.parse("3.1.0").withPreview("beta2")).isEqualTo(AgpVersion.parse("3.1.0-beta2"))
    assertThat(AgpVersion.parse("3.1.0").withPreview("rc02")).isEqualTo(AgpVersion.parse("3.1.0-rc02"))
    assertThat(AgpVersion.parse("7.0.0-alpha01").withPreview("alpha02")).isEqualTo(AgpVersion.parse("7.0.0-alpha02"))
    assertThat(AgpVersion.parse("7.0.0-alpha01").withPreview("beta02")).isEqualTo(AgpVersion.parse("7.0.0-beta02"))
    assertThat(AgpVersion.parse("7.0.0-alpha01").withPreview("rc02")).isEqualTo(AgpVersion.parse("7.0.0-rc02"))
    assertThat(AgpVersion.parse("7.0.0-alpha01").withPreview("dev")).isEqualTo(AgpVersion.parse("7.0.0-dev"))
  }
  ...
  private fun compareAGPVersions(version1: String, version2: String): Int = AgpVersion.parse(version1).compareTo(AgpVersion.parse(version2))
