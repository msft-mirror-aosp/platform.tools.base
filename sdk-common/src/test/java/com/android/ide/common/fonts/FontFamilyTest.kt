...
class FontFamilyTest {
    ...
    private fun createFontFamily(provider: FontProvider,
        ...
        return FontFamily(provider, fontSource, name, menuUrl, menuName, listOf(MutableFontDetail(name, 400, 100f, NORMAL, DEFAULT_EXACT, "https://fonts.com/roboto/v15/qrs.ttf", "", false)))
    }
}
