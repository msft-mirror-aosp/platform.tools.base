...
/**
 * This class represents device properties that the transport daemon uses to determine device settings. The file written indicates the SDK
 * and release of the phone being simulated by the test.
 *
 * The file generated by this class is used by //tools/base/transport/utils/device_info.host.cc
 */
class DeviceProperties(private val serial: String, private val codeName: String, private val release: String, private val sdk: String) {
