...
class TransportServiceCommandTest : public ::testing::Test {
 public:
  TransportServiceCommandTest()
  ...
  void SetUp() override {
    ...
    events_thread_ = std::thread(&TransportServiceCommandTest::GetEvents, this);
  }
...
TEST_F(TransportServiceCommandTest, TestBeginSessionCommand) {
