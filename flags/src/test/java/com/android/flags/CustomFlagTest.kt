...
class CustomFlagTest {
  ...
  fun checkAllowList() {
    ...
    assertFailsWith<Exception> { InvalidFlag() }
  }

  class NonDataClassCustomValue(val value: String) {
    override fun toString() = "NonDataClassCustomValue(value=$value)"
  }
  ...
  fun checkValidation() {
    ...
    class CustomValueFlag :
      CustomTypeFlag<NonDataClassCustomValue>(
    ...
    val failure = assertFailsWith<Exception> { flag.validate() }
  }
}
