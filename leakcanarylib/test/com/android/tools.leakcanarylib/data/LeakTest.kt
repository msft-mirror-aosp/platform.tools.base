...
class LeakTest {
  ...
  fun `parseMultipleLibraryLeak - complete leak information found and can be parsed`() {
    ...
    val expectedLibraryLeakString =
      libraryLeakText.lines().filterNot { it.contains("Leak pattern:") || it.contains("Description:") }.joinToString("\n").trim()
