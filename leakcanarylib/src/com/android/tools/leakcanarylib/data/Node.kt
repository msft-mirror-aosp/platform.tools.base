...
/**
 * This class represents node in a memory leak trace analysis. Each node holds information about a specific object, its type, its role in
 * the leak, and related memory statistics.
 */
data class Node(
