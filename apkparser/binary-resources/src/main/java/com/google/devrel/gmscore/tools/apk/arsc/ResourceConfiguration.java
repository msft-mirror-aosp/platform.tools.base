...
public abstract class ResourceConfiguration implements SerializableResource {
  ...
  static final int GRAMMATICAL_GENDER_NOT_SPECIFIED = 0;
  static final int GRAMMATICAL_GENDER_NEUTRAL = 0x01;
  static final int GRAMMATICAL_GENDER_FEMININE = 0x02;
  static final int GRAMMATICAL_GENDER_MASCULINE = 0x03;

  private static final Map<Integer, String> GRAMMATICAL_GENDER_VALUES;

  static {
    Map<Integer, String> map = new HashMap<>();
    map.put(GRAMMATICAL_GENDER_NOT_SPECIFIED, "");
    map.put(GRAMMATICAL_GENDER_NEUTRAL, "neuter");
    map.put(GRAMMATICAL_GENDER_FEMININE, "feminine");
    map.put(GRAMMATICAL_GENDER_MASCULINE, "masculine");
    GRAMMATICAL_GENDER_VALUES = Collections.unmodifiableMap(map);
  }
  ...
  /** The configured grammatical gender. */
  public abstract int grammaticalGender();
  ...
  static ResourceConfiguration create(ByteBuffer buffer) {
    ...
    configurationBuilder
        ...
        .grammaticalGender(Byte.toUnsignedInt(buffer.get()) & 0x3);
  ...
  public final boolean isDensityCompatibleWith(int deviceDensityDpi) {
    ...
    return switch (configDensity) {
      case DENSITY_DPI_UNDEFINED, DENSITY_DPI_ANY, DENSITY_DPI_NONE -> true;
      default -> configDensity <= deviceDensityDpi;
    };
  }
  ...
  public final byte[] toByteArray(int options) {
    ...
    buffer.put((byte) grammaticalGender());
  ...
  public final Map<Type, String> toStringParts() {
    ...
    result.put(
        Type.GRAMMATICAL_GENDER, getOrDefault(GRAMMATICAL_GENDER_VALUES, grammaticalGender(), ""));
  ...
  public abstract static class Builder {
    ...
    public abstract Builder grammaticalGender(int grammaticalGender);
