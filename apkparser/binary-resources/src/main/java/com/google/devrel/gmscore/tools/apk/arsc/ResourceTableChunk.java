...
public class ResourceTableChunk extends ChunkWithChunks {
  ...
  private final ListMultimap<String, PackageChunk> packages = ArrayListMultimap.create();
  ...
  /** Returns the package chunks with the given {@code packageName}. */
  public List<PackageChunk> getPackages(String packageName) {
    return Collections.unmodifiableList(packages.get(packageName));
  }
