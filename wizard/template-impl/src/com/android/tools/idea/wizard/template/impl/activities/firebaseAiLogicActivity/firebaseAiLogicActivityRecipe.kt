 ...
 */
package com.android.tools.idea.wizard.template.impl.activities.firebaseAiLogicActivity
...
import com.android.tools.idea.wizard.template.impl.activities.firebaseAiLogicActivity.res.values.stringsXml
import com.android.tools.idea.wizard.template.impl.activities.firebaseAiLogicActivity.src.app_package.bakingScreen
import com.android.tools.idea.wizard.template.impl.activities.firebaseAiLogicActivity.src.app_package.bakingViewModelKt
import com.android.tools.idea.wizard.template.impl.activities.firebaseAiLogicActivity.src.app_package.mainActivityKt
...
fun RecipeExecutor.firebaseAiLogicActivityRecipe(moduleData: ModuleTemplateData, activityClass: String, packageName: String) {
  ...
  addDependency(mavenCoordinate = "com.google.firebase:firebase-ai:17.+")
  ...
  open(rootOut.resolve("README.md"))
}
