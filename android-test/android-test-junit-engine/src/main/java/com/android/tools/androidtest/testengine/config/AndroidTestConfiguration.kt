...
package com.android.tools.androidtest.testengine.config

import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.AAPT2_PATH
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.ADB_PATH
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.ANDROID_TEST_EXECUTION_MODE
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.ANIMATIONS_DISABLED
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.APK_INSTALL_OPTIONS
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.DEVICE_SERIALS
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.INSTALL_TIMEOUT_MS
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.INSTRUMENTATION_ARGS
...
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.TEST_APKS
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.TEST_PACKAGE_ID
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.TEST_UTIL_APKS
import com.android.tools.androidtest.testengine.config.AndroidTestConfigurationKeys.UNINSTALL_AFTER_TESTS
import java.io.File
import org.junit.platform.engine.ExecutionRequest

/** Configuration for Android test engine extracted from [ExecutionRequest]. */
