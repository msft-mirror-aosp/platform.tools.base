...
class DeviceProcessCatalogTest {
        ...
        CoroutineTestUtils.runBlockingWithTimeout {
            ...
            catalog.trackProcesses().take(2).collect { processUpdates ->
                if (collectedIndex == 0) {
                    ...
                    assertEquals(1001, processInfo.userId.in32Value)
        ...
        CoroutineTestUtils.runBlockingWithTimeout {
            ...
            catalog.trackProcesses().take(2).collect { processUpdates ->
                if (collectedIndex == 0) {
                    ...
                    assertEquals(1002, processInfo.userId.in32Value)
    ...
    private fun createJdwpProcessInfo(
        ...
        builder.userId = userId?.let {
            OptionalInt32.newBuilder().setHasValue(true).setIn32Value(it).build()
