...
class JdwpProcessChangeFlowTest {
  ...
  @Test
  fun testConnectedDeviceDebuggableProcesses_tracksExistingProcess(): Unit = CoroutineTestUtils.runBlockingWithTimeout {
    // Prepare
  ...
  @Test
  fun testConnectedDeviceDebuggableProcesses_tracksNewProcess(): Unit = CoroutineTestUtils.runBlockingWithTimeout {
    // Prepare
    val deviceID = "1234"
    val fakeDevice =
  ...
  @Test
  fun testConnectedDeviceDebuggableProcesses_tracksRemovedProcess(): Unit = CoroutineTestUtils.runBlockingWithTimeout {
    // Prepare
    val (connectedDevice, fakeDevice) = connectOnlineDevice()
    val pid10 = 10
    fakeDevice.startClient(pid10, 0, "a.b.c", true)
  ...
  @Test
  fun testConnectedDeviceDebuggableProcesses_waitsForDeviceOnlineBeforeEmittingUpdates(): Unit = CoroutineTestUtils.runBlockingWithTimeout {
    // Prepare
    val deviceID = "1234"
    val pid10 = 10
    val fakeDevice =
  ...
  @Test
  fun testConnectedDeviceDebuggableProcesses_synchronized(): Unit = CoroutineTestUtils.runBlockingWithTimeout {
    // Prepare
    val (connectedDevice, fakeDevice) = connectOnlineDevice()
  ...
  @Test
  fun testConnectedDeviceDebuggableProcesses_throwsOnAlreadyDisconnectedDevice(): Unit = CoroutineTestUtils.runBlockingWithTimeout {
    // Prepare
    val deviceID = "1234"
    val fakeDevice =
      fakeAdb.connectDevice(
  ...
  @Test
  fun testConnectedDeviceDebuggableProcesses_throwsWhenDeviceDisconnects(): Unit = CoroutineTestUtils.runBlockingWithTimeout {
    // Prepare
    val (connectedDevice, fakeDevice) = connectOnlineDevice()
    val pid10 = 10
    fakeDevice.startClient(pid10, 0, "a.b.c", true)
