...
internal data class NanoTimeSpan(val startNano: Long, val endNano: Long) {
  ...
  companion object {
    fun assertNanoTimeSpansAreSorted(timeSpans: List<NanoTimeSpan>, expectedCount: Int) {
    ...
    fun assertNanoTimeSpansAreInterleaved(timeSpans: List<NanoTimeSpan>, expectedEntryCount: Int, entryDurationMillis: Int) {
      // Assert expected number of time spans
