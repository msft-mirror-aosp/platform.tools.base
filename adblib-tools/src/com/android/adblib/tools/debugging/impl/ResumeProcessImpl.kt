...
/**
 * Implementation of services related to [JdwpProcess.resumeProcess],
 * [ExternalJdwpProcessCommandDispatcher] and [useAppInfoForProcessProperties].
 */
internal class ResumeProcessImpl(private val process: JdwpProcess) {
    ...
    private suspend fun resumeProcessUsingDirectJdwpConnection() {
        require(device.useAppInfoForProcessProperties()) {
