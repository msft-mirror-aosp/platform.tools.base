...
/**
 * Common error codes contained in JDWP reply packets, documented
 * [here](https://docs.oracle.com/javase/7/docs/platform/jpda/jdwp/jdwp-protocol.html#JDWP_Error)
 *
...
internal enum class JdwpErrorCode(val errorCode: Int, val errorMessage: String) {
  ...
  companion object {
    ...
    /**
     * Performs a binary search looking for the [JdwpErrorCode] entry corresponding to [errorCode].
     *
     * Note: This custom implementation ensures we don't allocate any memory either for a static map from [errorCode] to [JdwpErrorCode], or
     * by calling the built-in [binarySearchBy].
     */
