...
/**
 * Collect the values of a [Flow] returned by [serviceInvocation] and store them in a [MutableStateFlow] ([destinationStateFlow]), retrying
 * the [serviceInvocation] for as long as the [ConnectedDevice.scope] is active.
 *
 * @param lastValue The value emitted to [destinationStateFlow] when the device scope is cancelled.
 * @param retryValue The value emitted to [destinationStateFlow] between a failure of [serviceInvocation] and a retry attempt to invoke it.
