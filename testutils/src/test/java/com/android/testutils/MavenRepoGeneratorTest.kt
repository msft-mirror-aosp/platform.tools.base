      ...
      val mavenRepo =
        MavenRepoGenerator(
          listOf(
            ...
            MavenRepoGenerator.Library("com.example:libc:1", "libc".toByteArray(), "com.example:liba:1", "com.example:libb:1"),
            ...
            Files.walkFileTree(
              ...
              object : SimpleFileVisitor<Path>() {
                override fun visitFile(file: Path, attrs: BasicFileAttributes?): FileVisitResult {
                  put(dir.relativize(file).toString(), Files.readAllLines(file).joinToString("\n"))
