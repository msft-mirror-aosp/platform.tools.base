...
open class FakeClock(private var now: Instant = Instant.EPOCH, private val zoneId: ZoneId = ZoneOffset.UTC) : Clock() {
  override fun instant() = now

  override fun withZone(otherZoneId: ZoneId): Clock =
    object : Clock() {
