 ...
 *
 * Do no use Directly. Instead use [AbstractBuildGivenBuildExpectTest] or [AbstractReturnGivenReturnExpectTest]
 */
abstract class AbstractGivenExpectTest<GivenT, ResultT> {
   ...
   *
   * This is to be used in tests where the action needs to be custom. If the action is the same for all the tests of the class, then
   * [defaultWhen] can be overridden instead.
   */
...
/** infix function to create Pair<>, similar to 'to'. this can read better when GivenT is a pair. */
