...
public class TestUtils {
     ...
     */
    public static final String KOTLIN_VERSION_FOR_TESTS = "2.1.20-Beta2";

    /** KSP version used by AGP integration tests. */
    public static final String KSP_VERSION_FOR_TESTS = "2.1.20-Beta2-1.0.29";
     ...
     */
    public static final String LATEST_KOTLIN_VERSION = "2.2.0-dev-5532";
