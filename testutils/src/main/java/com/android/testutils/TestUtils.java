...
public class TestUtils {
     ...
     */
    public static final String KOTLIN_VERSION_FOR_TESTS = "2.2.20-Beta1";

    /** KSP version used by AGP integration tests. */
    public static final String KSP_VERSION_FOR_TESTS = "2.2.20-Beta1-2.0.2";
     ...
     */
    public static final String KOTLIN_VERSION_FOR_COMPOSE_TESTS = "2.2.0";
     ...
     */
    public static final String LATEST_KOTLIN_VERSION = "2.2.20-dev-8371";
