...
public class AndroidxNameTest {
    ...
    public void multipleNames() {
        AndroidxName roomPkg =
                new AndroidxName(
                        "android.arch.persistence.room.", "androidx.room.", "androidx.room3.");
        assertEquals("android.arch.persistence.room.", roomPkg.oldName());
        assertEquals("androidx.room.", roomPkg.newName());
        assertEquals("android.arch.persistence.room.", roomPkg.defaultName());
        assertEquals(
                Arrays.asList(
                        "android.arch.persistence.room.", "androidx.room.", "androidx.room3."),
                roomPkg.names());

        assertTrue(roomPkg.isEquals("android.arch.persistence.room."));
        assertTrue(roomPkg.isEquals("androidx.room."));
        assertTrue(roomPkg.isEquals("androidx.room3."));
        assertFalse(roomPkg.isEquals("androidx.room4."));

        assertTrue(roomPkg.isEqualsIgnoreCase("androidx.ROOM3."));

        assertTrue(roomPkg.isPrefix("android.arch.persistence.room.Entity"));
        assertTrue(roomPkg.isPrefix("androidx.room.Entity"));
        assertTrue(roomPkg.isPrefix("androidx.room3.Entity"));
        assertFalse(roomPkg.isPrefix("androidx.room4.Entity"));

        assertEquals("Entity", roomPkg.removeFrom("android.arch.persistence.room.Entity"));
        assertEquals("Entity", roomPkg.removeFrom("androidx.room.Entity"));
        assertEquals("Entity", roomPkg.removeFrom("androidx.room3.Entity"));
        assertEquals("androidx.room4.Entity", roomPkg.removeFrom("androidx.room4.Entity"));
    }

    @Test
    public void ofWithMultipleNames() {
        AndroidxName roomPkg =
                new AndroidxName(
                        "android.arch.persistence.room.", "androidx.room.", "androidx.room3.");
        AndroidxName entity = AndroidxName.of(roomPkg, "Entity");

        assertEquals("android.arch.persistence.room.Entity", entity.oldName());
        assertEquals("androidx.room.Entity", entity.newName());
        assertEquals(
                Arrays.asList(
        ...
        assertTrue(entity.isEquals("android.arch.persistence.room.Entity"));
        assertTrue(entity.isEquals("androidx.room.Entity"));
        assertTrue(entity.isEquals("androidx.room3.Entity"));
        assertFalse(entity.isEquals("androidx.room4.Entity"));
    }
    ...
    public void documentedMappings() {
        ...
        final String documentedMappings =
                "android.arch.core:common\tandroidx.arch.core:core-common:2.0.0-rc01\n"
                    + "android.arch.core:core\tandroidx.arch.core:core-runtime:2.0.0-rc01\n"
                    ...
                    + "\tandroidx.test.services:test-services:1.1.0\n"
                    ...
                    + "com.google.android.exoplayer:extension-media2"
