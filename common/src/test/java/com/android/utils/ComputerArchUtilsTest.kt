    ...
    try {
      SystemPropertyOverrides().use { systemPropertyOverrides ->
        ...
        Environment.instance =
          object : Environment() {
            override fun getVariable(name: EnvironmentVariable): String? = if (name.key == "HOSTTYPE") "x86" else null
          }
        systemPropertyOverrides.setProperty("os.arch", "x86")
      ...
      SystemPropertyOverrides().use { systemPropertyOverrides ->
        ...
        Environment.instance =
          object : Environment() {
            ...
            override fun getVariable(name: EnvironmentVariable): String? = if (name.key == "PROCESSOR_ARCHITEW6432") "AMD64" else null
          }
        assertEquals(CpuArchitecture.X86_64, osArchitecture)
      }
    } finally {
