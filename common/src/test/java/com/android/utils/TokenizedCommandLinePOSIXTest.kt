...
class TokenizedCommandLinePOSIXTest {
  ...
  fun checkPreserveTicks() {
    checkTokenizationToCompilerFlags("-DX='Y Z'", listOf("-DX=Y Z"), listOf("-DX='Y Z'"))
  }
  ...
  companion object {
    ...
    private fun tokenizeCommandLineToEscaped(commandLine: String) =
      TokenizedCommandLine(commandLine = commandLine, raw = false, platform = SdkConstants.PLATFORM_LINUX).toTokenList()
