...
class TestThreadSleeperTest {
  ...
  fun sleep() {
    ...
    assertThat(testThreadSleeper.sleepArguments)
      .containsExactly(100L to 25, 40_000L to 0, 3_025L to 0, 15.hours.inWholeMilliseconds to 0)
      .inOrder()

    assertThat(testThreadSleeper.sleepDurations)
      .containsExactly(100.milliseconds + 25.nanoseconds, 40.seconds, 3025.milliseconds, 15.hours)
      .inOrder()

    assertThat(testThreadSleeper.totalMillisecondsSlept).isEqualTo(100 + 40_000 + 3_025 + 15.hours.inWholeMilliseconds)

    assertThat(testThreadSleeper.totalTimeSlept).isEqualTo(100.milliseconds + 25.nanoseconds + 40.seconds + 3_025.milliseconds + 15.hours)
  }
  ...
  fun nanosecondsInBounds() {
    ...
    assertThat(testThreadSleeper.sleepArguments).containsExactly(200L to 0, 1L to 999_999, 2L to 0, 2L to 1).inOrder()
  }
}
