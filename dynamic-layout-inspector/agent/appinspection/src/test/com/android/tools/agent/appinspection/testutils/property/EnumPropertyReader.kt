...
/** Class which wraps a [PropertyReader] but adds support for using enums instead of managing your own integer index list. */
class EnumPropertyReader<E : Enum<E>>(private val delegateReader: PropertyReader, private val indexOffset: Int = 0) {
