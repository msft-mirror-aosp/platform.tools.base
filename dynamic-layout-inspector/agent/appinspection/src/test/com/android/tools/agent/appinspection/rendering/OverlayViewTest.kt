...
class OverlayViewTest {
  ...
  fun testTouchEvents() = runTest {
    ...
    val rootId = root.uniqueDrawingId
    val expectedSelectionEvent =
      buildUserInputEventProto(rootId = rootId, x = 2f, y = 2f, type = LayoutInspectorViewProtocol.UserInputEvent.Type.SELECTION)
        .toByteArray()
  ...
  fun testTouchEventsRightClick() = runTest {
    ...
    val rootId = root.uniqueDrawingId
    val expectedRightClickEvent =
      buildUserInputEventProto(rootId = rootId, x = 2f, y = 2f, type = LayoutInspectorViewProtocol.UserInputEvent.Type.RIGHT_CLICK)
        .toByteArray()
    assertThat(receivedEvents).hasSize(1)
  ...
  fun testTouchEventsDoubleClick() = runTest {
    ...
    val expectedSelectionEvent =
      buildUserInputEventProto(rootId = rootId, x = 2f, y = 2f, type = LayoutInspectorViewProtocol.UserInputEvent.Type.SELECTION)
        .toByteArray()
    val expectedDoubleClickEvent =
      buildUserInputEventProto(rootId = rootId, x = 2f, y = 2f, type = LayoutInspectorViewProtocol.UserInputEvent.Type.DOUBLE_CLICK)
        .toByteArray()
  ...
  fun testHoverEvents() = runTest {
    ...
    val rootId = root.uniqueDrawingId
    val expectedHoverEvent =
      buildUserInputEventProto(rootId = rootId, x = 2f, y = 2f, type = LayoutInspectorViewProtocol.UserInputEvent.Type.HOVER).toByteArray()
    assertThat(receivedEvents).hasSize(1)
