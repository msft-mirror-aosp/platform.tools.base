  ...
  fun testCompositeCmd() {
    val events =
      listOf(
        ...
        CompositeCmd.EventMonitorContended(EventKind.MONITOR_CONTENDED_ENTER, 5, 1, TaggedObjectID(0, 1), Location(0, 1, 2, 3)),
        CompositeCmd.EventMonitorContended(EventKind.MONITOR_CONTENDED_ENTERED, 0, 1, TaggedObjectID(1, 3), Location(0, 1, 2, 3)),
        CompositeCmd.EventMonitorWait(EventKind.MONITOR_WAIT, 6, 1, TaggedObjectID(0, 1), Location(0, 1, 2, 3), 0),
        CompositeCmd.EventMonitorWaited(EventKind.MONITOR_WAITED, 0, 1, TaggedObjectID(0, 1), Location(0, 1, 2, 3), true),
        CompositeCmd.EventException(EventKind.EXCEPTION, 7, 1, Location(0, 1, 2, 3), TaggedObjectID(0, 1), Location(0, 1, 2, 3)),
        ...
        CompositeCmd.EventFieldAccess(EventKind.FIELD_ACCESS, 13, 1, Location(0, 1, 2, 3), 0, 1, 2, TaggedObjectID(0, 1)),
