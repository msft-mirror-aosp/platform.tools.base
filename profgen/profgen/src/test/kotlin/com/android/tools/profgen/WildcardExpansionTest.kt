...
class WildcardExpansionTest {
  ...
  fun testJarArchive() {
    ...
    ArchiveClassFileResourceProvider(archive).use { runTests(it.getClassFileResources()) }
  }
  ...
  private fun runTest(profile: String, expectedProfile: String, classFileResources: Collection<ClassFileResource>) {
