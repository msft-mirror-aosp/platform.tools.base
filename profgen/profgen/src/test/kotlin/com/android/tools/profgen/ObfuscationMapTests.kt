...
class ObfuscationMapTests {
  ...
  fun assertMethod(obf: ObfuscationMap, original: String, obfuscated: String) {
    ...
    assertEquals(deobfuscated, origMethod, "Expected '$origMethod' but found '$deobfuscated")
  }
  ...
  fun assertType(obf: ObfuscationMap, original: String, obfuscated: String) {
    ...
    assertEquals(deobfuscated[0], original, "Expected '$original' but found '$deobfuscated")
  }
  ...
  fun assertTypes(obf: ObfuscationMap, originals: List<String>, obfuscated: String) {
    ...
    assertEquals(originals.toSet(), deobfuscated, "Expected '$originals' but found '$deobfuscated")
  }
}
