...
interface SettingsExtension {
  ...
  @get:Incubating val addOnVendor: String?
  /** Value set via `compileSdkAddon` */
  @get:Incubating val addOnName: String?
  /** Value set via `compileSdkAddon` */
  @get:Incubating val addOnVersion: Int?

  /** Configures all aspects regarding compile Sdk version, see [CompileSdkSpec] for available options. */
   ...
   * See [uses-sdk element documentation](http://developer.android.com/guide/topics/manifest/uses-sdk-element.html).
   */
  @get:Incubating @set:Incubating var targetSdk: Int?
   ...
   * See [uses-sdk element documentation](http://developer.android.com/guide/topics/manifest/uses-sdk-element.html).
   */
  @get:Incubating @set:Incubating var targetSdkPreview: String?
