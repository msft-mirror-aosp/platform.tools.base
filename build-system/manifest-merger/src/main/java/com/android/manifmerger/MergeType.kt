...
enum class MergeType {
  ...
  /** Merge this element's children with lower priority element's children. Do not merge element's attributes. */
  MERGE_CHILDREN_ONLY,
  ...
  /** Always consume lower priority elements unless it is strictly equal to the higher priority element. */
  ALWAYS,
}
