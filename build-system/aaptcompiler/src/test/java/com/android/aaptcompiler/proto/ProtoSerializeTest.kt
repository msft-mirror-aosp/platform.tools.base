...
class ProtoSerializeTest {
  ...
  private fun testSerializeDeserialize(file: FileReference, givenPool: StringPool, config: ConfigDescription) {
  ...
  private fun testSerializeDeserialize(overlayableItem: OverlayableItem) {
    ...
    val pbOverlayableItem = serializeOverlayableToPb(overlayableItem, mutableListOf(), Resources.ResourceTable.newBuilder(), sourcePool)
    ...
    val deserialized = deserializeOverlayableFromPb(pbOverlayableItem, overlayable, extractedSources, null)
  ...
  private fun testSerializeDeserialize(style: Style, givenPool: StringPool) {
    ...
    sourcePool.flattenUtf16(buffer, null)
    val extractedSources = ResStringPool.get(ByteBuffer.wrap(buffer.toBytes()), buffer.size)
    val deserialized = deserializeStyleFromPb(pbStyle, givenPool, ConfigDescription(), extractedSources, null)
  ...
  private fun testSerializeDeserialize(array: ArrayResource, givenPool: StringPool) {
    ...
    sourcePool.flattenUtf16(buffer, null)
    val extractedSources = ResStringPool.get(ByteBuffer.wrap(buffer.toBytes()), buffer.size)
    val deserialized = deserializeArrayFromPb(pbArray, givenPool, ConfigDescription(), extractedSources, null)
  ...
  private fun testSerializeDeserialize(plural: Plural, givenPool: StringPool) {
    ...
    sourcePool.flattenUtf16(buffer, null)
    val extractedSources = ResStringPool.get(ByteBuffer.wrap(buffer.toBytes()), buffer.size)
    val deserialized = deserializePluralFromPb(pbPlural, givenPool, ConfigDescription(), extractedSources, null)
  ...
  fun testSerializeBinaryPrimitive() {
    ...
    // Null type
    testSerializeDeserialize(BinaryPrimitive(ResValue(ResValue.DataType.NULL, ResValue.NullFormat.UNDEFINED)))
    // Empty type
  ...
  fun testSerializeConfig() {
    ...
    testSerializeDeserialize(parse("mcc310-pl-sw720dp-normal-long-port-night-xhdpi-keyssoft-qwerty-navexposed-nonav"))
  ...
  fun testSerializeStrings() {
    ...
    testSerializeDeserialize(
      StyledString(originalPool.makeRef(StyleString("Hello World!", listOf(Span("b", 0, 4), Span("i", 6, 10)))), listOf()),
      newPool,
    )
  ...
  fun testAttrSerialization() {
    ...
    attributeExample.symbols.add(
      AttributeResource.Symbol(Reference(parseNameOrFail("android:attr/bar")), 1, ResValue.DataType.INT_DEC.byteValue)
    )
    attributeExample.symbols.add(
      AttributeResource.Symbol(Reference(parseNameOrFail("android:attr/baz")), 2, ResValue.DataType.INT_DEC.byteValue)
    )
    attributeExample.symbols.add(
      AttributeResource.Symbol(Reference(parseNameOrFail("android:attr/bat")), 4, ResValue.DataType.INT_DEC.byteValue)
    )
  ...
  fun testStyleSerialization() {
    ...
    styleExampleNoParent.entries.add(
      Style.Entry(Reference(parseResourceName("android:string/foo")!!.resourceName), BasicString(oldPool.makeRef("Hello there!")))
    )
  ...
  fun testSerializeSinglePackage() {
    ...
    Truth.assertThat(table.setVisibilityWithId(parseNameOrFail("com.app.a:layout/main"), publicSymbol, 0x7f020000)).isTrue()
    ...
    Truth.assertThat(table.addResource(parseNameOrFail("com.app.a:plurals/hey"), ConfigDescription(), "", plural)).isTrue()
    ...
    Truth.assertThat(
        table.addResource(
          ...
          parse("land"),
          "",
          BinaryPrimitive(ResValue(ResValue.DataType.INT_DEC, 123)),
        )
      )
      .isTrue()
    Truth.assertThat(
        table.addResource(
          ...
          parse("land"),
          "tablet",
          BinaryPrimitive(ResValue(ResValue.DataType.INT_HEX, 321)),
        )
      )
      .isTrue()
    ...
    Truth.assertThat(table.addResource(parseNameOrFail("com.app.a:layout/abc"), ConfigDescription(), "", expectedRef)).isTrue()
    ...
    Truth.assertThat(table.setOverlayable(parseNameOrFail("com.app.a:integer/overlayable"), overlayableItem)).isTrue()
    ...
    val newPrimitive = getValue(newTable, "com.app.a:integer/one", parse("land"), "tablet") as? BinaryPrimitive
    ...
    val newPrimitive2 = getValue(newTable, "com.app.a:integer/one", parse("land")) as? BinaryPrimitive
    ...
    Truth.assertThat(actualOverlayableItem.overlayable.source).isEqualTo(Source("res/values/overlayable.xml", 40))
    Truth.assertThat(actualOverlayableItem.policies).isEqualTo(OverlayableItem.Policy.NONE)
    Truth.assertThat(actualOverlayableItem.source).isEqualTo(Source("res/values/overlayable.xml", 42))
  }
  ...
  fun serializeAndDeserializeOverlayable() {
    ...
    val baz = OverlayableItem(Overlayable("FrontPack", "overlay://theme", Source.EMPTY), OverlayableItem.Policy.PUBLIC)
    val boz =
      OverlayableItem(
    ...
    val biz = OverlayableItem(Overlayable("Other", "overlay://customization", Source.EMPTY), comment = "comment")
    val table =
      ResourceTableBuilder()
    ...
    Truth.assertThat(item.policies).isEqualTo(OverlayableItem.Policy.SYSTEM or OverlayableItem.Policy.PRODUCT)
    ...
    Truth.assertThat(item.policies).isEqualTo(OverlayableItem.Policy.PUBLIC or OverlayableItem.Policy.VENDOR)
    ...
    Truth.assertThat(item.overlayable.actor).isEqualTo("overlay://theme")
    Truth.assertThat(item.policies).isEqualTo(OverlayableItem.Policy.SIGNATURE or OverlayableItem.Policy.ODM or OverlayableItem.Policy.OEM)
