        ...
        androidApplication {
            ...
            files {
                add("src/main/kotlin/com/foo/bar/app/MyClass.kt",
                    generateKotlinFunction("com.first")
                )
            }
        ...
        override fun handleExtension(
            ...
            androidComponents.onVariants { variant ->
                val taskProvider = project.tasks.register(
                    "generate${variant.name}Sources",
                    SourceGeneratingTask::class.java
                ) {
                    it.packageName.set("com.first")
                }
                variant.sources.kotlin!!.addGeneratedSourceDirectory(
                    taskProvider, SourceGeneratingTask::outputDir
                )
            }
        }
    }
...
private abstract class SourceGeneratingTask: DefaultTask() {
    ...
    fun generate() {
        ...
        outputFolder.mkdirs()
        File(outputFolder, "someFile.kt").writeText(
            """
