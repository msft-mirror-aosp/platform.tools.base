...
class AssetPackagingTest {
  @get:Rule val project: GradleTestProject = builder().fromTestProject("projectWithModules").withDependencyChecker(false).create()
  ...
  fun setUp() {
    ...
    createOriginalAsset(createAssetFile(libDir, "androidTest", "filelibtest.txt"), "libraryTest:abcd")

    val lib2Dir = libProject2.projectDir
    // Include a gzipped asset, which should be extracted.
    createOriginalGzippedAsset(createAssetFile(lib2Dir, "main", "filelib2.txt.gz"), "library2:abcd".toByteArray(Charsets.UTF_8))
    createOriginalAsset(createAssetFile(lib2Dir, "androidTest", "filelib2test.txt"), "library2Test:abcd")
  }
  ...
  private fun createOriginalGzippedAsset(assetFile: File, content: ByteArray) {
    ...
    GZIPOutputStream(byteArrayOutputStream).use { out -> out.write(content) }
  ...
  private fun createAssetFile(projectDirectory: File, dimension: String, vararg path: String): File {
  ...
  fun testNonIncrementalPackaging() {
    ...
    libProject2.checkTestApk("filelib2.txt".withContent("library2:abcd"), "filelib2test.txt".withContent("library2Test:abcd"))
  ...
  fun testAppProjectWithNewAssetFile() {
    ...
    TemporaryProjectModification.doTest(appProject) {
      ...
      execute("app:assembleDebug")
      appProject.checkApk("newfile.txt".withContent("newfile content"), "subdir/file.txt", "filelib2.txt", "filelib.txt", "file.txt")
    }
  }
  ...
  fun testAppProjectWithModifiedAssetFile() {
    ...
    TemporaryProjectModification.doTest(appProject) {
      ...
      execute("app:assembleDebug")
      appProject.checkApk("file.txt".withContent("new content"), "subdir/file.txt", "filelib2.txt", "filelib.txt")
    }
  }
  ...
  fun testAppProjectWithNewDebugAssetFileOverridingMain() {
    ...
    execute("app:assembleDebug")
    appProject.checkApk("file.txt".withContent("app:abcd"), "subdir/file.txt", "filelib2.txt", "filelib.txt")
  }
  ...
  fun testAppProjectWithNewAssetFileOverridingDependency() {
    ...
    TemporaryProjectModification.doTest(appProject) {
      ...
      execute("app:assembleDebug")
      appProject.checkApk("filelib.txt".withContent("new content"), "subdir/file.txt", "filelib2.txt", "file.txt")
    }

    // file's been removed, checking in the other direction.
    execute("app:assembleDebug")
    appProject.checkApk("filelib.txt".withContent("library:abcd"), "subdir/file.txt", "filelib2.txt", "file.txt")
  }
  ...
  fun testAppProjectWithAddedAssetInDependency() {
    ...
    TemporaryProjectModification.doTest(libProject) {
      ...
      execute("app:assembleDebug")
      appProject.checkApk("new_lib_file.txt".withContent("new content"), "subdir/file.txt", "filelib2.txt", "filelib.txt", "file.txt")
    }
  }
  ...
  fun testAppProjectWithAddedAssetThatOverrideAaptOptions() {
    TemporaryProjectModification.doTest(appProject) {
      ...
      execute("app:assembleDebug")
      appProject.checkApk("_anotherdir/file.txt".withContent("app:hijk"), "subdir/file.txt", "filelib2.txt", "filelib.txt", "file.txt")
  ...
  fun testAppProjectWithAddedAndRemovedAsset() {
    ...
    TemporaryProjectModification.doTest(appProject) {
      ...
      execute("app:assembleDebug")
      appProject.checkApk("newFile.txt".withContent("foo"), "subdir/file.txt", "filelib2.txt", "filelib.txt", "file.txt")
    }
  ...
  fun testAppProjectTestWithNewAssetFile() {
    ...
    TemporaryProjectModification.doTest(appProject) {
      ...
      execute("app:assembleAT")
      appProject.checkTestApk("newfile.txt".withContent("new file content"), "filetest.txt")
    }
  }
  ...
  fun testLibProjectWithIgnoredAssets() {
    TemporaryProjectModification.doTest(libProject) {
      ...
      it.appendToFile(libProject.buildFile.getPath(), "android.aaptOptions.ignoreAssetsPattern = 'ignored'")
      execute("library:assembleDebug")
  ...
  fun testLibProjectTestWithNewAssetFile() {
    ...
    TemporaryProjectModification.doTest(libProject) {
      it.addFile("src/androidTest/assets/newfile.txt", "new file content")
      execute("library:assembleAT")
      libProject.checkTestApk("newfile.txt".withContent("new file content"), "filelibtest.txt", "filelib2.txt", "filelib.txt")
    }
  }
  ...
  fun testLibProjectTestWithModifiedAssetFile() {
    ...
    TemporaryProjectModification.doTest(libProject) {
      ...
      execute("library:assembleAT")
      libProject.checkTestApk("filelibtest.txt".withContent("new content"), "filelib2.txt", "filelib.txt")
    }
  }
  ...
  fun testLibProjectTestWithNewAssetFileOverridingTestedLib() {
    ...
    TemporaryProjectModification.doTest(libProject) {
      ...
      execute("library:assembleAT")
      libProject.checkTestApk("filelib.txt".withContent("new content"), "filelibtest.txt", "filelib2.txt")
    }

    // file's been removed, checking in the other direction.
    execute("library:assembleAT")
    libProject.checkTestApk("filelib.txt".withContent("library:abcd"), "filelibtest.txt", "filelib2.txt")
  }
  ...
  fun testLibProjectTestWithNewAssetFileOverridingDependency() {
    ...
    TemporaryProjectModification.doTest(libProject) {
      ...
      execute("library:assembleAT")
      libProject.checkTestApk("filelib2.txt".withContent("new content"), "filelibtest.txt", "filelib.txt")
    }

    // file's been removed, checking in the other direction.
    execute("library:assembleAT")
    libProject.checkTestApk("filelib2.txt".withContent("library2:abcd"), "filelibtest.txt", "filelib.txt")
  }
  ...
  fun testPackageAssetsWithUnderscoreRegression() {
    ...
    TemporaryProjectModification.doTest(appProject) {
      ...
      execute("app:assembleDebug")
      appProject.checkApk("_newfile.txt".withContent("newfile content"), "subdir/file.txt", "filelib2.txt", "filelib.txt", "file.txt")
    }
  }
  ...
  fun testIgnoreAssets() {
    ...
    TestFileUtils.appendToFile(projectFile, "android { aaptOptions { ignoreAssets = '*a:b*' } } ")
    ...
    appProject.checkApk("ab".withContent(abData), "subdir/file.txt", "filelib2.txt", "filelib.txt", "file.txt", "_anotherdir/file.txt")
  }
  ...
  fun testAddStaticSourceDirectory() {
    ...
    appProject.checkApk("static.txt".withContent("app:static"), "subdir/file.txt", "filelib2.txt", "filelib.txt", "file.txt")
  }
  ...
  private fun GeneratesApk.checkApk(vararg itemList: Any) {
    assertApk(ApkSelector.DEBUG) { checkAssets(*itemList) }
  }
  ...
  private fun GeneratesApk.checkTestApk(vararg itemList: Any) {
    assertApk(ApkSelector.ANDROIDTEST_DEBUG) { checkAssets(*itemList) }
  }
  ...
  private fun GeneratesAar.checkAar(vararg itemList: Any) {
    assertAar(AarSelector.DEBUG) { checkAssets(*itemList) }
  }
