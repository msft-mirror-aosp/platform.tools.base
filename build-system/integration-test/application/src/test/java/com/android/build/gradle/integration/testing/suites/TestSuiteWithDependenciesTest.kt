    ...
    val rule = GradleRule.configure()
        .withMavenRepository {
            ...
            jar("com.test:toy-junit-engine:1.0")
                ...
                .addTextFile(
                    ...
                    ToyJunitEngineForTestingDependencies::class.java.name
                )
        ...
        .from {
            ...
            androidApplication(":app") {
                ...
                files {
                    add("src/main/kotlin/com/example/test/SomeApp.kt",
                        """
            ...
            androidLibrary(":lib") {
                ...
                files {
                    add("src/main/kotlin/com/example/lib/SomeApiClass.kt",
                        """
...
class ToyJunitEngineForTestingDependencies: TestEngine {
    ...
    override fun execute(p0: ExecutionRequest?) {
        p0?.let { executionRequest ->
            ...
            try {
                val appClass = ToyTestDescriptorForTestingDependencies::class.java.classLoader
                    .loadClass("com.example.lib.SomeApiClass")
