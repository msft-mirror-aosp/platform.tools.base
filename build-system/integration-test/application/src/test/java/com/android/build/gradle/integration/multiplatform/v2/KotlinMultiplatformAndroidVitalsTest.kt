...
class KotlinMultiplatformAndroidVitalsTest {
  ...
  @Test
  fun `fail when another android plugin is applied to kmp android`() {
    val build = rule.build {
    ...
    result.assertErrorContains(
      "'com.android.library' and 'com.android.kotlin.multiplatform.library' plugins cannot be applied in the same project."
    )
  }
