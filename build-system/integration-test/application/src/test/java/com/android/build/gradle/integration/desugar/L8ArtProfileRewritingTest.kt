...
class L8ArtProfileRewritingTest {
  ...
  fun setUp() {
    ...
    val proguardRulesFileContent =
      ...
      """
        .trimIndent()
    FileUtils.writeToFile(project.file("app/proguard-rules.pro"), proguardRulesFileContent)
  ...
  private fun testL8Rewriting() {
    ...
    Truth.assertThat(profileDump.indexOf("HSPLcom/example/helloworld/Data;->doLambda()V")).isNotEqualTo(-1)
    Truth.assertThat(profileDump.indexOf("HSPLj\$/util/stream/Stream;->")).isNotEqualTo(-1)
  }
