...
class DynamicFeatureJavaResTest {
  ...
  private val lib =
    MinimalSubProject.lib("com.example.lib")
      ...
      .withFile("src/main/resources/META-INF/services/com.example.Service", "com.example.lib.impl.LibService")
  ...
  private val baseModule =
    MinimalSubProject.app("com.example.baseModule")
      ...
      .withFile("src/main/resources/META-INF/services/com.example.Service", "com.example.baseModule.impl.BaseModuleService")
  ...
  private val dynamicFeature =
    MinimalSubProject.dynamicFeature("com.example.dynamicFeature")
      ...
      .withFile("src/main/resources/META-INF/services/com.example.Service", "com.example.dynamicFeature.impl.DynamicFeatureService")
      .withFile("src/main/resources/META-INF/services/com.example.feature.Service", "com.example.dynamicFeature.impl.DynamicFeatureService")
  ...
  fun testDuplicateJavaResThrowsException() {
    TestFileUtils.searchAndReplace(project.getSubproject(":dynamicFeature").buildFile, "exclude \"collide.txt\"", "")
    val result = project.executor().expectFailure().run("assembleMinified")
    assertThat(result.failureMessage)
      .contains("Multiple dynamic-feature and/or base APKs will contain entries " + "with the same path, 'collide.txt'")
  }
  ...
  fun testJavaResourcePackaging() {
    ...
    project.getSubproject("baseModule").getApk(apkType).use { apk ->
      ...
      assertThat(apk)
        .containsJavaResourceWithContent("META-INF/services/com.example.Service", "com.example.baseModule.impl.BaseModuleService")
      assertThat(apk).doesNotContainJavaResource("META-INF/services/com.example.feature.Service")
    }
  }
}
