...
class LibraryNoPrecompiledResourcesTest {
  ...
  private val localLib =
    MinimalSubProject.lib("com.test.localLib")
      ...
      .withFile("src/main/java/test/Data.java", "package test; public class Data {}")
  ...
  private val app =
    MinimalSubProject.app("com.example.app")
      ...
      .withFile("src/androidTest/java/test/test.java", "package test; public class DataTest extends Data {}")
      .withFile(
  ...
  private val testApp = MultiModuleTestProject.builder().subproject(":localLib", localLib).subproject(":app", app).build()
  ...
  fun testDependencyOnLibrariesWithNoProcompiledDependencies() {
    project.executor().run("clean", "app:processDebugAndroidTestResources")
  }
}
