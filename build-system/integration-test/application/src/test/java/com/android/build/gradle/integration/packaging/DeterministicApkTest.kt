...
class DeterministicApkTest(private val debuggable: Boolean, private val fromIde: Boolean, private val forceDeterministicApk: Boolean) {
  ...
  fun cleanBuildDeterministicApkTest() {
    ...
    val apk1 = project.getApk(getApkType(), GradleTestProject.ApkLocation.Output)
    ...
    val apk2 = project.getApk(getApkType(), GradleTestProject.ApkLocation.Output)
  ...
  private fun getExecutor(): GradleTaskExecutor =
    project.executor().with(BooleanOption.IDE_INVOKED_FROM_IDE, fromIde).with(BooleanOption.FORCE_DETERMINISTIC_APK, forceDeterministicApk)
}
