...
/**
 * Tests that will exercise the ALL and PROJECT classes access combined with minification turned on or off.
 *
 * The classes access will add a new class and the tests verifies that all added types are present in the resulting APK.
 */
