...
class RulesExtractionDynamicAppTest {
  ...
  private val feature1 =
    MinimalSubProject.dynamicFeature("com.example.feature1")
      .appendToBuild(FEATURE1_BUILD_GRADLE)
      .withFile("src/main/java/com/example/feature1/Feature1ClassToKeep.java", FEATURE1_CLASS_KEEP)
      .withFile("src/main/java/com/example/feature1/Feature1ClassToRemove.java", FEATURE_CLASS_REMOVE)
      .withFile("proguard-rules.pro", "-keep public class com.example.feature1.Feature1ClassToKeep")

  private val baseModule =
    MinimalSubProject.app("com.example.baseModule")
      .appendToBuild(BASE_BUILD_GRADLE)
      .withFile("src/main/java/com/example/baseModule/BaseClassToKeep.java", BASE_CLASS_KEEP)
      .withFile("src/main/java/com/example/baseModule/BaseClassToRemove.java", BASE_CLASS_REMOVE)
      .withFile("proguard-rules.pro", "-keep public class com.example.baseModule.BaseClassToKeep")
