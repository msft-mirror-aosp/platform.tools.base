...
class ExtractApksTaskTest {
    ...
    fun extractApkNoConfig() {
        ...
        val failure =
            build.executor.expectFailure().run(":app:extractApksFromBundleForDebug")
    ...
    fun testMultipleDuplicateDeviceConfigs() {
        ...
        val apkSelectConfig1 = temporaryFolder.newFile("deviceSpec_1.json").apply {
            writeText(configInfo)
        }

        val apkSelectConfig2 = temporaryFolder.newFile("deviceSpec_2.json").apply {
            writeText(configInfo)
        }
