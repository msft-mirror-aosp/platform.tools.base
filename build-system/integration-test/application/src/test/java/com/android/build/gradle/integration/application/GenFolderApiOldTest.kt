...
class GenFolderApiOldTest(private val variantApiTestType: VariantApiTestType) {
  ...
  val project: GradleTestProject =
    builder()
      .fromTestProject("genFolderApiOld")
  ...
  fun backwardsCompatible() {
    ...
    Truth.assertThat(TestFileUtils.sha1NormalizedLineEndings(project.file("old_variant_api.build.gradle")))
      .isEqualTo("4b3fdabf87f8f5352be3afad61e97550adfb09a0")
