...
/** Similar to [CacheabilityTest], but targeting projects using dynamic features to verify a different set of tasks. */
class DynamicFeaturesCacheabilityTest {
      ...
      mapOf(
          ...
          setOf(
            ...
            .plus(
              if (BooleanOption.GENERATE_MANIFEST_CLASS.defaultValue) {
                setOf(":app:generateDebugManifestClass", ":feature1:generateDebugManifestClass", ":feature2:generateDebugManifestClass")
              } else {
                emptySet()
              }
            ),
        ...
        DID_WORK to
          setOf(
            ...
            /**
             * Not cacheable as the project contains local file deps, see
             * [com.android.build.gradle.internal.tasks.featuresplit.PackagedDependenciesWriterTask.CreationAction.configure]
             */
            ...
            /** Intentionally not cacheable. See [com.android.build.gradle.internal.tasks.SigningConfigWriterTask] */
            ...
            /** Intentionally not cacheable. See [com.android.build.gradle.tasks.ProcessManifestForBundleTask] */
            ":feature2:checkDebugAarMetadata",
            /** Intentionally not cacheable. See [com.android.build.gradle.internal.tasks.CheckAarMetadataTask] */
  ...
  fun testRelocatability() {
    ...
    CacheabilityTestHelper(projectCopy1, projectCopy2, buildCacheDir)
      .runTasks("clean", "assembleDebug", "lintDebug")
