...
class ArchivesBaseNameTest(plugin: String, private val extension: String) {
  ...
  @get:Rule var project: GradleTestProject = GradleTestProject.builder().fromTestApp(HelloWorldApp.forPlugin(plugin)).create()
  ...
  private fun checkApkName(name: String, extension: String) {
    ...
    // Get the apk file
    val outputFile =
      if (debugBuildOutput.mainArtifact.assembleTaskOutputListingFile != null) {
  ...
  companion object {
    ...
    fun data(): Iterable<Array<Any>> {
      return listOf(arrayOf("com.android.application", "apk"), arrayOf("com.android.library", "aar"))
    }
  }
}
