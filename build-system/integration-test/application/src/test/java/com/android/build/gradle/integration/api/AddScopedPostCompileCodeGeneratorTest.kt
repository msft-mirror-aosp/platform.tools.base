 ...
 *
 * The test runs with different scopes for consuming the POST_COMPILATION_CLASSES and for producing
 * in the CLASSES artifact.
 */
@RunWith(Parameterized::class)
class AddScopedPostCompileCodeGeneratorTest(
    private val consumingScope: Scope,
    private val producingScope: Scope
) {
    ...
    val project = GradleRule.from {
        ...
        androidLibrary {
            files {
                ...
                add("src/main/kotlin/${AddScopedPostCompileCodeGeneratorTask.CLIENT_INTERFACE_INTERNAL_NAME}.kt",
                    """
        ...
        override fun handleProject(project: Project) {
            ...
            extension
                .onVariants(extension.selector().withBuildType("debug")) {  variant ->
                    ...
                    variant.artifacts.forScope(consumingScope.get())
                        .use(generatorTask)
                        .toGet(
                    ...
                    variant.artifacts.forScope(producingScope.get())
                        .use(generatorTask)
...
abstract class AddScopedPostCompileCodeGeneratorTask: DefaultTask() {
    ...
    @get:Input
    abstract val allScope: Property<Boolean>
