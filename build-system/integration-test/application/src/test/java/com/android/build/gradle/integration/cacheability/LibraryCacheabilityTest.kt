...
/** Similar to [CacheabilityTest], but focusing on tasks invoked from a library module to verify a different set of tasks. */
      ...
      mapOf(
        ...
        DID_WORK to
          setOf(
            ...
            /** Intentionally not cacheable. See [com.android.build.gradle.internal.tasks.LibraryJniLibsTask] */
            ":lib:copyReleaseJniLibsProjectOnly",
            ":lib:checkReleaseAarMetadata",
