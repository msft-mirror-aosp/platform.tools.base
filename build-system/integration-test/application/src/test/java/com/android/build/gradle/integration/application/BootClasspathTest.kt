...
/**
 * Test [BaseExtension.bootClasspath] can be used before afterEvaluate with [BooleanOption.USE_NEW_DSL] set to `false`.
 *
 * Once [BooleanOption.USE_NEW_DSL] is no longer an option, the cleanup described at [BaseExtension.bootClasspath] can happen (and this test
 * can be deleted).
 */
