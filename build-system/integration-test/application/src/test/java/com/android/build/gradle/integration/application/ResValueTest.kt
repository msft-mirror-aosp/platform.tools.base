...
class ResValueTest {
    ...
    @get:Rule
    val rule = GradleRule.configure().disableBrokenNewDslOptOutChecks().from {
        androidApplication {
            android {
                defaultConfig {
    ...
    fun modelDefaultConfig() {
        val map = mapOf(
            "string/VALUE_DEFAULT" to "1",
            "string/VALUE_FLAVOR" to "1",
            "string/VALUE_DEBUG" to "1",
            "string/VALUE_VARIANT" to "1",
        )
    ...
    fun modelFlavor1() {
        val map = mapOf(
            "string/VALUE_FLAVOR" to "10",
            "string/VALUE_DEBUG" to "10",
            "string/VALUE_VARIANT" to "10",
        )
    ...
    fun modelFlavor2() {
        val map = mapOf(
            "string/VALUE_FLAVOR" to "20",
            "string/VALUE_DEBUG" to "20",
            "string/VALUE_VARIANT" to "20",
        )
    ...
    fun buildFlavor1Debug() {
        checkGeneratedFile("flavor1/debug", """
    ...
    fun buildFlavor1Release() {
        checkGeneratedFile("flavor1/release", """
            <?xml version="1.0" encoding="utf-8"?>
            <resources>
    ...
    fun buildFlavor2Debug() {
        checkGeneratedFile("flavor2/debug", """
            <?xml version="1.0" encoding="utf-8"?>
            <resources>
    ...
    fun buildFlavor2Release() {
        checkGeneratedFile("flavor2/release", """
            <?xml version="1.0" encoding="utf-8"?>
            <resources>
    ...
    private fun checkGeneratedFile(variantDir: String, expected: String) {
        val output = build.subProject(":app").buildDir
            .resolve("generated/res/resValues/")
            .resolve(variantDir)
            .resolve("values/gradleResValues.xml")
