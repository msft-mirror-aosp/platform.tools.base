...
class ExtendingDslIntegrationTest {
  ...
  val expectedOutputs =
    mapOf(
      ...
      ":feature" to
        mapOf(
          "blueDebug" to
            "projectExt=dynamicFeatureProjectExt, buildTypeExt=dynamicFeatureBuildTypeExt, productFlavorExt=[dynamicFeatureProductFlavorExt]",
  ...
  private fun GradleBuild.validateVariant(projectPath: String, variantName: String) {
    ...
    val expectedContent =
      expectedOutputs[projectPath]?.get(variantName)
...
class ExtendingCallback : GenericComponentCallback {
  ...
  override fun handleExtension(project: Project, androidComponents: AndroidComponentsExtension<*, *, *>) {
...
abstract class VariantDslExtension @Inject constructor(extensionConfig: VariantExtensionConfig<*>) : VariantExtension, Serializable {
  @get:Input abstract val projectExt: Property<String>
  @get:Input abstract val buildTypeExt: Property<String>
  @get:Input abstract val productFlavorExt: ListProperty<String>
...
abstract class VariantOutputTask : DefaultTask() {
  ...
  @get:Nested abstract val variantInfo: Property<VariantDslExtension>
