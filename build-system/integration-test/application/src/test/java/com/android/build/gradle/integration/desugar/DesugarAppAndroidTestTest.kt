 ...
 *
 * Specifically we set up the case that causes b/130917947 App main -> Lib C -> Lib A, Lib B which means when desugaring C it has A,B App
 * test -> Lib B. which means when desugaring C in the android test classpath it has B,A as dependencies (i.e. in different order)
 */
    ...
    MavenRepoGenerator(
      listOf(
        ...
        MavenRepoGenerator.Library(
          "com.example:libc:1",
          jarWithClasses(listOf(MarkerC::class.java)),
          "com.example:liba:1",
          "com.example:libb:1",
        ),
      )
