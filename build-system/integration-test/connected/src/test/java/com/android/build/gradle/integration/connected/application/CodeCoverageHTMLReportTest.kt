...
/**
 * Integration test for [CodeCoverageReportTask].
 *
 ...
 */
class CodeCoverageHTMLReportTest {
    ...
    fun testCreateCoverageReport() {
        rule.build.executor.run("createCoverageReport")
    ...
    fun testCreateAggregatedCoverageReport() {
        rule.build.executor.run("createAggregatedCoverageReport")
