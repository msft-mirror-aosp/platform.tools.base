  ...
  private val build =
    MultiModuleTestProject.builder()
      .apply {
        val app =
          MinimalSubProject.app("com.example.app")
            .appendToBuild(
              ...
              |android.defaultConfig.targetSdk = 23
              """
                .trimMargin()
            )
            .withFile(
        ...
        val dynamicFeature =
          MinimalSubProject.dynamicFeature("com.example.app.dynamic.feature")
            ...
            .withFile(
              "src/main/java/com/example/dynamic/feature/FeatureProductionClass.java",
              """
        ...
        androidTestDependency(dynamicFeature, "com.android.support.test:runner:$TEST_SUPPORT_LIB_VERSION")
        androidTestDependency(dynamicFeature, "com.android.support.test:rules:$TEST_SUPPORT_LIB_VERSION")
        androidTestDependency(dynamicFeature, "com.android.support:support-annotations:$SUPPORT_LIB_VERSION")
      }
      .build()

  @get:Rule val project = GradleTestProject.builder().fromTestApp(build).create()
