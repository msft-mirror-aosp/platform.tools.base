...
class SimpleManagedDeviceTest {
  ...
  @get:Rule val rule = GradleRule.configure().withCustomSdkDir(customAndroidSdkRule).from { simpleGMDProject() }
  ...
  fun runBasicManagedDevice() {
    ...
    result.assertOutputContains("Execute com.example.android.kotlin.ExampleInstrumentedTest.useAppContext: PASSED")
  }
