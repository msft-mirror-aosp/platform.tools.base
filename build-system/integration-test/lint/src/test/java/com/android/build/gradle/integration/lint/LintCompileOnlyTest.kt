...
class LintCompileOnlyTest {
  ...
  fun testLintCheckDependenciesWithCompileOnlyDependencies() {
    ...
    PathSubject.assertThat(reportFile)
      .containsAllOf("Foo.java:4: Error: STOPSHIP comment found", "Bar.java:4: Error: STOPSHIP comment found")
    ...
    PathSubject.assertThat(reportFile).doesNotContain("Baz.java:4: Error: STOPSHIP comment found")
  }
}
