...
class LintDependencySdkIntCheckTest {
  ...
  private val libSourceFile by lazy { project.getSubproject(":lib").file("src/main/java/com/example/bar/Lib.java") }
  ...
  fun testDependencySdkIntCheck() {
    ...
    getExecutor().run(":app:lintDebug").apply { assertTask(":lib:lintAnalyzeDebug").didWork() }
