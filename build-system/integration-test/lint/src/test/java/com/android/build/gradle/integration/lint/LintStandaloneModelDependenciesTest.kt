...
class LintStandaloneModelDependenciesTest {
  ...
  fun testLintModelDependencies() {
    ...
    assertThat(artifactDependenciesFile).containsAllOf("guava", "java-lib2", "java-lib3", "gradle-api")
    ...
    assertThat(testArtifactDependenciesFile).containsAllOf("junit", "java-lib1.jar", "java-lib2", "gradle-api")
  ...
  private fun createIvyRepo() {
    val ivyFile = project.projectDir.resolve("ivyRepo/com/example/xml/1.0/xml-1.0.ivy").also { it.parentFile.mkdirs() }
    TestFileUtils.appendToFile(
      ivyFile,
      // language=xml
      """
    ...
    val xmlFile = project.projectDir.resolve("ivyRepo/com/example/xml/1.0/xml-def-1.0.xml")
    TestFileUtils.appendToFile(
      xmlFile,
      // language=xml
      """
