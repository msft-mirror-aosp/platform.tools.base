...
class LintRestrictedApiTest(private val checkDependencies: Boolean) {
  ...
  companion object {
    @Parameterized.Parameters(name = "checkDependencies_{0}") @JvmStatic fun params() = listOf(true, false)
  }
  ...
  fun testRestrictedApisFromModuleDependency() {
    ...
    PathSubject.assertThat(reportFile).doesNotContain("library group prefix")
  }
