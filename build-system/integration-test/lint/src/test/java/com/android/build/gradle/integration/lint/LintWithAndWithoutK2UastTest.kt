 ...
 *
 * Creates a project with many modules (with android.lint.useK2Uast set to true for half of them), and then runs lint on all modules.
 */
@RunWith(FilterableParameterized::class)
class LintWithAndWithoutK2UastTest(private val runLintInProcess: Boolean) {

  companion object {
    @JvmStatic @Parameterized.Parameters(name = "runLintInProcess_{0}") fun parameters() = listOf(true, false)
  }
