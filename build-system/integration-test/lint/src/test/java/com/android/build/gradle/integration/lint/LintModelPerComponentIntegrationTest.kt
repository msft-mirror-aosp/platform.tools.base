...
class LintModelPerComponentIntegrationTest {
  ...
  fun checkLintAnalysisModels_androidTest() {
    ...
    checkLintModels(
      project = project,
      lintModelDir = project.getSubproject("app").intermediatesDir.toPath().resolve("incremental/lintAnalyzeDebugAndroidTest"),
  ...
  fun checkLintAnalysisModels_unitTest() {
    ...
    checkLintModels(
      project = project,
      lintModelDir = project.getSubproject("app").intermediatesDir.toPath().resolve("incremental/lintAnalyzeDebugUnitTest"),
  ...
  fun checkLintAnalysisModels_testFixtures() {
    ...
    checkLintModels(
      project = project,
      lintModelDir = project.getSubproject("app").intermediatesDir.toPath().resolve("incremental/lintAnalyzeDebugTestFixtures"),
  ...
  fun checkLintModelsForShrinkable() {
    ...
    val lintModelDir =
      project.getSubproject("app").intermediatesDir.toPath().resolve("lint_report_lint_model/debug/generateDebugLintReportModel").toFile()
