...
import com.android.build.gradle.integration.common.output.JarSubject.Companion.assertThat
import com.google.common.truth.ExpectFailure
import com.google.common.truth.SimpleSubjectBuilder
import org.junit.Test

class JarSubjectTest: BaseZipSubjectTest() {
    ...
    private fun expectFailure(action: (SimpleSubjectBuilder<JarSubject, Zip>) -> Unit): AssertionError {
        return ExpectFailure.expectFailureAbout(JarSubject.jars(), action)
    }
}
