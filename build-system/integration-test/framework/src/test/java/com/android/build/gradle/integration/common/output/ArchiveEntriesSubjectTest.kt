...
class ArchiveEntriesSubjectTest {
  @Test
  fun exactFileMatch() {
    withActual("com/foo/foo.txt", "com/bar/bar.txt").expectExactMatchWith("com/foo/foo.txt", "com/bar/bar.txt")
  }

  @Test
  fun exactFolderMatch() {
    withActual("com/foo/foo.txt", "com/foo/bar.txt", "com/bar/bar.txt").expectExactMatchWith("com/foo/", "com/bar/")
  }

  @Test
  fun fileAndParentFolder() {
    withActual("com/foo/foo.txt").expectExactMatchWith("com/foo/foo.txt", "com/foo/")
  }

  @Test
  fun exactClassMatchWithInnerClass() {
    withActual("com/foo/Foo").expectExactClassMatchWith("com/foo/Foo$")
  }

  @Test
  fun classAndInnerClass() {
    withActual("com/foo/Foo", "com/foo/Foo\$bar").expectExactClassMatchWith("com/foo/Foo$")
  }
  ...
  @Test
  fun wrongSingleFile() {
    withActual("com/bar/bar.txt").expectFailureWhenComparingExactlyTo("com/foo/foo.txt").andValidateFailure {
  ...
  fun wrongSingleFolder() {
    withActual("com/bar/bar.txt").expectFailureWhenComparingExactlyTo("com/foo/").andValidateFailure {
      factKeys().containsExactly("expected", "but was").inOrder()
  ...
  fun wrongSingleClass() {
    withActual("com/bar/Bar").expectFailureWhenComparingExactlyTo("com/foo/Foo$").andValidateFailure {
      factKeys().containsExactly("expected", "but was").inOrder()
  ...
  fun unexpected_single_file() {
    withActual("com/foo/foo.txt", "com/bar/bar.txt").expectFailureWhenComparingExactlyTo("com/bar/bar.txt").andValidateFailure {
  ...
  fun unexpected_multi_files() {
    withActual("com/foo/foo.txt", "com/foo/bar.txt", "com/bar/bar.txt")
      .expectFailureWhenComparingExactlyTo("com/bar/bar.txt")
      .andValidateFailure {
  ...
  fun multiple_unexpected_and_missing() {
    withActual("com/foo/foo.txt", "com/foo/foo2.txt")
      .expectFailureWhenComparingExactlyTo("com/bar/bar.txt", "com/bar/bar2.txt")
      .andValidateFailure {
  ...
  fun missing_single_file() {
    withActual("com/bar/bar.txt").expectFailureWhenComparingExactlyTo("com/foo/foo.txt", "com/bar/bar.txt").andValidateFailure {
  ...
  fun missing_multi_files() {
    withActual("com/bar/bar.txt")
      .expectFailureWhenComparingExactlyTo("com/foo/foo.txt", "com/foo/bar.txt", "com/bar/bar.txt")
      .andValidateFailure {
  ...
  fun missing_single_folder() {
    withActual("com/bar/bar.txt").expectFailureWhenComparingExactlyTo("com/bar/", "com/foo/").andValidateFailure {
      factKeys().containsExactly("missing", "---", "expected", "but was").inOrder()
  ...
  fun missing_multi_folders() {
    withActual("com/bar/bar.txt").expectFailureWhenComparingExactlyTo("com/bar/", "com/foo/", "com/foo2/").andValidateFailure {
      factKeys().containsExactly("missing (2)", "---", "expected", "but was").inOrder()
  ...
  fun missing_file_in_present_folder() {
    withActual("com/foo/foo.txt").expectFailureWhenComparingExactlyTo("com/foo/bar.txt", "com/foo/").andValidateFailure {
      factKeys().containsExactly("missing", "---", "expected", "but was").inOrder()
  ...
  fun partialFileMatch() {
    withActual("com/foo/foo.txt", "com/bar/bar.txt").expectPartialMatchWith("com/foo/foo.txt")
  }

  @Test
  fun partialExactFileMatch() {
    withActual("com/foo/foo.txt", "com/bar/bar.txt").expectPartialMatchWith("com/foo/foo.txt", "com/bar/bar.txt")
  }

  @Test
  fun partialFolderMatch() {
    withActual("com/foo/foo.txt", "com/bar/bar.txt").expectPartialMatchWith("com/foo/")
  }

  @Test
  fun partialClassMatch() {
    withActual("com/foo/Foo", "com/bar/Bar").expectPartialClassMatchWith("com/foo/Foo$")
  }

  @Test
  fun partial_multiple_missings() {
    withActual("com/bar/bar.txt")
      .expectFailureWhenComparingPartiallyTo("com/foo/foo.txt", "com/foo/bar.txt", "com/bar/bar.txt")
      .andValidateFailure {
  ...
  fun partial_single_missing() {
    withActual("com/bar/bar.txt").expectFailureWhenComparingPartiallyTo("com/foo/foo.txt", "com/bar/bar.txt").andValidateFailure {
  ...
  fun partial_missing_single_expected() {
    withActual("com/bar/foo.txt", "com/bar/bar.txt").expectFailureWhenComparingPartiallyTo("com/foo/foo.txt").andValidateFailure {
  ...
  fun partial_wrong_single_item() {
    withActual("com/bar/bar.txt").expectFailureWhenComparingPartiallyTo("com/foo/foo.txt").andValidateFailure {
  ...
  private class StringListTester(private val actual: Collection<String>) {
    fun expectExactMatchWith(vararg items: String) {
      Truth.assertAbout(ArchiveEntriesSubject.files()).that(actual).containsExactly(items.toList())
    }

    fun expectPartialMatchWith(vararg items: String) {
      Truth.assertAbout(ArchiveEntriesSubject.files()).that(actual).containsAtLeast(items.toList())
    }

    fun expectExactClassMatchWith(vararg items: String) {
      Truth.assertAbout(ArchiveEntriesSubject.classes()).that(actual).containsExactly(items.toList())
    }

    fun expectPartialClassMatchWith(vararg items: String) {
      Truth.assertAbout(ArchiveEntriesSubject.classes()).that(actual).containsAtLeast(items.toList())
    }

    @CheckReturnValue
    fun expectFailureWhenComparingExactlyTo(vararg items: String): TestError {
      return expectFailure(mode = ArchiveEntriesSubject.Mode.FILES, items = items) { containsExactly(it) }
    }

    @CheckReturnValue
    fun expectFailureWhenComparingPartiallyTo(vararg items: String): TestError {
      return expectFailure(mode = ArchiveEntriesSubject.Mode.FILES, items = items) { containsAtLeast(it) }
    }
    ...
    private fun expectFailure(
      ...
      val factory = if (mode == ArchiveEntriesSubject.Mode.FILES) ArchiveEntriesSubject.files() else ArchiveEntriesSubject.classes()

      return TestError(
        error = ExpectFailure.expectFailureAbout(factory) { subjectBuilder -> action(subjectBuilder.that(actual), items.toList()) },
        actual = actual,
      )
    }
  }
