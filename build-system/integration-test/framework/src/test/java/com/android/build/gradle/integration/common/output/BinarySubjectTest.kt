...
private val DATA_CAFEBABE: ByteArray = byteArrayOf(0xCA.toByte(), 0xFE.toByte(), 0xBA.toByte(), 0xBE.toByte())
...
class BinarySubjectTest {
  ...
  fun isEqualTo() {
    ...
    expectFailure { it.that(DATA_CAFEBABE).isEqualTo(DATA_FEBA) }
  }
  ...
  fun isNotEqualTo() {
    ...
    // test negative results
    expectFailure { it.that(DATA_CAFEBABE).isNotEqualTo(DATA_CAFEBABE) }
  }
  ...
  fun contains() {
    ...
    // test negative results
    expectFailure { it.that(DATA_CAFEBABE).contains(DATA_BABA) }
  }
  ...
  fun doesNotContain() {
    ...
    // test negative results
    expectFailure { it.that(DATA_CAFEBABE).doesNotContain(DATA_FEBA) }
  }
  ...
  fun isEmpty() {
    ...
    // test negative results
    expectFailure { it.that(DATA_CAFEBABE).isEmpty() }
  }
  ...
  fun isNotEmpty() {
    ...
    // test negative results
    expectFailure { it.that(DATA_EMPTY).isNotEmpty() }
  }
  ...
  fun hasLength() {
    ...
    // test negative results
    expectFailure { it.that(DATA_EMPTY).hasLength(4) }
  }
