...
internal class GradleRuleBuilderImpl internal constructor() : GradleRuleBuilder {
  ...
  override fun from(folderName: String, logicalName: String?, configAction: GradleBuildDefinition.() -> Unit): GradleRule {
    val builder =
      GradleBuildDefinitionImpl(name = logicalName ?: folderName, rootFolderName = folderName, enableDefaultContentCreation = true)
  ...
  override fun fromProject(
    ...
    val builder =
      GradleBuildDefinitionImpl(name = logicalName ?: folderName, rootFolderName = folderName, enableDefaultContentCreation = false)
    configAction(builder)
  ...
  internal fun create(gradleBuild: GradleBuildDefinitionImpl, testProjectName: String? = null): GradleRule {
