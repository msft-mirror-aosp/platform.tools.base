...
internal fun ModelSnapshotter<Versions>.snapshotVersions() {
  ...
  item("agp", Versions::agp) { version -> version?.let { normalizeAgpVersion(it) } }
}
...
internal fun ModelSnapshotter<BasicAndroidProject>.snapshotBasicAndroidProject() {
  ...
  dataObject("defaultConfig", BasicAndroidProject::mainSourceSet) { snapshotSourceSetContainer() }
  objectList(
    name = "buildTypes",
...
internal fun ModelSnapshotter<AndroidProject>.snapshotAndroidProject() {
  ...
  dataObject("javaCompileOptions", AndroidProject::javaCompileOptions) {
    ...
    item("isCoreLibraryDesugaringEnabled", JavaCompileOptions::isCoreLibraryDesugaringEnabled)
  }
  dataObject("viewBindingOptions", AndroidProject::viewBindingOptions) { item("isEnabled", ViewBindingOptions::isEnabled) }
  valueList(
    name = "flags",
...
internal fun ModelSnapshotter<AndroidDsl>.snapshotAndroidDsl() {
  ...
  item("compileTarget", AndroidDsl::compileTarget) { version -> version?.let { normaliseCompileTarget(it) } }
  item("buildToolsVersion", AndroidDsl::buildToolsVersion) { version -> version?.let { normalizeBuildToolsVersion(it) } }
  dataObject("defaultConfig", AndroidDsl::defaultConfig) { snapshotProductFlavor() }
  objectList(
    name = "buildTypes",
  ...
  dataObject("aaptOptions", AndroidDsl::aaptOptions) { item("namespacing", AaptOptions::namespacing) }
  dataObject("lintOptions", AndroidDsl::lintOptions) { snapshotLintOptions() }
...
internal fun ModelSnapshotter<NativeModule>.snapshotNativeModule() {
  ...
  objectList("variants", NativeModule::variants, nameAction = { name }, sortAction = { collection -> collection?.sortedBy { it.name } }) {
    snapshotNativeVariant()
  }
  item("nativeBuildSystem", NativeModule::nativeBuildSystem)
  item("ndkVersion", NativeModule::ndkVersion) { if (it == NDK_DEFAULT_VERSION) "{DEFAULT_NDK_VERSION}" else it }
  item("defaultNdkVersion", NativeModule::defaultNdkVersion) { if (it == NDK_DEFAULT_VERSION) "{DEFAULT_NDK_VERSION}" else it }
...
private fun ModelSnapshotter<SourceSetContainer>.snapshotSourceSetContainer() {
  dataObject("sourceProvider", SourceSetContainer::sourceProvider) { snapshotSourceProvider() }
  dataObject("androidTestSourceProvider", SourceSetContainer::androidTestSourceProvider) { snapshotSourceProvider() }
  dataObject("unitTestSourceProvider", SourceSetContainer::unitTestSourceProvider) { snapshotSourceProvider() }
  dataObject("testFixturesSourceProvider", SourceSetContainer::testFixturesSourceProvider) { snapshotSourceProvider() }
}
...
private fun ModelSnapshotter<ProductFlavor>.snapshotProductFlavor() {
  ...
  item("renderscriptSupportModeBlasEnabled", ProductFlavor::renderscriptSupportModeBlasEnabled)
...
private fun ModelSnapshotter<out BaseConfig>.snapshotBaseConfig() {
  ...
  valueList(name = "manifestPlaceholders", propertyAction = { manifestPlaceholders.entries }, formatAction = { "$key -> $value" }) {
    collection ->
    collection?.sortedBy { it.key }
  }
...
private fun ModelSnapshotter<BasicVariant>.snapshotBasicVariant() {
  ...
  dataObject("mainArtifact", BasicVariant::mainArtifact) { snapshotBasicArtifact() }
  dataObject("androidTestArtifact", BasicVariant::androidTestArtifact) { snapshotBasicArtifact() }
  dataObject("unitTestArtifact", BasicVariant::unitTestArtifact) { snapshotBasicArtifact() }
  dataObject("testFixturesArtifact", BasicVariant::testFixturesArtifact) { snapshotBasicArtifact() }
}
...
private fun ModelSnapshotter<Variant>.snapshotVariant() {
  ...
  dataObject("mainArtifact", Variant::mainArtifact) { snapshotAndroidArtifact() }
  dataObject("androidTestArtifact", Variant::androidTestArtifact) { snapshotAndroidArtifact() }
  dataObject("unitTestArtifact", Variant::unitTestArtifact) { snapshotJavaArtifact() }
  dataObject("testFixturesArtifact", Variant::testFixturesArtifact) { snapshotAndroidArtifact() }
...
private fun ModelSnapshotter<BasicArtifact>.snapshotBasicArtifact() {
  dataObject("variantSourceProvider", BasicArtifact::variantSourceProvider) { snapshotSourceProvider() }
  dataObject("multiFlavorSourceProvider", BasicArtifact::multiFlavorSourceProvider) { snapshotSourceProvider() }
}
...
internal fun ModelSnapshotter<ProjectGraph>.snapshotProjectGraph() {
  objectList(name = "variant", propertyAction = { resolvedVariantsWithProjectInfo?.entries }, nameAction = { this.value.toString() }) {
    this
    dataObject("projectInfo", { it.key }) { snapshotProjectInfo() }
  }
}

internal fun ModelSnapshotter<VariantDependencies>.snapshotVariantDependencies() {
  item("name", VariantDependencies::name)
  dataObject("mainArtifact", VariantDependencies::mainArtifact) { snapshotArtifactDependencies() }
  dataObject("androidTestArtifact", VariantDependencies::androidTestArtifact) { snapshotArtifactDependencies() }
  dataObject("unitTestArtifact", VariantDependencies::unitTestArtifact) { snapshotArtifactDependencies() }
  dataObject("testFixturesArtifact", VariantDependencies::testFixturesArtifact) { snapshotArtifactDependencies() }
  ...
  objectList(
    ...
    dataObject("projectInfo", Library::projectInfo) { snapshotProjectInfo() }
    dataObject("libraryInfo", Library::libraryInfo) {
      ...
      valueList(name = "productFlavors", propertyAction = { productFlavors.entries }, formatAction = { "$key -> $value" }) { collection ->
        collection?.sortedBy { it.key }
      }
      valueList(name = "attributes", propertyAction = { attributes.entries }, formatAction = { "$key -> $value" }) { collection ->
        collection?.sortedBy { it.key }
      }
      valueList(name = "capabilities", propertyAction = ComponentInfo::capabilities) { collection -> collection?.sortedBy { it } }
    }
...
private fun ModelSnapshotter<ArtifactDependencies>.snapshotArtifactDependencies() {
  ...
  objectList(name = "unresolvedDependencies", propertyAction = ArtifactDependencies::unresolvedDependencies, nameAction = { name }) {
...
private fun ModelSnapshotter<GraphItem>.snapshotGraphItem(visited: MutableSet<String>) {
  ...
  if (visited.contains(localKey)) {
    ...
    objectList(name = "dependencies", propertyAction = GraphItem::dependencies, nameAction = { it.normalizeArtifactAddress(key) }) {
      snapshotGraphItem(visited)
    }
  }
}
