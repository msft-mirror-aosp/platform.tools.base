...
class SnapshotItemRegistrarImpl(override val name: String, override val contentType: SnapshotContainer.ContentType) :
   ...
   */
  override fun <T> valueList(name: String, list: Collection<T>?, formatAction: (T.() -> String)?) {
   ...
   */
  override fun <T> objectList(name: String, list: Collection<T>?, action: SnapshotItemRegistrar.(Collection<T>) -> Unit) {
    check(contentType == SnapshotContainer.ContentType.OBJECT_PROPERTIES || contentType == SnapshotContainer.ContentType.OBJECT_LIST)
   ...
   * @param action a callback to add the items to the builder
   */
  override fun <T> dataObject(name: String, obj: T?, action: T.(SnapshotItemRegistrar) -> Unit) {
    check(contentType == SnapshotContainer.ContentType.OBJECT_PROPERTIES || contentType == SnapshotContainer.ContentType.OBJECT_LIST)
