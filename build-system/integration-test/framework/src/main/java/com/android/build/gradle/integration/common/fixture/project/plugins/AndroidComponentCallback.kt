...
/**
 * Base interface for all component callbacks.
 */
interface AndroidComponentCallback

/**
 * interface to implement to provide custom plugin logic to a [GradleRule] project
 * of type Android Application
 */
interface ApplicationComponentCallback: AndroidComponentCallback {
 ...
 */
interface LibraryComponentCallback: AndroidComponentCallback {
    fun handleComponents(
        project: Project,
