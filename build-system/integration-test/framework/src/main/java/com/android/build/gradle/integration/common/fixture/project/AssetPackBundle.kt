...
internal class AssetPackBundleDefinitionImpl(path: String, createMinimumProject: Boolean) :
  GradleProjectDefinitionImpl(path), AssetPackBundleDefinition {
  ...
  override val bundle: AssetPackBundleExtension =
    DslProxy.createProxy(AssetPackBundleExtension::class.java, dslRecorder).also {
  ...
  override fun writeExtension(writer: BuildWriter, location: Path) {
    writer.apply {
      block("bundle") { dslRecorder.writeContent(this) }
...
internal class AssetPackBundleImpl(location: Path, projectDefinition: AssetPackBundleDefinition) :
  GradleProjectImpl<AssetPackBundleDefinition>(location, projectDefinition),
  AssetPackBundleProject,
  GeneratesAab by GeneratesAabDelegate(location) {

  override fun getReversibleInstance(fileChangeController: FileChangeController): AssetPackBundleProject =
    ReversibleAssetPackBundleProject(this, fileChangeController)
}

/** Reversible version of [AssetPackBundleProject] */
internal class ReversibleAssetPackBundleProject(parentProject: AssetPackBundleProject, fileChangeController: FileChangeController) :
  ReversibleGradleProject<AssetPackBundleProject, AssetPackBundleDefinition>(parentProject, fileChangeController),
  AssetPackBundleProject,
