...
class MapPropertyProxy<K : Any, V : Any>(private val dslRecorder: DslRecorder) : MapProperty<K, V> {
  ...
  override fun <U : Any, R : Any> zip(right: Provider<U>, combiner: BiFunction<in MutableMap<K, V>, in U, out R?>): Provider<R> {
    throw RuntimeException("Not yet implemented")
  }
