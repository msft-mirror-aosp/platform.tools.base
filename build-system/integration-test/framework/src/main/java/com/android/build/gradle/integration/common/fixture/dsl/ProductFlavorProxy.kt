...
open class ProductFlavorProxy(internal val dslRecorder: DslRecorder) : ProductFlavor {
  ...
  override fun testInstrumentationRunnerArgument(key: String, value: String) {
    dslRecorder.call("testInstrumentationRunnerArgument", listOf(key, value), isVarArgs = false)
  }

  override fun setTestInstrumentationRunnerArguments(testInstrumentationRunnerArguments: MutableMap<String, String>): Any? {
    dslRecorder.call("setTestInstrumentationRunnerArguments", listOf(testInstrumentationRunnerArguments), isVarArgs = false)
    return this
  }

  override fun testInstrumentationRunnerArguments(args: Map<String, String>) {
    dslRecorder.call("testInstrumentationRunnerArguments", listOf(args), isVarArgs = false)
  }
  ...
  override val vectorDrawables: VectorDrawables
    get() = DslProxy.createProxy(VectorDrawables::class.java, dslRecorder.createChainedRecorder("vectorDrawables"))
  ...
  override fun missingDimensionStrategy(dimension: String, requestedValue: String) {
    dslRecorder.call("missingDimensionStrategy", listOf(dimension, requestedValue), isVarArgs = false)
  }

  override fun missingDimensionStrategy(dimension: String, vararg requestedValues: String) {
    dslRecorder.call("missingDimensionStrategy", listOf(dimension, requestedValues), isVarArgs = true)
  }

  override fun missingDimensionStrategy(dimension: String, requestedValues: List<String>) {
    dslRecorder.call("missingDimensionStrategy", listOf(dimension, requestedValues), isVarArgs = false)
  }
  ...
  override fun ndk(action: Ndk.() -> Unit) {
    dslRecorder.runNestedBlock(name = "ndk", parameters = listOf(), instanceProvider = { DslProxy.createProxy(Ndk::class.java, it) }) {
      action(this)
    }
  }
  ...
  override val javaCompileOptions: JavaCompileOptions
    get() = DslProxy.createProxy(JavaCompileOptions::class.java, dslRecorder.createChainedRecorder("javaCompileOptions"))
  ...
  override val shaders: Shaders
    get() = DslProxy.createProxy(Shaders::class.java, dslRecorder.createChainedRecorder("shaders"))
  ...
  override val externalNativeBuild: ExternalNativeBuildFlags
    get() = DslProxy.createProxy(ExternalNativeBuildFlags::class.java, dslRecorder.createChainedRecorder("externalNativeBuild"))
  ...
  override val optimization: Optimization
    get() = DslProxy.createProxy(Optimization::class.java, dslRecorder.createChainedRecorder("optimization"))
