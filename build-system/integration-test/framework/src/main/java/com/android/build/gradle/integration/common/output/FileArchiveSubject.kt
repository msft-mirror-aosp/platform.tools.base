...
interface FileArchiveSubject {
   ...
   * The archive list contains files only. There are no folders in it.
   *
   * The possible format of the provided item list includes both file path and folders. In the case of folders, it will match against any
   * files in the archive that are in that folder.
   */
