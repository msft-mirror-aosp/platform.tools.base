...
interface DependencyConfigurations {
   ...
   */
  fun add(configurationName: String, dependency: Any, action: (DependencyBuilder.() -> Unit)? = null)
   ...
   * See [implementation] for details
   */
  fun add(configurationNameToDependency: Pair<String, Any>, action: (DependencyBuilder.() -> Unit)? = null)
...
internal data class DependencyData(val configurationName: String, val dependency: Any, val capability: String? = null)
...
internal class DependencyConfigurationsBuilderImpl() : DependenciesConfigurationsBuilder {
  ...
  override fun remove(scope: String, dependency: Any, action: (DependencyBuilder.() -> Unit)?): Boolean {
    val dependencyData =
      action?.let {
  ...
  override fun add(configurationName: String, dependency: Any, action: (DependencyBuilder.() -> Unit)?) {
    val dependencyData =
      action?.let {
        val builder = DependencyBuilderImpl()
        action(builder)
  ...
  override fun add(configurationNameToDependency: Pair<String, Any>, action: (DependencyBuilder.() -> Unit)?) {
