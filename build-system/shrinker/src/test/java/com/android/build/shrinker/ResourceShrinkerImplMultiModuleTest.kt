...
class ResourceShrinkerImplMultiModuleTest {
  ...
  fun `shrink resources in a basic multi-modules project`() {
    ...
    val shrinker =
      ResourceShrinkerImpl(
        resourcesGatherers =
          listOf(ProtoResourceTableGatherer(app.baseResourceTable), ProtoResourceTableGatherer(app.featureResourceTable)),
  ...
  private fun createBaseModuleResourceTable(root: File): File {
    val basePackage =
      Resources.Package.newBuilder()
        ...
        .addType(6, "style", styleEntry(0, "AppTheme"), styleEntry(1, "MyStyle"))
        .addType(7, "menu", xmlFile(0, "main", "res/menu/main.xml"))
    ...
    return writeBinaryFile(File(root, "base/resources.pb"), basePackage.buildResourceTable().toByteArray())
  }
  ...
  private fun createFeatureModuleResourceTable(root: File): File {
    val featurePackage =
      Resources.Package.newBuilder()
        ...
        .addType(6, "style", styleEntry(0, "MyStyle.Child", 0x7f060001))
        .addType(7, "menu", xmlFile(0, "menu2", "res/menu/menu2.xml"))
        .addType(
          8,
          "raw",
    ...
    return writeBinaryFile(File(root, "feature/resources.pb"), featurePackage.buildResourceTable().toByteArray())
  }
          ...
          xmlElement("application")
            ...
            .addChild(
              xmlElement("activity")
                ...
                .addAttribute("name", ANDROID_NS, "example.app.feature.AnotherActivity")
                .addAttribute("layout", ANDROID_NS, "@layout/activity_feature", 0x80030000)
            )
        )
        .buildNode()

    return writeBinaryFile(File(dir, "feature/manifest/AndroidManifest.xml"), manifest.toByteArray())
  }
  ...
  private fun createBaseManifest(dir: File): File {
    ...
    return writeBinaryFile(File(dir, "base/manifest/AndroidManifest.xml"), manifest.toByteArray())
  }
  ...
  private fun createBaseResources(root: File): File {
    ...
    writeBinaryFile(File(root, "base/res/layout/layout_1.xml"), xmlElement("SomeBaseLayout").buildNode().toByteArray())

    writeBinaryFile(File(root, "base/res/drawable/unused.png"), ByteArray(100))
  ...
  private fun createFeatureResources(root: File): File {
    ...
    writeBinaryFile(File(root, "feature/res/layout/layout_feat.xml"), xmlElement("SomeFeatureLayout").buildNode().toByteArray())
  ...
  private fun createR8Dex(root: File): File {
    ...
    */
    val dexContent = CommonIoResources.toByteArray(CommonIoResources.getResource("resourceShrinker/classes.dex"))
    return writeBinaryFile(File(root, "base/dex/classes.dex"), dexContent)
  }

  private fun createDexWithGetIdentifier(root: File): File {
    val dexContent = CommonIoResources.toByteArray(CommonIoResources.getResource("resourceShrinker/getidentifier.dex"))
    return writeBinaryFile(File(root, "feature/dex/getidentifier.dex"), dexContent)
  }
  ...
  private fun String.removeEmptyLines() = split('\n').filter { it.isNotBlank() }.joinToString("\n")
}
