...
class PackagingUtilsTest {
  ...
  fun testGetNoCompressPredicateForExtensions_withNonEnglishChars() {
    PackagingUtils.getNoCompressPredicateForExtensions(listOf(".koŃcówka")).run {
  ...
  fun testGetNoCompressPredicateForExtensions_withPaths() {
    PackagingUtils.getNoCompressPredicateForExtensions(listOf("Android/subFolder/MyFile.idk")).run {
  ...
  fun testGetNoCompressPredicateWithExtensions_withFileNames() {
    PackagingUtils.getNoCompressPredicate(listOf(), NativeLibrariesPackagingMode.COMPRESSED, DexPackagingMode.COMPRESSED).run {
  ...
  fun testGetNoCompressGlobsForBundle_withPaths() {
    val matchers = PackagingUtils.getNoCompressGlobsForBundle(listOf("Android/subFolder/MyFile.idk"))
  ...
  fun testGetNoCompressGlobsForAapt() {
    ...
    val matchers = PackagingUtils.getNoCompressForAapt(listOf(".end", ".ąĘ", "Android/foo.bar", ".a(b)c?"))
    val expected =
      listOf(
  ...
  fun testGetNoCompressPredicate_doNotCompressNativeLibsOrDex() {
    ...
    PackagingUtils.getNoCompressPredicate(listOf("oo"), nativeLibsPackagingMode, dexPackagingMode).run {
