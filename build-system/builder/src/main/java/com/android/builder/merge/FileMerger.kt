...
object FileMerger {
  ...
  /**
   * Performs a merge operation. All files from all [inputs] are merged into [output].
   *
   * @param inputs all inputs
   * @param output object receiving information about all changes that need to be made to the output
