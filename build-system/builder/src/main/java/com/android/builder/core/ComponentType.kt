 ...
 * Type of component.
 *
 * Each plugin will produce a main component (variant) with multiple nested components within the variant. For example, the library plugin
 * produces a main variant of type [ComponentTypeImpl.LIBRARY] and might have attached components of type [ComponentTypeImpl.UNIT_TEST],
...
interface ComponentType {
  ...
  /**
   * Returns true if the variant is a base module. This is only true if it can have features. If the variant can never have feature (TEST
   * modules for instance), then this is false.
   */
  ...
  /** Returns true if this is a nested component in the module (either a test component or a testFixtures component). */
  ...
  /**
   * Returns true if the variant is a test variant, whether this is the test component of a module (testing the prod component of the same
   * module) or a separate test-only module.
   */
  ...
  /**
   * Returns prefix used for naming source directories. This is an empty string in case of non-testing variants and a camel case string
   * otherwise, e.g. "androidTest".
   */
  val prefix: String
  /**
   * Returns suffix used for naming Gradle tasks. This is an empty string in case of non-testing variants and a camel case string otherwise,
   * e.g. "AndroidTest".
   */
  val suffix: String
