...
internal open class SettingsCompileSdkSpecImpl @Inject constructor(
    ...
    override fun release(
        version: Int,
        action: (CompileSdkReleaseSpec.() -> Unit)
    ): CompileSdkVersion {
        val compileSdkReleaseSpec =
            objectFactory.newInstance(SettingsCompileSdkReleaseSpecImpl::class.java)
    ...
    fun release(
        version: Int,
        action: Action<CompileSdkReleaseSpec>
    ): CompileSdkVersion {
        val compileSdkReleaseSpec =
            objectFactory.newInstance(SettingsCompileSdkReleaseSpecImpl::class.java)
