...
interface ApplicationBuildFeatures : BuildFeatures {
   ...
   * `android.defaults.buildfeatures.databinding=true` in the `gradle.properties` file at the root project of your build.
   *
   ...
   *
   * You can override the default for this for all projects in your build by adding the line
   * `android.defaults.buildfeatures.mlmodelbinding=true` in the `gradle.properties` file at the root project of your build.
   *
   * More information about this feature at: TBD
   */
