...
interface Sources {
   ...
   * [com.android.build.api.dsl.LibraryBuildFeatures.androidResources] is true for library variants, otherwise null.
   */
  ...
  /**
   * Access to the machine learning models folders if [com.android.build.api.dsl.ApplicationBuildFeatures.mlModelBinding] is true otherwise
   * null
   */
   ...
   * RenderScript APIs are deprecated starting in Android 12 <a href="https://developer.android.com/guide/topics/renderscript/migrate">See
   * more</a>.
   */
   ...
   *
   * The first caller will create the new instance, other callers with the same [name] will get the same instance returned. Any callers can
   * obtain the final list of the folders registered under this custom source type by calling [SourceDirectories.Flat.all].
   *
