 ...
 *
 * Test projects have a target application project that they depend on and build type matching works in the same way as library
 * dependencies. Therefore to test multiple build types of an application you can declare corresponding build types here.
 *
