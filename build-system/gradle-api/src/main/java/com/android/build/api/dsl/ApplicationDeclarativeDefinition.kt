...
interface ApplicationDeclarativeDefinition :
  ...
  /**
   * Specifies build features that can be enabled or disabled on the Android Project.
   *
   * For more information about the properties you can configure in this block, see [BuildFeatures].
   */
  @get:Incubating val buildFeatures: ApplicationBuildFeatures
