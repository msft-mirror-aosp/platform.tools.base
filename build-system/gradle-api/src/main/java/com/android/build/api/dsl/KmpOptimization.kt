...
interface KmpOptimization {
  ...
  @get:Incubating val keepRules: LibraryKeepRules

  /** The collection of keep rule files to use for the test APK. */
  @get:Incubating val testKeepRules: ConfigurableFiles

  /** The collection of keep rule files for consumers of the library to use. */
  @get:Incubating val consumerKeepRules: ConsumerKeepRules
   ...
   */
  @get:Incubating @set:Incubating var minify: Boolean
}
