...
interface BuildFeatures : ExtensionAware {
   ...
   * Setting the value to `null` resets to the default value. Default value is `false`.
   *
   * You can override the default for this in your module by setting android { buildFeatures { prefab true } } in the module's build.gradle
   * file.
   *
   ...
   * Setting the value to `null` resets to the default value. Default value is `false`.
   */
  @Deprecated("This property and renderScript support will be removed in AGP 10.0") var renderScript: Boolean?
   ...
   * `android.defaults.buildfeatures.viewbinding=true` in the gradle.properties file at the root project of your build.
   *
