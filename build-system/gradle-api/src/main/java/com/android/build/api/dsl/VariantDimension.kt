...
interface VariantDimension {
   ...
   *
   * See [Inject Build Variables into the Manifest](https://developer.android.com/studio/build/manifest-build-variables.html).
   */
   ...
   */
  @get:Incubating val externalNativeBuild: ExternalNativeBuildFlags
   ...
   * To learn more, see [Add C and C++ Code to Your Project](http://developer.android.com/studio/projects/add-native-code.html#).
   */
  @Incubating fun externalNativeBuild(action: ExternalNativeBuildFlags.() -> Unit)
   ...
   */
  @Adding fun buildConfigField(type: String, name: String, value: String)
  ...
  @Deprecated("Use ApplicationBuildType.optimization instead") @get:Incubating val optimization: Optimization

  @Deprecated("Use ApplicationBuildType.optimization(action) instead") @Incubating fun optimization(action: Optimization.() -> Unit)
}
