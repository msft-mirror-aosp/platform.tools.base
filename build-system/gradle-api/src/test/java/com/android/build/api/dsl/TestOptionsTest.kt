...
class TestOptionsTest {
  ...
  @Mock private lateinit var testOptions: TestOptions
  ...
  /** Test that new unknown [TestSuite] to AGP can be registered and configured through the [TestOptions] interface. */
  @Test
