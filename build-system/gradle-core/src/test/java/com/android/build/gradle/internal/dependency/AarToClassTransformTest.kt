...
class AarToClassTransformTest {
  ...
  fun collidingJavaResources_areIgnored() {
    ...
    ZipFile(aar).use { inputAar ->
      AarToClassTransform.mergeJars(outputJar = outputJar, inputAar = inputAar, forCompileUse = true, generateRClassJar = false)
    }
  ...
  fun testRClassGeneration() {
    ...
    ZipFile(aar).use { inputAar ->
      AarToClassTransform.mergeJars(outputJar = outputJar, inputAar = inputAar, forCompileUse = true, generateRClassJar = true)
    }
