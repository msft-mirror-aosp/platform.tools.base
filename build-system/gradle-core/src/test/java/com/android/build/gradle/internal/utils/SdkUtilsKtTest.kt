...
internal class SdkUtilsKtTest {
  ...
  fun `api level target`() {
    Truth.assertThat(parseTargetHash("android-23")).isEqualTo(CompileSdkVersionImpl(apiLevel = 23))
  }
  ...
  @Test
  fun `canary target`() {
    Truth.assertThat(parseTargetHash("android-canary-20250617")).isEqualTo(CompileSdkVersionImpl(canaryDate = "20250617"))
  }

  @Test
  fun `beta target`() {
    Truth.assertThat(parseTargetHash("android-36-beta1")).isEqualTo(CompileSdkVersionImpl(apiLevel = 36, betaVersion = 1))
    Truth.assertThat(parseTargetHash("android-36.0-beta1"))
      .isEqualTo(CompileSdkVersionImpl(apiLevel = 36, minorApiLevel = 0, betaVersion = 1))
    Truth.assertThat(parseTargetHash("android-36.2-beta3"))
      .isEqualTo(CompileSdkVersionImpl(apiLevel = 36, minorApiLevel = 2, betaVersion = 3))
  }

  @Test
  fun `api level + extension target`() {
    Truth.assertThat(parseTargetHash("android-23-ext12")).isEqualTo(CompileSdkVersionImpl(apiLevel = 23, sdkExtension = 12))
  }

  @Test
  fun `api level + minor api level`() {
    Truth.assertThat(parseTargetHash("android-36.2")).isEqualTo(CompileSdkVersionImpl(apiLevel = 36, minorApiLevel = 2))
  }

  @Test
  fun `api level + minor api level + extension target`() {
    Truth.assertThat(parseTargetHash("android-36.2-ext12"))
      .isEqualTo(CompileSdkVersionImpl(apiLevel = 36, sdkExtension = 12, minorApiLevel = 2))
  }
  ...
  @Test
  fun `addon target`() {
    Truth.assertThat(parseTargetHash("foo:bar:12")).isEqualTo(CompileSdkVersionImpl(vendorName = "foo", addonName = "bar", apiLevel = 12))
  }
  ...
  fun `compile data to hash`() {
    ...
    Truth.assertThat(CompileSdkVersionImpl(minorApiLevel = 3, sdkExtension = 12).toHash()).isNull()
