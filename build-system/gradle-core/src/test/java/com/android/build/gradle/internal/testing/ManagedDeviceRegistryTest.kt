...
private interface SharedDeviceTestRunConfigAction : DeviceTestRunConfigureAction<SharedDeviceApi, TestDeviceTestRunInput>

private interface TestDeviceApi : Device

private interface TestDeviceSetupConfigAction : DeviceSetupConfigureAction<TestDeviceApi, TestDeviceSetupInput>

private interface TestDeviceTestRunConfigAction : DeviceTestRunConfigureAction<TestDeviceApi, TestDeviceTestRunInput>
...
private val testDeviceImplProxy: TestDeviceImpl =
  Proxy.newProxyInstance(ManagedDeviceRegistryTest::class.java.classLoader, arrayOf<Class<*>>(TestDeviceImpl::class.java)) { _, _, _ ->
    null
  } as TestDeviceImpl
...
class ManagedDeviceRegistryTest {
  ...
  fun registrationNoSetupActions() {
    registry.registerDeviceType(TestDeviceApi::class.java) {
      ...
      setTestRunActions(TestDeviceTestRunConfigAction::class.java, TestDeviceTestRunTaskAction::class.java)
    }

    verify(managedDevicesBlock.allDevices).registerBinding(eq(TestDeviceApi::class.java), eq(TestDeviceImpl::class.java))
    ...
    assertThat(registration.testRunConfigAction).isEqualTo(TestDeviceTestRunConfigAction::class.java)
    assertThat(registration.testRunTaskAction).isEqualTo(TestDeviceTestRunTaskAction::class.java)
  }
  ...
  fun registrationWithSetupActions() {
    registry.registerDeviceType(TestDeviceApi::class.java) {
      dslImplementationClass = TestDeviceImpl::class.java
      setSetupActions(TestDeviceSetupConfigAction::class.java, TestDeviceSetupTaskAction::class.java)
      setTestRunActions(TestDeviceTestRunConfigAction::class.java, TestDeviceTestRunTaskAction::class.java)
    }
  ...
  fun registerMultipleSameApiShouldFail() {
    registry.registerDeviceType(SharedDeviceApi::class.java) {
      dslImplementationClass = TestDeviceImpl::class.java
      setTestRunActions(SharedDeviceTestRunConfigAction::class.java, TestDeviceTestRunTaskAction::class.java)
    }
