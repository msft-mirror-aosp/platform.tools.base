...
class ResourcesApkPackagingImplTest {
  ...
  fun testExcludes() {
    ...
    val dslResourcesPackagingOptionsImpl = dslPackaging.resources as ResourcesPackagingImpl
    dslResourcesPackagingOptionsImpl.setExcludes(Sets.union(dslPackaging.resources.excludes, setOf("baz")))

    val resourcesPackagingOptionsImpl = ResourcesApkPackagingImpl(dslPackaging, variantPropertiesApiServices)
