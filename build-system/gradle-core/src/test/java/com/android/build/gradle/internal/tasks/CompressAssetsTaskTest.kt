...
class CompressAssetsTaskTest {
  ...
  fun testBasic() {
    ...
    CompressAssetsDelegate(workQueue, outputDir.toFile(), noCompressPredicate, compressionLevel, nonIncrementalChanges).run()
    ...
    CompressAssetsDelegate(workQueue, outputDir.toFile(), noCompressPredicate, compressionLevel, incrementalChanges).run()
