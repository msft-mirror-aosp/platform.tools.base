...
class SyncIssueReporterImplTest {
    ...
    @Before
    fun setup() {
        whenever(androidProblemsReporterProviderService.reporter())
            .thenReturn(androidProblemsReporter)
    }
    ...
    fun testCollectingIssueTwice() {
        ...
        assertThat(androidProblemsReporter.reportedSyncIssues).isEqualTo(listOf(
