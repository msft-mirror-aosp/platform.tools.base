...
class ManagedDeviceImageSuggestionGeneratorTest {
  ...
  fun ensureInvalidAllArchitectureMessage() {
    val generator =
      ManagedDeviceImageSuggestionGenerator(CpuArchitecture.X86_64, "invalid_device", 30, 0, null, "aosp", "", false, listOf())

    assertThat(generator.message)
      .isEqualTo("System Image specified by invalid_device does not exist.\n\n" + "Try one of the following fixes:")
  }
  ...
  fun ensureAlternativeSourceSuggestionWorks() {
    val generator =
      ManagedDeviceImageSuggestionGenerator(
        ...
        "",
        true,
        listOf("system-images;android-28;aosp_atd;x86_64", "system-images;android-28;default;x86_64"),
      )
  ...
  fun ensureSuggestingLatestIfHigherDoesNotExistWorks() {
    val generator =
      ManagedDeviceImageSuggestionGenerator(
        ...
        "",
        false,
        listOf("system-images;android-31;default;arm64-v8a"),
      )
    assertThat(generator.message)
      .isEqualTo(
  ...
  fun ensure32BitSuggestionWorks() {
    val generator =
      ManagedDeviceImageSuggestionGenerator(
        ...
        "",
        true,
        listOf("system-images;android-24;default;x86"),
      )
