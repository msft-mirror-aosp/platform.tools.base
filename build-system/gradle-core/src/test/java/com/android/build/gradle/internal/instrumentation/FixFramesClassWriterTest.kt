...
class FixFramesClassWriterTest {
  ...
  fun setUp() {
    fixFramesClassWriter =
      FixFramesClassWriterWrapper(ClassesHierarchyResolver.Builder(ClassesDataCache()).addDependenciesSources(androidJar.toFile()).build())
  ...
  fun testCommonSuperClassCalculation() {
    ...
    assertCommonSuperClassIsTheSame(Array<FileInputStream>::class.java, Array<BufferedInputStream>::class.java)
    assertCommonSuperClassIsTheSame(Array<ObjectInput>::class.java, Array<ObjectOutput>::class.java)
    assertCommonSuperClassIsTheSame(Array<Closeable>::class.java, Array<AutoCloseable>::class.java)

    assertCommonSuperClassIsTheSame(Array<Array<Array<Closeable>>>::class.java, Array<Array<Array<AutoCloseable>>>::class.java)
    assertCommonSuperClassIsTheSame(Array<Array<Closeable>>::class.java, Array<Array<Array<AutoCloseable>>>::class.java)
    assertCommonSuperClassIsTheSame(Array<Array<Array<FileInputStream>>>::class.java, Array<Array<Array<BufferedInputStream>>>::class.java)
    assertCommonSuperClassIsTheSame(Array<Array<Array<Int>>>::class.java, Array<Array<Array<Boolean>>>::class.java)
  }

  private fun assertCommonSuperClassIsTheSame(firstClass: Class<*>, secondClass: Class<*>) {
    assertThat(fixFramesClassWriter.findCommonSuperClass(Type.getInternalName(firstClass), Type.getInternalName(secondClass)))
      .isEqualTo(classWriter.findCommonSuperClass(Type.getInternalName(firstClass), Type.getInternalName(secondClass)))
  }
