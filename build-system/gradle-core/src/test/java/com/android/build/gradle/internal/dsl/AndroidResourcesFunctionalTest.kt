 ...
 *
 * The AndroidResources block is unusual as it was subclassed after initially being created on common extension, which is currently
 * unsupported by the DSL decorator.
 */
class AndroidResourcesFunctionalTest {
  ...
  private fun buildProject(plugin: TestProjects.Plugin): Project {
    val project = TestProjects.builder(projectDirectory.newFolder("project").toPath()).withPlugin(plugin).build()
