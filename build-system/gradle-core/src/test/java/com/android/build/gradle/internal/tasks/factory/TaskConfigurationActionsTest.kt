...
class TaskConfigurationActionsTest {
  ...
  private val expectedOrderedActions =
    listOf(
  ...
  fun `delayed creation`() {
    ...
    @Suppress("UNCHECKED_CAST") val taskProvider = mock<TaskProvider<Task>>()
  ...
  private fun createTaskAction(): TaskConfigurationActions<Task> {
    val creationAction =
      object : TaskCreationAction<Task>() {
    ...
    return TaskConfigurationActions(creationAction, preConfigAction, configureAction, providerHandler)
  }
}
