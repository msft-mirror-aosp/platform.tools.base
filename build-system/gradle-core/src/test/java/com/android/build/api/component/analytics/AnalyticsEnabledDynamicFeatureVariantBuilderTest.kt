...
class AnalyticsEnabledDynamicFeatureVariantBuilderTest {
  ...
  @Suppress("DEPRECATION") private val androidTestBuilder: com.android.build.api.variant.AndroidTestBuilder = mock()
  ...
  private val proxy: AnalyticsEnabledDynamicFeatureVariantBuilder by lazy { AnalyticsEnabledDynamicFeatureVariantBuilder(delegate, stats) }

  @Before
  fun setup() {
    @Suppress("DEPRECATION") whenever(delegate.androidTest).thenReturn(androidTestBuilder)
  }
