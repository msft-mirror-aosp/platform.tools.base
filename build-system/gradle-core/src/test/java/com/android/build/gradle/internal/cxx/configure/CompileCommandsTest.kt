...
class CompileCommandsTest {
  ...
  fun `garbage bin is discarded`() {
    ...
    Files.delete(bin.toPath())
    bin.writer().use { writer -> writer.append("garbage file") }
    bin.setLastModified(json.lastModified())
  ...
  fun `missing -o flag is error`() {
    ...
    structuredLog.assertError(code = COULD_NOT_EXTRACT_OUTPUT_FILE_FROM_CLANG_COMMAND)
  }
  ...
  fun `check some valid object-to-target translations`() {
    assertTargetNameFromObjectFile("Externals/cpp-optparse/CMakeFiles/cpp-optparse.dir/OptionParser.cpp.o", expectTarget = "cpp-optparse")
    assertTargetNameFromObjectFile("CMakeFiles/cpp-optparse.dir/OptionParser.cpp.o", expectTarget = "cpp-optparse")
    assertTargetNameFromObjectFile("CMakeFiles/cpp-optparse.dir/src/OptionParser.cpp.o", expectTarget = "cpp-optparse")
    assertTargetNameFromObjectFile("CMakeFiles/cpp-optparse.dir/user.dir/OptionParser.cpp.o", expectTarget = "cpp-optparse")
  }
}
