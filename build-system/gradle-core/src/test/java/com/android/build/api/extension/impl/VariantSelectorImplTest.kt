...
internal class VariantSelectorImplTest {
  ...
  @Test
  fun testWithName() {
    val variantSelector = VariantSelectorImpl().withName(Pattern.compile("F.o")) as VariantSelectorImpl
  ...
  fun testWithBuildType() {
    val variantSelector = VariantSelectorImpl().withBuildType("debug") as VariantSelectorImpl
  ...
  fun testWithBuildTypeAndName() {
    val variantSelector = VariantSelectorImpl().withBuildType("debug").withName(Pattern.compile("F.o")) as VariantSelectorImpl
    val debugVariant1 = mock<ApplicationVariantBuilder>()
    whenever(debugVariant1.buildType).thenReturn("debug")
  ...
  fun testWithProductFlavor() {
    val flavorAndDimensionVariantSelector = VariantSelectorImpl().withFlavor("dim1" to "flavor1")
    val variantSelectorWithoutPair = VariantSelectorImpl().withFlavor("dim3", "flavor1")
    ...
    whenever(flavor1Variant.productFlavors).thenReturn(listOf("dim1" to "flavor1", "dim2" to "flavor2"))
    whenever(flavor2variant.productFlavors).thenReturn(listOf("dim2" to "flavor2", "dim3" to "flavor3"))
    whenever(flavor1Dim3Variant.productFlavors).thenReturn(listOf("dim3" to "flavor1"))
  ...
  fun testWithBuildTypeAndFlavor() {
    val variantSelector = VariantSelectorImpl().withFlavor("dim1" to "flavor1").withBuildType("debug") as VariantSelectorImpl
    ...
    whenever(applicationVariantBuilder1.productFlavors).thenReturn(listOf("dim1" to "flavor1", "dim2" to "flavor2"))
    ...
    whenever(applicationVariantBuilder2.productFlavors).thenReturn(listOf("dim1" to "flavor1", "dim2" to "flavor2"))
    val libraryVariantBuilder = mock<LibraryVariantBuilder>()
    whenever(libraryVariantBuilder.buildType).thenReturn("debug")
    whenever(libraryVariantBuilder.productFlavors).thenReturn(listOf("dim1" to "flavor1", "dim2" to "flavor2"))
  ...
  fun testWithBuildTypeAndFlavorAndName() {
    val variantSelector =
      VariantSelectorImpl().withFlavor("dim1" to "flavor1").withBuildType("debug").withName(Pattern.compile("F.o")) as VariantSelectorImpl

    val variantFoo = mock<ApplicationVariantBuilder>()
    whenever(variantFoo.buildType).thenReturn("debug")
    whenever(variantFoo.productFlavors).thenReturn(listOf("dim1" to "flavor1", "dim2" to "flavor2"))
    whenever(variantFoo.name).thenReturn("Foo")

    val variantBar = mock<ApplicationVariantBuilder>()
    whenever(variantBar.buildType).thenReturn("debug")
    whenever(variantBar.productFlavors).thenReturn(listOf("dim1" to "flavor1", "dim2" to "flavor2"))
    whenever(variantBar.name).thenReturn("Bar")

    val variantFoo2 = mock<ApplicationVariantBuilder>()
    whenever(variantFoo2.buildType).thenReturn("release")
    whenever(variantFoo2.productFlavors).thenReturn(listOf("dim1" to "flavor1", "dim2" to "flavor2"))
    ...
    whenever(variantFoo3.productFlavors).thenReturn(listOf("dim1" to "flavor1", "dim2" to "flavor2"))
