...
class AnalyticsEnabledApplicationAndroidResourcesBuilderTest {
  ...
  private val proxy: AnalyticsEnabledApplicationAndroidResourcesBuilder by
    lazy(LazyThreadSafetyMode.SYNCHRONIZED) { AnalyticsEnabledApplicationAndroidResourcesBuilder(delegate, stats) }
  ...
  fun generateLocaleConfig() {
    ...
    verify(delegate, times(1)).generateLocaleConfig = true
  }
}
