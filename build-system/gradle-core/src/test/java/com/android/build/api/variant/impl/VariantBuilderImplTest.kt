...
internal class VariantBuilderImplTest {
  ...
  private fun setTargetSdk(value: Int) =
    GeneratesApkBuilder::class.java.getMethod("setTargetSdk", Integer::class.java).invoke(builder, value)

  private fun getTargetSdkPreview() = GeneratesApkBuilder::class.java.getMethod("getTargetSdkPreview").invoke(builder)

  private fun setTargetSdkPreview(value: Any) =
    GeneratesApkBuilder::class.java.getMethod("setTargetSdkPreview", String::class.java).invoke(builder, value)
}
