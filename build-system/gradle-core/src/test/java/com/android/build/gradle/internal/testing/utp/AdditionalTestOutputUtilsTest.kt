...
class AdditionalTestOutputUtilsTest {
  ...
  fun findAdditionalTestOutputDirectoryOnDeviceWithApi16() {
    ...
    assertThat(dir).isEqualTo("/storage/emulated/0/Android/data/testedApplicationId/files/test_data")
  }
  ...
  fun findAdditionalTestOutputDirectoryOnDeviceWithApi29() {
    ...
    assertThat(dir).isEqualTo("/sdcard/Android/media/testedApplicationId/additional_test_output")
  }
