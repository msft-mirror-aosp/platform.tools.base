...
class ManagedDeviceUtilsTest {
  ...
  fun computeAvdName_sameAvdSameVendor() {
    val google = computeAvdName(30, 0, null, "google", "", "x86", "Pixel 2")
    val googleApis = computeAvdName(30, 0, null, "google_apis", "", "x86", "Pixel 2")
  ...
  fun computeAvdName_pageAlignmentWorks() {
    val pageSize4k = computeAvdName(36, 0, null, "google_apis", "", "x86", "Pixel 3")

    assertThat(pageSize4k).isEqualTo("dev36_google_apis_x86_Pixel_3")

    val pageSize16k = computeAvdName(36, 0, null, "google_apis", "_ps16k", "x86", "Pixel 3")
  ...
  fun computAvdName_extensionVersionWorks() {
    val noExtension = computeAvdName(34, 0, null, "google_apis", "", "x86_64", "Pixel 3")

    assertThat(noExtension).isEqualTo("dev34_google_apis_x86_64_Pixel_3")

    val extension = computeAvdName(34, 0, 12, "google_apis", "", "x86_64", "Pixel 3")

    assertThat(extension).isEqualTo("dev34_ext12_google_apis_x86_64_Pixel_3")
  }

  fun computeAvdName_minorVersionWorks() {
    val noMinor = computeAvdName(35, 0, null, "default", "", "x86_64", "Pixel 5")

    assertThat(noMinor).isEqualTo("dev35_default_x86_64_Pixel_5")

    val minorOnly = computeAvdName(35, 5, null, "default", "x86_64", "", "Pixel 5")

    assertThat(minorOnly).isEqualTo("dev35_m5_default_x86_64_Pixel_5")

    val minorAndExtension = computeAvdName(35, 5, 21, "default", "x86_64", "", "Pixel 5")
  ...
  fun computeAvdName_worksWithParenthesis() {
    val computedName = computeAvdName(29, 0, null, "google_apis", "", "x86", "Pixel 2 (something)")
  ...
  fun computeAvdName_worksWitQuotations() {
    val computedName = computeAvdName(33, 0, null, "google_apis", "", "x86", "8\" Fold-out")
