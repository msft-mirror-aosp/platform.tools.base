...
class AnalyticsEnabledCodeTransparencyTest {
  ...
  private val proxy: AnalyticsEnabledCodeTransparency by lazy { AnalyticsEnabledCodeTransparency(delegate, stats) }
  ...
  fun testSetSigningConfig() {
    ...
    verify(delegate, times(1)).setSigningConfig(signingConfig)
  }
}
