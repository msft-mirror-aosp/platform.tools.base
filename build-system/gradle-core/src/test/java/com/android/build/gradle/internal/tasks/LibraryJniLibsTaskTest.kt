...
class LibraryJniLibsTaskTest {
  ...
  fun testBasic() {
    ...
    TestInputsGenerator.writeJarWithEmptyEntries(jarFile1.toPath(), listOf("lib/x86/bar.so", "lib/x86/notAnSoFile"))
    ...
    LibraryJniLibsTask.LibraryJniLibsDelegate(dir1, listOf(jarFile1, jarFile2), outputDirectory, workers, task).copyFiles()
