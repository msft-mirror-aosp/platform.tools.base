...
internal class ProcessLibraryArtProfileTaskTest {
  ...
  @get:Rule var sourceFolder = TemporaryFolder()
  ...
  fun setUp() {
    ...
    val taskProvider = project.tasks.register("processLibraryArtProfile", ProcessLibraryArtProfileTask::class.java)
  ...
  fun testValidArtProfile() {
    val sourceFile =
      sourceFolder.newFile(SdkConstants.FN_ART_PROFILE).also {
        it.writeText(
          """
  ...
  fun testMultipleArtProfiles() {
    ...
    val sourceFile2 =
      sourceFolder.newFile("baseline-prof-2.txt").also {
        it.writeText(
          """
  ...
  fun testMergingWithInvalidArtProfile() {
    ...
    val sourceFile3 =
      sourceFolder.newFile("baseline-prof-3.txt").also {
        it.writeText(
          """
          HSPLcom/google/Bar;->method(II)I
          HSPLcom/google/Bar;->method-name-with-hyphens(II)I
