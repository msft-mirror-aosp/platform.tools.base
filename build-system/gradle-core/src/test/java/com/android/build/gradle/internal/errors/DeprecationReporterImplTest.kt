...
class DeprecationReporterImplTest {
  ...
  enum class FakeOption(
    ...
    DEPRECATED("android.deprecated.option", false, Option.Status.Deprecated(DeprecationReporter.DeprecationTarget.VERSION_8_0)),
    DEPRECATED_OPTIONAL(
      "android.deprecated.optional.option",
      null,
      Option.Status.Deprecated(DeprecationReporter.DeprecationTarget.VERSION_8_0),
    ),
    REMOVED("android.removed.option", false, Option.Status.Removed(Version.VERSION_8_0, "Extra message.")),
    ...
    EXPERIMENTAL_WITH_PLANNED_DEPRECATION(
      ...
      FutureStage(Version.VERSION_9_0, false, FeatureStage.Deprecated(DeprecationReporter.DeprecationTarget.VERSION_10_0)),
    );
  ...
  fun `test removed options, actual value != default value`() {
    ...
    assertThat(issueReporter.errors)
      .containsExactly(
        "The option 'android.removed.option' is deprecated.\n" +
          "The current default is 'false'.\n" +
          "It was removed in version 8.0 of the Android Gradle plugin.\n" +
  ...
  fun `test option state change behavior - deprecated`() {
    val futureReporter =
      DeprecationReporterImpl(
        issueReporter,
        ProjectOptions(FakeProviderFactory(factory, ImmutableMap.of("android.simulateAgpVersionBehavior", "10.0.0"))),
        "",
      )

    futureReporter.reportOptionIssuesIfAny(FakeOption.EXPERIMENTAL_WITH_PLANNED_DEPRECATION, true)
