...
class AndroidComponentsExtensionTest {
  ...
  fun testStaticPluginVersion() {
    ...
    val variantApiOperationsRegistrar =
      VariantApiOperationsRegistrar<ApplicationExtension, ApplicationVariantBuilder, ApplicationVariant>(extension)

    val androidComponents: ApplicationAndroidComponentsExtension =
      ApplicationAndroidComponentsExtensionImpl(dslServices, sdkComponents, managedDeviceRegistry, variantApiOperationsRegistrar, extension)
  ...
  fun testLibraryModuleNoSelection() {
    ...
    testNoSelection(
      LibraryAndroidComponentsExtensionImpl(dslServices, sdkComponents, managedDeviceRegistry, variantApiOperationsRegistrar, extension),
      variantApiOperationsRegistrar,
  ...
  fun testDynamicFeatureModuleNoSelection() {
    ...
    val variantApiOperationsRegistrar =
      VariantApiOperationsRegistrar<com.android.build.api.dsl.DynamicFeatureExtension, DynamicFeatureVariantBuilder, DynamicFeatureVariant>(
        extension
      )
    testNoSelection(
  ...
  fun testTestModuleNoSelection() {
    ...
    testNoSelection(
      TestAndroidComponentsExtensionImpl(dslServices, sdkComponents, managedDeviceRegistry, variantApiOperationsRegistrar, extension),
      variantApiOperationsRegistrar,
  ...
  fun testBeforeVariants() {
    ...
    appExtension.beforeVariants { it.minSdk = 23 }

    appExtension.beforeVariants(fooVariant) { it.enable = false }
  }
  ...
  fun testOnVariantsProperties() {
    ...
    val debugF1Variant = appExtension.selector().withBuildType("debug").withFlavor("f1" to "dim1")
    appExtension.onVariants(debugF1Variant) { it.artifacts.get(SingleArtifact.APK) }
  }
  ...
  fun testRegisterProjectExtension() {
    ...
    appExtension.registerExtension(DslExtension.Builder("extension").extendProjectWith(ProjectDslExtensionType::class.java).build()) {
    ...
    assertThat(variantApiOperationsRegistrar.dslExtensions[0].dslExtensionTypes.dslName).isEqualTo("extension")
  ...
  fun testRegisterBuildTypeExtension() {
    ...
    appExtension.registerExtension(DslExtension.Builder("extension").extendBuildTypeWith(DslExtensionType::class.java).build()) {
      object : VariantExtensionType {}
    }
  ...
  fun testRegisterProductFlavorExtension() {
    ...
    appExtension.registerExtension(DslExtension.Builder("extension").extendProductFlavorWith(DslExtensionType::class.java).build()) {
      object : VariantExtensionType {}
    }
    verify(extensionContainer).add("extension", DslExtensionType::class.java)
    assertThat(variantApiOperationsRegistrar.dslExtensions).hasSize(1)
  ...
  fun testMultipleRegisterExtension() {
    ...
    appExtension.registerExtension(DslExtension.Builder("buildTypeExtension").extendBuildTypeWith(DslExtensionType::class.java).build()) {
      object : VariantExtensionType {}
    }
    appExtension.registerExtension(
      DslExtension.Builder("productFlavorExtension").extendProductFlavorWith(DslExtensionType::class.java).build()
    ) {
      object : VariantExtensionType {}
    }
    ...
    assertThat(variantApiOperationsRegistrar.dslExtensions[0].dslExtensionTypes.dslName).isEqualTo("buildTypeExtension")
    assertThat(variantApiOperationsRegistrar.dslExtensions[0].dslExtensionTypes.buildTypeExtensionType)
      .isEqualTo(DslExtensionType::class.java)
    assertThat(variantApiOperationsRegistrar.dslExtensions[1].dslExtensionTypes.dslName).isEqualTo("productFlavorExtension")
  ...
  fun testFinalizationBlockAlreadyExecuted() {
    ...
    appExtension.finalizeDsl { fail("This should never execute !") }
  }
  ...
  private fun createExtensionAwareBuildType(extension: ApplicationExtension): ExtensionContainer {
    @Suppress("UNCHECKED_CAST") val buildTypesContainer = mock<NamedDomainObjectContainer<ApplicationBuildType>>()
    ...
    whenever(buildTypesContainer.configureEach(argument.capture())).thenAnswer { invocation ->
      buildTypes.forEach { invocation.getArgument<Action<in ApplicationBuildType>>(0).execute(it) }
    }
  ...
  private fun createExtensionAwareProductFlavor(extension: ApplicationExtension): ExtensionContainer {
    @Suppress("UNCHECKED_CAST") val productFlavorContainer = mock<NamedDomainObjectContainer<ApplicationProductFlavor>>()
    ...
    whenever(productFlavorContainer.configureEach(argument.capture())).thenAnswer { invocation ->
      productFlavors.forEach { invocation.getArgument<Action<in ApplicationProductFlavor>>(0).execute(it) }
    }
  ...
  private inline fun <DslExtensionT : CommonExtension, reified VariantBuilderT : VariantBuilder, VariantT : Variant> testAllSelection(
    ...
    extension.beforeVariants(extension.selector().all()) { visitedVariants.add(it) }
    @Suppress("UNCHECKED_CAST") operationsRegistrar.variantBuilderOperations.executeOperations(mock<VariantBuilderT>())
