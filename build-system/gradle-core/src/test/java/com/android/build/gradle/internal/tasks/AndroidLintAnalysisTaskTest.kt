...
class AndroidLintAnalysisTaskTest {
  ...
  abstract class TaskForTest @Inject constructor(testWorkerExecutor: WorkerExecutor) : AndroidLintAnalysisTask() {
  ...
  fun setUp() {
    ...
    task =
      project.tasks
        .register("androidLintAnalysisTask", TaskForTest::class.java, FakeGradleWorkExecutor(project.objects, temporaryFolder.newFolder()))
        .get()
