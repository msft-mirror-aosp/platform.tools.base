...
class ResourcesPackagingImplTest {
  ...
  fun testExcludes() {
    ...
    val dslResourcesPackagingOptionsImpl = dslPackaging.resources as com.android.build.gradle.internal.dsl.ResourcesPackagingImpl
    dslResourcesPackagingOptionsImpl.setExcludes(Sets.union(dslPackaging.resources.excludes, setOf("baz")))

    val resourcesPackagingOptionsImpl = ResourcesPackagingImpl(dslPackaging, variantPropertiesApiServices)
    ...
    assertThat(resourcesPackagingOptionsImpl.excludes.get()).containsExactlyElementsIn(expectedExcludes)
  }
  ...
  fun testPickFirsts() {
    ...
    val dslResourcesPackagingOptionsImpl = dslPackaging.resources as com.android.build.gradle.internal.dsl.ResourcesPackagingImpl
    dslResourcesPackagingOptionsImpl.setPickFirsts(Sets.union(dslPackaging.resources.pickFirsts, setOf("baz")))

    val resourcesPackagingOptionsImpl = ResourcesPackagingImpl(dslPackaging, variantPropertiesApiServices)

    assertThat(resourcesPackagingOptionsImpl.pickFirsts.get()).containsExactly("foo", "bar", "baz")
  }
  ...
  fun testMerges() {
    ...
    val dslResourcesPackagingOptionsImpl = dslPackaging.resources as com.android.build.gradle.internal.dsl.ResourcesPackagingImpl
    dslResourcesPackagingOptionsImpl.setMerges(Sets.union(dslPackaging.resources.merges, setOf("baz")))

    val resourcesPackagingOptionsImpl = ResourcesPackagingImpl(dslPackaging, variantPropertiesApiServices)

    val expectedMerges = defaultMerges.toMutableSet()
    expectedMerges.addAll(listOf("foo", "bar", "baz"))
    assertThat(resourcesPackagingOptionsImpl.merges.get()).containsExactlyElementsIn(expectedMerges)
  }
