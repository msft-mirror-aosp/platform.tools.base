    ...
    check {
      ...
      onVariantStats { variant ->
        ...
        if (variant.isDebug) {
          ...
          variant.variantApiAccess.variantAccessList.forEach { println("op " + it.type) }
          ...
          Truth.assertThat(variantAccessList.first().type).isEqualTo(VariantMethodType.MIN_SDK_VERSION_VALUE_VALUE)
        }
      }
    }
  }
