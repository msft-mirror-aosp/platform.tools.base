...
data class VariantOutputImpl(
  @get:Input @get:Optional override val versionCode: Property<Int>,
  @get:Input @get:Optional override val versionName: Property<String>,
  @get:Input override val enabled: Property<Boolean>,
  @get:Internal val variantOutputConfiguration: VariantOutputConfiguration,
  ...
  data class SerializedForm(
    @get:Input val versionCode: Int?,
    @get:Input val versionName: String?,
    @get:Nested val variantOutputConfiguration: VariantOutputConfigurationImpl,
    @get:Input val baseName: String,
    @get:Input val fullName: String,
    @get:Input val outputFileName: String,
  ) : Serializable {
