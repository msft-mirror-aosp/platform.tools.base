...
constructor(
  ...
  BaseExtension(dslServices, bootClasspathConfig, buildOutputs, sourceSetManager, false, stats),
  TestAndroidConfig,
  ...
  private val applicationVariantList: DomainObjectSet<ApplicationVariant> = dslServices.domainObjectSet(ApplicationVariant::class.java)

  /**
   * The list of Application variants. Since the collections is built after evaluation, it should be used with Gradle's `all` iterator to
