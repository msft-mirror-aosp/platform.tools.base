...
open class ApplicationVariantImpl
@Inject
constructor(
  ...
  override val dependenciesInfo: DependenciesInfo by lazy {
    DependenciesInfoImpl(dependenciesInfoBuilder.includeInApk, dependenciesInfoBuilder.includeInBundle)
  }
  ...
  private fun checkProfileableWithCompileSdk() {
    ...
    if ((fromProfilingModeOption == true || profileable) && _compileSdk < minProfileableSdk) {
  ...
  private fun createVersionCodeProperty(): Property<Int> =
    internalServices.newPropertyBackingDeprecatedApi(Int::class.java, dslInfo.versionCode)
  ...
  override fun <T : Component> createUserVisibleVariantObject(stats: GradleBuildVariant.Builder?): T =
    if (stats == null) {
      ...
      services.newInstance(AnalyticsEnabledApplicationVariant::class.java, this, stats) as T
    }

  override val bundleConfig: BundleConfigImpl =
    BundleConfigImpl(CodeTransparencyImpl(global.bundleOptions.codeTransparency.signing), internalServices)
