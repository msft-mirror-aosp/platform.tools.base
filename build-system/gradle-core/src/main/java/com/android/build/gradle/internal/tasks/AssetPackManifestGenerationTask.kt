...
/**
 * Task responsible for creating the pack's manifest file from the settings in the module's build.gradle file, as well as the base package
 * name of the project. "Packs" can refer to either AI packs or asset packs.
 */
...
abstract class AssetPackManifestGenerationTask : NonIncrementalGlobalTask() {
  ...
  /** The dynamic delivery type that will be used for the pack. The valid options are fast-follow, install-time, or on-demand. */
  @get:Input abstract val deliveryType: Property<String>
  /** The dynamic delivery type that will be used for the pack in an instant app context. The valid options are fast-follow or on-demand. */
  @get:Input @get:Optional abstract val instantDeliveryType: Property<String>
  ...
  @get:Input @get:Optional abstract val aiModelDependencyPackageName: Property<String>
  /** The name of the AI model dependency. Only set for AI packs that contain model adaptations. */
  @get:Input @get:Optional abstract val aiModelDependencyName: Property<String>
...
abstract class AssetPackManifestGenerationRunnable : WorkAction<AssetPackManifestGenerationRunnable.Params> {
