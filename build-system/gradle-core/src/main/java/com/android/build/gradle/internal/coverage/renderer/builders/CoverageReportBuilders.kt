...
/**
 * A mutable builder for creating an immutable [TestSuiteReport] instance. Represents the coverage data generated by a single test suite.
 *
 ...
 * @param moduleName The name of the module this package belongs to. Can be null if this report is part of a `TestSuiteReport`'s package
 *   list.
 * @param testSuiteName The name of the test suite this package report belongs to. Can be null if the report is aggregated by packages
 *   rather than by test suite.
 */
 ...
 * @param testSuiteName The name of the test suite this class report belongs to. Can be null if the report is aggregated by packages rather
 *   than by test suite.
 */
class ClassReportBuilder(val name: String, val packageName: String, val sourceFileName: String, val testSuiteName: String?) {
