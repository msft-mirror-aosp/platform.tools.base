...
internal class DynamicFeatureVariantFactory(dslServices: DslServices) :
  AbstractAppVariantFactory<DynamicFeatureVariantBuilder, DynamicFeatureVariantDslInfo, DynamicFeatureCreationConfig>(dslServices) {
  ...
  override fun createBuildFeatureValues(buildFeatures: BuildFeatures, projectServices: ProjectServices): BuildFeatureValues {
    buildFeatures as? DynamicFeatureBuildFeatures ?: throw RuntimeException("buildFeatures not of type DynamicFeatureBuildFeatures")
