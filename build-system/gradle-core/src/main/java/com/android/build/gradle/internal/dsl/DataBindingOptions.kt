...
abstract class DataBindingOptions
@Inject
constructor(private val featuresProvider: Supplier<BuildFeatures>, private val dslServices: DslServices) :
  ...
  override var enable: Boolean
    ...
    set(value) {
      when (val buildFeatures = featuresProvider.get()) {
        ...
        else -> dslServices.logger.warn("dataBinding.setEnabled has no impact on this sub-project type")
      }
    }
