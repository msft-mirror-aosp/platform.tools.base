...
enum class OptionalBooleanOption(override val propertyName: String, val stage: Stage, val recommendedValue: Boolean? = null) :
  Option<Boolean> {
   ...
   * ENFORCED FEATURES
   */
  @Suppress("unused") ENABLE_R8("android.enableR8", FeatureStage.Enforced(VERSION_7_0, "Please remove it from `gradle.properties`.")),
  @Suppress("unused")
