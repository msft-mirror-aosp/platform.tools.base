 ...
 * resources.
 */
@Deprecated("Deprecated and moved to a new package", ReplaceWith("com.android.build.api.dsl.AndroidSourceSet"))
interface AndroidSourceSet : com.android.build.api.dsl.AndroidSourceSet {
  ...
  @get:Deprecated("This property is deprecated. Use getRuntimeOnlyConfigurationName() instead", ReplaceWith("runtimeOnlyConfigurationName"))
  val packageConfigurationName: String

  /** Returns the name of the compiled-only configuration for this source set. */
  @get:Deprecated("This property is deprecated. Use getCompileOnlyConfigurationName() instead", ReplaceWith("compileOnlyConfigurationName"))
   ...
   */
  @Deprecated("This property is unused and will be removed in AGP 9.0", level = DeprecationLevel.HIDDEN)
   ...
   *
   * The given closure is used to configure the [AndroidSourceDirectorySet] which contains the shaders.
   *
   ...
   *
   * <p>The given closure is used to configure the {@link AndroidSourceDirectorySet} which contains the ml models.
   *
