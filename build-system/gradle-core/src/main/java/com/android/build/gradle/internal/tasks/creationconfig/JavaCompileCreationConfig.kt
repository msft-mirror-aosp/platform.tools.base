  ...
  return if (creationConfig is KmpComponentCreationConfig) {
    object : BaseJavaCompileCreationConfig(creationConfig, usingKapt) {
      ...
      private fun KmpComponentCreationConfig.getKotlinJvmTarget() =
        androidKotlinCompilation.compileTaskProvider.get().compilerOptions.jvmTarget.orNull?.target
...
internal open class BaseJavaCompileCreationConfig(val creationConfig: ComponentCreationConfig, override val usingKapt: Boolean) :
