...
abstract class TestExtensionImpl
@Inject
constructor(
  dslServices: DslServices,
  dslContainers: DslContainerProvider<TestDefaultConfig, TestBuildType, TestProductFlavor, SigningConfig>,
) : CommonExtensionImpl<TestBuildType, TestDefaultConfig, TestProductFlavor>(dslServices, dslContainers), InternalTestExtension {

  override val buildFeatures: TestBuildFeatures = dslServices.newInstance(TestBuildFeaturesImpl::class.java)
  ...
  override val androidResources: TestAndroidResources = dslServices.newDecoratedInstance(TestAndroidResourcesImpl::class.java, dslServices)
  ...
  override val installation: TestInstallation = dslServices.newDecoratedInstance(TestInstallationImpl::class.java, dslServices)
