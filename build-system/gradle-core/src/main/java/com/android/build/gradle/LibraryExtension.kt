...
constructor(
  ...
  TestedExtension(dslServices, bootClasspathConfig, buildOutputs, sourceSetManager, false, stats),
  ...
  private val libraryVariantList: DomainObjectSet<LibraryVariant> = dslServices.domainObjectSet(LibraryVariant::class.java)

  /**
   * Returns a collection of [build variants](https://developer.android.com/studio/build/build-variants.html) that the library project
   * includes.
   *
