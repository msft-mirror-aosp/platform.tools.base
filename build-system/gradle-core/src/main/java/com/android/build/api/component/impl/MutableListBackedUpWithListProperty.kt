...
class MutableListBackedUpWithListProperty<E : Any>(private val propertyList: ListProperty<E>, private val propertyName: String) :
    ...
    return object : MutableListIterator<E> by mutableIterator {
      ...
      override fun remove() {
        throw UnsupportedOperationException(
          "You cannot remove elements from the $propertyName " + "collection, use clear() and add back elements you want to retain"
        )
      }
    }
  }
  ...
  override fun removeAt(index: Int): E {
    throw NotImplementedError(
      "Cannot selectively remove elements from the $propertyName collection, first clear() the list" +
