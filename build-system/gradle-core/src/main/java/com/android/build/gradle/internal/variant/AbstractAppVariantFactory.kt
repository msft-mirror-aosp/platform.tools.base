 ...
 */
abstract class AbstractAppVariantFactory<
  VariantBuilderT : VariantBuilder,
  VariantDslInfoT : VariantDslInfo,
  VariantT : VariantCreationConfig,
>(dslServices: DslServices) : BaseVariantFactory<VariantBuilderT, VariantDslInfoT, VariantT>(dslServices) {
  ...
  override fun createVariantData(
    ...
    return ApplicationVariantData(componentIdentity, artifacts, services)
  }
  ...
  private fun validateVersionCodes(model: VariantInputModel<DefaultConfig, BuildType, ProductFlavor, SigningConfig>) {
    val issueReporter: IssueReporter = dslServices.issueReporter
