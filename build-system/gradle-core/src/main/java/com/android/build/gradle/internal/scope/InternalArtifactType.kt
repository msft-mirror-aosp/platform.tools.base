 ...
 *
 * @param finalizingArtifact a list of Artifact types that this type is finalizing. This mean that the task producing this artifact type
 *   will be used to finalize the tasks producing the elements of that list.
 */
@Suppress("ClassName")
sealed class InternalArtifactType<T : FileSystemLocation>(
  kind: ArtifactKind<T>,
  ...
  /**
   * A directory containing runtime classes. NOTE: It may contain either class files only (preferred) or a single jar only, see {@link
   * AndroidArtifacts.ClassesDirFormat}.
   */
  ...
  // Sources jar that is published for Maven and for deriving fused library merged source jars
  ...
  /** Unmerged obfuscation mapping file produced by R8 task (before L8 desugaring mapping is merged) */
  object UNMERGED_OBFUSCATION_MAPPING_FILE : InternalArtifactType<RegularFile>(FILE), Replaceable

  /** Unmerged partitioned obfuscation mapping file produced by R8 task (before L8 desugaring partition mapping is merged) */
  object UNMERGED_OBFUSCATION_MAPPING_PARTITION_FILE : InternalArtifactType<RegularFile>(FILE), Replaceable
  ...
  // Global synthetics generated by d8, merged by us and to be published from dynamic feature
  // modules
  ...
  // java res before it is minified by R8Task
  object ORIGINAL_MERGED_JAVA_RES : InternalArtifactType<RegularFile>(FILE), Replaceable
  ...
  // The variant specific jacoco code coverage data collected from unit tests, instrumentation tests
  // and test suites
  ...
  object MERGED_RES_INCREMENTAL_FOLDER : InternalArtifactType<Directory>(DIRECTORY, Category.INTERMEDIATES, "incremental"), Replaceable

  object GENERATED_PNGS_RES : InternalArtifactType<Directory>(DIRECTORY, Category.GENERATED, "res/pngs"), Replaceable

  object UPDATED_NAVIGATION_XML : InternalArtifactType<Directory>(DIRECTORY, Category.GENERATED), Replaceable
  ...
  // File created by AAPT containing containing the list of resources and directives to each
  // resource.
  ...
  // public.txt output This file might not exist if the project does not declare any public
  // resources.
  ...
  /** Shrunk resources in proto format (produced by the base module, to be consumed by dynamic feature modules). */
  ...
  object COMPILE_AND_RUNTIME_R_CLASS_JAR : InternalArtifactType<RegularFile>(FILE), Replaceable
  ...
  // An AAPT2 static library: InternalArtifactType<RegularFile>(FILE), Replaceable containing only
  // the current sub-project's resources.
  ...
  // the data binding class log generated after compilation:
  // InternalArtifactType<RegularFile>(FILE), Replaceable includes merged
  // class info file
  ...
  // The libs/ directory for the AAR: InternalArtifactType<RegularFile>(FILE), Replaceable
  // containing secondary jars
  ...
  object APK_IDE_REDIRECT_FILE : InternalArtifactType<RegularFile>(kind = FILE, finalizingArtifact = listOf(SingleArtifact.APK))

  object BUNDLE_IDE_REDIRECT_FILE : InternalArtifactType<RegularFile>(kind = FILE, finalizingArtifact = listOf(SingleArtifact.BUNDLE))

  object APK_FROM_BUNDLE_IDE_REDIRECT_FILE : InternalArtifactType<RegularFile>(kind = FILE, finalizingArtifact = listOf(EXTRACTED_APKS))
  ...
  object R8_MAPPING_CONFIGURATION_ANALYZER_DATA : InternalArtifactType<RegularFile>(FILE, Category.OUTPUTS, "mapping", "configanalyzer.pb")

  object R8_MAPPING_CONFIGURATION_ANALYZER_REPORT :
    InternalArtifactType<RegularFile>(FILE, Category.OUTPUTS, "mapping", "configanalyzer.html")
  ...
  object R8_MAPPING_CONFIGURATION : InternalArtifactType<RegularFile>(FILE, Category.OUTPUTS, "mapping", "configuration.txt")

  object R8_MAPPING_MISSING_RULES : InternalArtifactType<RegularFile>(FILE, Category.OUTPUTS, "mapping", "missing_rules.txt")

  object R8_MAPPING_RESOURCES : InternalArtifactType<RegularFile>(FILE, Category.OUTPUTS, "mapping", "resources.txt")

  // Human-readable Art profile artifacts; combines art profiles from various project sources
  object MERGED_ART_PROFILE : InternalArtifactType<RegularFile>(FILE, fileName = SdkConstants.FN_ART_PROFILE)
  ...
  object R8_ART_PROFILE : InternalArtifactType<RegularFile>(FILE, fileName = SdkConstants.FN_ART_PROFILE), Transformable

  /** R8 HTML analysis report file. */
  object R8_REPORT_HTML : InternalArtifactType<RegularFile>(FILE, Category.REPORTS)

  /** R8 PB analysis report file. */
  object R8_REPORT_PB : InternalArtifactType<RegularFile>(FILE, Category.REPORTS)
  ...
  object L8_ART_PROFILE : InternalArtifactType<RegularFile>(FILE, fileName = SdkConstants.FN_ART_PROFILE), Transformable

  object LIBRARY_ART_PROFILE : InternalArtifactType<RegularFile>(FILE, fileName = SdkConstants.FN_ART_PROFILE)
  ...
  object COMBINED_ART_PROFILE : InternalArtifactType<RegularFile>(FILE, fileName = SdkConstants.FN_ART_PROFILE)

  // binary art profile artifacts.
  object BINARY_ART_PROFILE : InternalArtifactType<RegularFile>(FILE, fileName = SdkConstants.FN_BINARY_ART_PROFILE)

  object BINARY_ART_PROFILE_METADATA : InternalArtifactType<RegularFile>(FILE, fileName = SdkConstants.FN_BINARY_ART_PROFILE_METADATA)
