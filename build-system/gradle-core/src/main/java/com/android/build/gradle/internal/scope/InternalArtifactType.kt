...
sealed class InternalArtifactType<T : FileSystemLocation>(
  ...
  // library: InternalArtifactType<RegularFile>(FILE), Replaceable and how to process them (typically which typedefs to omit during
  // packaging).
  ...
  // The main dex list for the bundle: InternalArtifactType<RegularFile>(FILE), Replaceable unlike the main dex list for a monolithic
  ...
  // Replaceable
  // the res ID offset: InternalArtifactType<RegularFile>(FILE), Replaceable both tied to the feature module path. Published by the base for
  // the
  ...
  // The validated signing config output: InternalArtifactType<RegularFile>(FILE), Replaceable to allow the task to be up to date:
  ...
  // The library dependencies report: InternalArtifactType<RegularFile>(FILE), Replaceable direct and indirect:
