...
abstract class BundleToApkTask : NonIncrementalTask() {
  ...
  class CreationAction(creationConfig: ApkCreationConfig) : VariantTaskCreationAction<BundleToApkTask, ApkCreationConfig>(creationConfig) {
    ...
    override fun handleProvider(taskProvider: TaskProvider<BundleToApkTask>) {
      super.handleProvider(taskProvider)
      creationConfig.artifacts
        .setInitialProvider(taskProvider, BundleToApkTask::outputFile)
        .withName("bundle.apks")
        .on(InternalArtifactType.APKS_FROM_BUNDLE)
    }
