...
// structured by project, module, test suite, package, and class.
// =========================================================================================
 ...
 * @property variantCoverages Aggregated coverage information for each variant across all modules.
 ...
 * @property variantCoverages Aggregated coverage for each variant within this module.
 * @property testSuites A list of test suites that ran against this module.
...
/**
 * Represents coverage data generated by a single test suite.
 *
 * @property name The name of the test suite.
 * @property moduleName The name of the module this test suite belongs to.
 ...
 * @property testSuiteName The name of the test suite this class report belongs to. Can be null if report is grouped by package.
 * @property sourceFileName The name of the source file.
 * @property variantCoverages Aggregated coverage for each variant of this class.
