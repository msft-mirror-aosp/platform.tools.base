...
internal abstract class VariantDslInfoImpl
internal constructor(
  ...
  override val minSdkVersion: MutableAndroidVersion
    ...
    get() = mergedFlavor.minSdkVersion?.let { MutableAndroidVersion(it.apiLevel, it.codename) } ?: MutableAndroidVersion(1)
  ...
  override val namespace: Provider<String>
    get() {
      ...
      if (extension.namespace == null) {
        ...
        services.issueReporter.reportError(IssueReporter.Type.NAMESPACE_NOT_SET, message, buildFilePath)
      }
  ...
  override val nativeBuildDslInfo by
    lazy(LazyThreadSafetyMode.NONE) { NativeBuildDslInfoImpl(componentType, defaultConfig, buildTypeObj, productFlavorList, extension) }
  ...
  private fun initApplicationId(): Provider<String> {
    ...
    val appIdFromFlavors =
      productFlavorList
        ...
        .firstOrNull { it != null } ?: defaultConfig.applicationId
