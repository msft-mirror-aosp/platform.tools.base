...
/** Transform a [ConfigureInvalidationState] into an [EncodedConfigureInvalidationState] by encoding strings with [StringEncoder]. */
...
/** Transform a [EncodedConfigureInvalidationState] into an [ConfigureInvalidationState] by decoding strings with [StringDecoder]. */
...
fun decodeConfigureInvalidationState(encoded: EncodedConfigureInvalidationState, decoder: StringDecoder) = encoded.decode(decoder)

/** Transform a [FileChange] into an [EncodedFileChange] by encoding strings with [StringEncoder]. */
...
/** Transform a [EncodedFileChange] into an [FileChange] by decoding strings with [StringDecoder]. */
...
/** Transform a [NativeModelBuilderOutcome] into an [EncodedNativeModelBuilderOutcome] by encoding strings with [StringEncoder]. */
...
/** Transform a [EncodedNativeModelBuilderOutcome] into an [CxxGradleConfigureOutcome] by decoding strings with [StringDecoder]. */
...
fun decodeNativeModelBuilderOutcome(encoded: EncodedNativeModelBuilderOutcome, decoder: StringDecoder) = encoded.decode(decoder)

/** Transform a [CreateCxxModel] into an [EncodedCreateCxxModel] by encoding strings with [StringEncoder]. */
...
/** Transform a [EncodedCreateCxxModel] into an [CreateCxxModel] by decoding strings with [StringDecoder]. */
