...
class MergedFlavor(name: String, private val _applicationId: Property<String>, private val services: VariantServices) :
  ...
  override var applicationId: String?
    get() {
      ...
      services.deprecationReporter.reportDeprecatedApi(
  ...
  companion object {
    ...
    /**
     * Merges the flavors by analyzing the specified one and the list. Flavors whose position in the list is higher will have their values
     * overwritten by the lower-position flavors (in case they have non-null values for some properties). E.g. if flavor at position 1
     * specifies applicationId &quot;my.application&quot;, and flavor at position 0 specifies &quot;sample.app&quot;, merged flavor will
     * have applicationId &quot;sampleapp&quot; (if there are no other flavors overwriting this value). Flavor `lowestPriority`, as the name
    ...
    fun mergeFlavors(
      ...
      for (mFlavor in flavors) {
        applicationIdSuffix = mergeApplicationIdSuffix(mFlavor.applicationIdSuffix, applicationIdSuffix)
        versionNameSuffix = mergeVersionNameSuffix(mFlavor.versionNameSuffix, versionNameSuffix)
      }
  ...
  private fun reportErrorWithWorkaround(fieldName: String, outputFieldName: String, fieldValue: Any?) {
    val formattedFieldValue =
