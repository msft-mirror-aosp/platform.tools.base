...
abstract class AbstractPublishing<T : SingleVariant>(val dslService: DslServices) {
  ...
  protected fun addSingleVariant(variantName: String, implementationClass: Class<T>): T {
  ...
  protected fun addSingleVariantAndConfigure(variantName: String, implementationClass: Class<T>, action: T.() -> Unit) {
