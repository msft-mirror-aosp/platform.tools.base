...
internal class AarExtractor {
  ...
  /** [StringBuilder] used to construct all paths. It gets truncated back to [JARS_PREFIX_LENGTH] on every calculation. */
   ...
   *
   * Note: There are small adjustments made to the extracted contents. For example, classes.jar inside the AAR will be extracted to
   * jars/classes.jar, and if the jar does not exist, we will create an empty classes.jar.
   */
