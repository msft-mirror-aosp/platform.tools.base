...
>(protected val dslServices: DslServices, dslContainers: DslContainerProvider<DefaultConfigT, BuildTypeT, ProductFlavorT, SigningConfig>) :
  ...
  @Deprecated("To be removed after Gradle drops space assignment support. Use `compileSdk {}` instead.")
