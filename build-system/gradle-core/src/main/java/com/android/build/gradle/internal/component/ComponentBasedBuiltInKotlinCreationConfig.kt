...
class ComponentBasedBuiltInKotlinCreationConfig(
    val componentCreationConfig: ComponentCreationConfig
    ...
    override fun getJavaClasspath(
        ...
        componentCreationConfig.getJavaClasspath(configType, classesType, generatedBytecodeKey)

    override fun getBuiltInKaptArtifact(
    ...
    override val kaptSourceOutputDir: Provider<Directory>
            by lazy {
                componentCreationConfig.paths.generatedDir(
                    "source", "kapt", componentCreationConfig.paths.dirName
                )
            }
    ...
    override val kaptKotlinSourceOutputDir: Provider<Directory>
            by lazy {
                componentCreationConfig.paths.generatedDir(
                    "source", "kaptKotlin", componentCreationConfig.paths.dirName
                )
            }
    ...
    override fun toAndroidVariantType(): AndroidVariantType =
        componentCreationConfig.toAndroidVariantType()

    override fun getAnnotationProcessorJars(): FileCollection =
        componentCreationConfig.getAnnotationProcessorJars()
    ...
    override fun setupFriends(friendPaths: ConfigurableFileCollection) {
        ...
        if (componentCreationConfig is TestComponentCreationConfig) {
            val testFixturesComponent = componentCreationConfig.mainVariant.nestedComponents
