...
internal class SharedProcessTracker(coroutineScope: CoroutineScope, delegate: ProcessTracker, private val logger: AdbLogger) :
  ProcessTracker {

  private val flow =
    delegate.trackProcesses().catch { throwable -> logger.logIOCompletionErrors(throwable) }.shareIn(coroutineScope, Lazily)
