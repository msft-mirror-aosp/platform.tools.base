...
http_archive(
    name = "perfetto",
    patch_args = ["-p1"],
    sha256 = "b44a361299615bab6d224a7b0dd77401e8bb9bbd8c949dbad2119ea86e8d339a",
    strip_prefix = "perfetto-51.1",
    url = "https://github.com/google/perfetto/archive/refs/tags/v51.1.zip",
)
