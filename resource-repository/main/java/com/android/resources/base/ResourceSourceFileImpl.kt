 ...
 *
 * [relativePath] path of the file relative to the resource directory, or null if the source file of
 * the resource is not available [configuration] configuration the resource file is associated with
 */
